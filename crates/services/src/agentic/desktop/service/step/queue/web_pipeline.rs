pub(crate) use super::support::{
    ...
    explicit_query_scope_hint, final_web_completion_contract_ready, final_web_completion_facts,
    ...
    retrieval_contract_min_sources, select_final_web_summary_from_candidates,
    select_web_pipeline_query_contract, selected_source_quality_metrics_with_locality_hint,
    semantic_retrieval_query_contract_with_locality_hint, source_has_human_challenge_signal,
    source_host, source_matches_local_business_search_entity_anchor, synthesize_web_pipeline_reply,
