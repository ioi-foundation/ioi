...
pub(crate) const QUERY_COMPATIBILITY_PRIMARY_STATUS_BONUS: usize = 6;
pub(crate) const QUERY_COMPATIBILITY_OFFICIAL_STATUS_HOST_BONUS: usize = 10;
pub(crate) const QUERY_COMPATIBILITY_LOW_PRIORITY_PENALTY: usize = 8;
