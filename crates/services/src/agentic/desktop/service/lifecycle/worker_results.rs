...
fn await_child_burst_step_limit(
    state: &dyn StateAccess,
    child_session_id: [u8; 32],
    child_state: &AgentState,
) -> Result<usize, String> {
...
async fn drive_child_session_once(
...
fn block_parent_playbook_after_worker_failure(
    service: &DesktopAgentService,
    state: &mut dyn StateAccess,
    parent_state: &mut AgentState,
    parent_step_index: u32,
...
fn load_or_materialize_worker_result(
    service: &DesktopAgentService,
    state: &mut dyn StateAccess,
    child_state: &AgentState,
    child_session_id: [u8; 32],
...
fn materialize_paused_worker_error(reason: &str) -> String {
...
fn parent_playbook_terminal_status_for_block(
    reason: &str,
...
async fn merge_blocked_child_worker_result(
    service: &DesktopAgentService,
    state: &mut dyn StateAccess,
    parent_state: &mut AgentState,
    parent_step_index: u32,
...
async fn merge_terminal_child_worker_result(
    service: &DesktopAgentService,
    state: &mut dyn StateAccess,
    parent_state: &mut AgentState,
    parent_step_index: u32,
...
async fn maybe_merge_observed_patch_build_verify_completion(
    service: &DesktopAgentService,
    state: &mut dyn StateAccess,
    parent_state: &mut AgentState,
    parent_step_index: u32,
