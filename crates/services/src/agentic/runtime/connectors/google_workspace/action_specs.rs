fn google_connector_action_specs() -> Vec<GoogleConnectorActionSpec> {
    vec![
        ...
        GoogleConnectorActionSpec {
            ...
            description: "Start or reconnect a durable Gmail watch backed by Pub/Sub and the Hypervisor runtime.",
            kind: "admin",
            confirm_before_run: true,
        ...
        GoogleConnectorActionSpec {
            ...
            description: "Start or reconnect durable Google Workspace event ingestion backed by Pub/Sub and the Hypervisor runtime.",
            kind: "admin",
            confirm_before_run: true,
