...
#[path = "substrate/semantic_impact.rs"]
mod semantic_impact;
#[path = "substrate/session_lifecycle.rs"]
mod session_lifecycle;
use self::semantic_impact::semantic_impact_for_state;
use self::session_lifecycle::{
    harness_trace_adapter_for_surface, operator_interruption_contract_for_state,
    session_trace_bundle_for_state, workflow_envelope_adapter_for_surface,
};
