...
pub(in crate::agentic::runtime::execution) struct BrowserSurfaceRegions {
...
pub(in crate::agentic::runtime::execution) fn is_probable_browser_window(
    title: &str,
    app_name: &str,
) -> bool {
...
pub(in crate::agentic::runtime::execution) fn estimate_browser_surface_regions(
    window: &WindowInfo,
...
pub(in crate::agentic::runtime::execution) async fn browser_surface_regions(
    exec: &ToolExecutor,
) -> Option<BrowserSurfaceRegions> {
