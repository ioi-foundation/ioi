...
use crate::agentic::runtime::execution::workload::WORKLOAD_RECEIPT_REDACTED_PLACEHOLDER;
...
fn build_tool_executor(
...
) -> crate::agentic::runtime::execution::ToolExecutor {
    ...
    crate::agentic::runtime::execution::ToolExecutor::new(
        gui,
        os,
        terminal,
        browser,
