...
pub use ioi_types::app::{
    ...
    default_harness_worker_binding_registry_record, harness_component_kind_for_action_target,
    ...
    HarnessSlotKind, HarnessSlotSpec, HarnessTimeoutBehavior, HarnessWorkerAttachReceipt,
    HarnessWorkerAttachRequest, HarnessWorkerAttachStatus, HarnessWorkerBinding,
