...
impl McpControlAgentStateUpdateCore {
    pub fn plan(
        ...
        let control = json!({
            ...
            "authority_boundary": if transport_admission_required { Some("wallet.network.mcp_external_exit") } else { None },
            "authority_provider_ref": if transport_admission_required { Some("wallet.network") } else { None },
...
fn mcp_control_live_exit_receipt(
    ...
    json!({
        ...
        "details": {
            ...
            "execution_mode": execution_mode,
            "timeout_ms": timeout_ms,
            "authority_boundary": "wallet.network.mcp_external_exit",
