...
mod tests {
    ...
    #[test]
    fn model_mount_server_control_command_transport_is_retired() {
        assert_eq!(command_operation("plan_model_mount_server_control"), None);
        assert_eq!(
            expected_command_schema_version("plan_model_mount_server_control"),
            None
        );
        assert_eq!(
            validate_command_envelope(
