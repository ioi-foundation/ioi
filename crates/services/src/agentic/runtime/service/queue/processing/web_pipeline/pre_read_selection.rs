...
fn pre_read_primary_authority_override_allowed(
    ...
    crate::agentic::runtime::service::queue::support::retrieval_contract_requires_primary_authority_source(
        ...
        && !crate::agentic::runtime::service::queue::support::source_has_human_challenge_signal(
            url,
            title,
            excerpt,
        )
...
fn pre_read_on_topic_secondary_support_allowed(
    ...
    let semantic_anchor_hits =
        crate::agentic::runtime::service::decision_loop::signals::query_semantic_anchor_tokens(
            query_contract,
        )
        .iter()
...
fn pre_read_candidate_url_allowed_for_query(
    ...
    crate::agentic::runtime::service::queue::support::projection_candidate_url_allowed_with_contract_and_projection(
        retrieval_contract,
        query_contract,
        &projection,
        url,
...
fn pre_read_primary_authority_family_key(
    ...
    crate::agentic::runtime::service::queue::support::source_document_authority_family_key(
        query_contract,
        url,
        title,
        excerpt,
