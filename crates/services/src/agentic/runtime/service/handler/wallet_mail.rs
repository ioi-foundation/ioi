...
const MAIL_READ_RECEIPT_PREFIX: &[u8] = b"mail_read_evidence::";
const MAIL_LIST_RECEIPT_PREFIX: &[u8] = b"mail_list_evidence::";
const MAIL_DELETE_RECEIPT_PREFIX: &[u8] = b"mail_delete_evidence::";
const MAIL_REPLY_RECEIPT_PREFIX: &[u8] = b"mail_reply_evidence::";
