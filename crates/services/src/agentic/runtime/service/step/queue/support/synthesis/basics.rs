...
pub(crate) fn looks_like_clock_time(token: &str) -> bool {
    crate::agentic::runtime::service::step::text_tokens::looks_like_clock_time(token)
}

pub(crate) fn token_is_numeric_literal(token: &str) -> bool {
    crate::agentic::runtime::service::step::text_tokens::token_is_numeric_literal(token)
}
