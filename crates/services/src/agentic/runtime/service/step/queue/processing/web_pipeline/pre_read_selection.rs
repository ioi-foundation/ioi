...
fn pre_read_candidate_url_allowed_for_query(
    ...
    crate::agentic::runtime::service::step::queue::support::projection_candidate_url_allowed_with_contract_and_projection(
        retrieval_contract,
        query_contract,
        &projection,
        url,
...
fn pre_read_primary_authority_family_key(
    ...
    crate::agentic::runtime::service::step::queue::support::source_document_authority_family_key(
        query_contract,
        url,
        title,
        excerpt,
...
fn required_primary_authority_selection_floor(
    ...
    let authority_slot_cap = crate::agentic::runtime::service::step::queue::support::retrieval_contract_primary_authority_source_slot_cap(
        retrieval_contract,
        query_contract,
        expected_count,
    );
...
#[cfg(test)]
#[path = "pre_read_selection/pre_read_selection_tests.rs"]
