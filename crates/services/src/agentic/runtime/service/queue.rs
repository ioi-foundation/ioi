// Path: crates/services/src/agentic/runtime/service/queue.rs
...
pub(crate) use support::drain_queued_web_retrieve_actions;
pub(crate) use support::emit_final_web_completion_contract_receipts;
pub use support::queue_action_request_to_tool;
pub(crate) use support::{
    market_quote_grounding_contract_ready_for_pending, query_requests_comparison,
    retrieval_contract_required_source_cluster_count, synthesis_query_contract,
};
