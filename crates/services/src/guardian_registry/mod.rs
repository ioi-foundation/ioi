...
use ioi_types::app::{
    ...
    CanonicalOrderPublicationBundle, CanonicalReplayPrefixEntry, EffectProofVerifierDescriptor,
    FailureReport, GuardianCommitteeManifest, GuardianLogCheckpoint, GuardianMeasurementProfile,
