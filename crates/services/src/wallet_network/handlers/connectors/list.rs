// Path: crates/services/src/wallet_network/handlers/connectors/list.rs

use super::shared::{
    contains_mail_list_capability, enforce_connector_action_replay_window,
    enforce_mailbox_constraint, load_mail_connector_record, mail_provider_message_to_summary,
    normalize_mail_list_limit, normalize_mailbox, resolve_mail_provider_credentials,
    LEASE_OPERATION_TRACK_LIMIT,
};
use crate::wallet_network::keys::{
    channel_key, lease_action_window_key, lease_consumption_key, lease_key, mail_list_receipt_key,
};
use crate::wallet_network::mail_ontology::MAIL_ONTOLOGY_SIGNAL_VERSION;
...
use ioi_types::app::wallet_network::{
    MailListRecentParams, MailListRecentReceipt, SessionChannelRecord, SessionChannelState,
