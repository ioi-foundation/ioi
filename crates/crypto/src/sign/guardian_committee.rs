...
mod tests {
    ...
    use ioi_types::app::{
        AccountId, GuardianCommitteeMember, GuardianDecisionDomain,
        GuardianWitnessCommitteeManifest, GuardianWitnessStatement, SignatureSuite,
    };
    ...
    fn reference_verify_quorum_certificate(
        ...
        let signer_indexes = reference_decode_signers_bitfield(
    ...
    fn quorum_certificate_matches_reference_verifier() {
        ...
        for case in cases {
            ...
            let reference =
                reference_verify_quorum_certificate(&manifest, &decision, &case).is_ok();
            assert_eq!(
                actual, reference,
    ...
    fn witness_certificate_matches_reference_verifier() {
        ...
        for case in cases {
            ...
            let reference =
                reference_verify_witness_certificate(&manifest, &statement, &case).is_ok();
            assert_eq!(
                actual, reference,
