...
`GuardianMajority` is the production consensus mode in the Convergent Fault Tolerance family.

Canonical prose specs:

- [`guardian_majority.md`](/home/heathledger/Documents/ioi/repos/ioi/docs/consensus/convergent/specs/guardian_majority.md)
- [`nested_guardian.md`](/home/heathledger/Documents/ioi/repos/ioi/docs/consensus/convergent/specs/nested_guardian.md)
