    ...
    let checks = vec![
        ...
        LocalCheck::new(
            ...
            send_succeeded
                ...
                && sent_label_present,
            format!(
                "send_success_count={} send_failure_count={} recipient_binding_present={} subject_present={} body_present={} message_id_present={} sent_label_present={} payload={}",
