...
pub fn case() -> QueryCase {
    QueryCase {
        ...
        success_definition: "Send the requested Gmail message through the hermetic Google connector fixture with structured send evidence, fixture receipts, and no contract-failure markers.",
