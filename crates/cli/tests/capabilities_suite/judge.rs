...
12) For `case_id=research_the_latest_nist_post_quantum_cryptography_standards_and_write_me_a_one_page_briefing`, rely on typed verification evidence for document layout, section floors, query grounding, authority coverage, temporal anchoring, and postamble readiness. Do not infer verdict from freeform prose.\n\
...
15) For `case_id=find_the_three_best_reviewed_italian_restaurants_near_me_and_compare_their_menus`, rely on typed verification evidence for runtime locality, local-business entity anchoring, menu-surface selected sources, citation backing, and comparison readiness. Do not infer verdict from freeform prose.\n\
