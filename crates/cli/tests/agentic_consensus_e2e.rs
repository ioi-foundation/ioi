// Path: crates/cli/tests/agentic_consensus_e2e.rs

#![cfg(all(feature = "consensus-poa", feature = "vm-wasm"))]

use anyhow::Result;
use ioi_crypto::algorithms::hash::sha256;
use ioi_cli::testing::{build_test_artifacts, genesis::GenesisBuilder, TestCluster};
use ioi_types::{
    app::{
...
async fn test_secure_agentic_consensus_e2e() -> Result<()> {
    ...
    let res =
        ioi_cli::testing::wait_for_height(rpc_addr, 2, std::time::Duration::from_secs(60)).await;
