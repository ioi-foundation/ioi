// Path: crates/cli/tests/service_architecture_e2e.rs
...
async fn service_v2_registered(
    ...
    for h in [
        ...
        if let Ok(Some(block)) =
            ioi_cli::testing::rpc::get_block_by_height_resilient(rpc_addr, h).await
        {
...
"#
    ...
    // [FIX] Increased timeout to 60s to prevent flakey test failure
