...
pub(crate) fn action_target_from_label(label: &str) -> Option<ActionTarget> {
    match label {
        ...
        "model::respond" => Some(ActionTarget::ModelRespond),
        "model::embed" => Some(ActionTarget::ModelEmbed),
        "model::rerank" => Some(ActionTarget::ModelRerank),
        "media::extract_transcript" => Some(ActionTarget::MediaExtractTranscript),
        "media::extract_multimodal_evidence" => Some(ActionTarget::MediaExtractMultimodalEvidence),
