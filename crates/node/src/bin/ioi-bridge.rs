// Path: crates/node/src/bin/ioi-bridge.rs
#![forbid(unsafe_code)]

//! The IOI Bridge Node.
//!
//! Responsible for heavy bridge verification and cross-chain proof handling.
...
#[derive(Parser, Debug)]
#[clap(name = "ioi-bridge", about = "IOI Bridge Node")]
