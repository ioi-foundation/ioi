...
pub(crate) fn build_chat_artifact_swarm_plan(
    ...
    let (strategy, adapter_label) = chat_swarm_strategy_for_request(request, execution_strategy);
    let is_micro_swarm = execution_strategy == ChatExecutionStrategy::MicroSwarm;
