...
pub(super) struct StudioHtmlPromotedDesignSkillSpine {
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub(super) struct StudioHtmlScaffoldContract {
    pub family: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub(super) struct StudioHtmlComponentPackContract {
    pub family: String,
    pub role: String,
    #[serde(default)]
...
fn html_skill_kind_label(kind: StudioArtifactSkillNeedKind) -> String {
...
pub(super) fn studio_html_promoted_design_skill_spine(
    brief: &StudioArtifactBrief,
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    selected_skills: &[StudioArtifactSelectedSkill],
) -> Option<StudioHtmlPromotedDesignSkillSpine> {
    if blueprint.renderer != StudioRendererKind::HtmlIframe {
        return None;
    }
    ...
    Some(StudioHtmlPromotedDesignSkillSpine {
...
pub(super) fn studio_html_scaffold_contract(
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    candidate_seed: u64,
) -> Option<StudioHtmlScaffoldContract> {
    if blueprint.renderer != StudioRendererKind::HtmlIframe {
        return None;
    }
...
pub(super) fn studio_html_component_pack_contracts(
    blueprint: &StudioArtifactBlueprint,
) -> Vec<StudioHtmlComponentPackContract> {
    if blueprint.renderer != StudioRendererKind::HtmlIframe {
        return Vec::new();
    }
    ...
    for component in &blueprint.component_plan {
        ...
        packs.push(StudioHtmlComponentPackContract {
...
pub(super) fn studio_jsx_promoted_design_skill_spine(
    brief: &StudioArtifactBrief,
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    selected_skills: &[StudioArtifactSelectedSkill],
) -> Option<StudioHtmlPromotedDesignSkillSpine> {
    if blueprint.renderer != StudioRendererKind::JsxSandbox {
        return None;
    }
...
pub(super) fn studio_jsx_scaffold_contract(
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    candidate_seed: u64,
) -> Option<StudioHtmlScaffoldContract> {
...
pub(super) fn studio_jsx_component_pack_contracts(
    blueprint: &StudioArtifactBlueprint,
) -> Vec<StudioHtmlComponentPackContract> {
    if blueprint.renderer != StudioRendererKind::JsxSandbox {
        return Vec::new();
...
pub(super) fn studio_svg_promoted_design_skill_spine(
    brief: &StudioArtifactBrief,
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    selected_skills: &[StudioArtifactSelectedSkill],
) -> Option<StudioHtmlPromotedDesignSkillSpine> {
    if blueprint.renderer != StudioRendererKind::Svg {
        return None;
    }
...
pub(super) fn studio_svg_scaffold_contract(
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    candidate_seed: u64,
) -> Option<StudioHtmlScaffoldContract> {
...
pub(super) fn studio_svg_component_pack_contracts(
    blueprint: &StudioArtifactBlueprint,
) -> Vec<StudioHtmlComponentPackContract> {
    if blueprint.renderer != StudioRendererKind::Svg {
        return Vec::new();
...
pub(super) fn studio_pdf_promoted_design_skill_spine(
    brief: &StudioArtifactBrief,
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    selected_skills: &[StudioArtifactSelectedSkill],
) -> Option<StudioHtmlPromotedDesignSkillSpine> {
    if blueprint.renderer != StudioRendererKind::PdfEmbed {
        return None;
    }
...
pub(super) fn studio_pdf_scaffold_contract(
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    candidate_seed: u64,
) -> Option<StudioHtmlScaffoldContract> {
...
pub(super) fn studio_pdf_component_pack_contracts(
    blueprint: &StudioArtifactBlueprint,
) -> Vec<StudioHtmlComponentPackContract> {
    if blueprint.renderer != StudioRendererKind::PdfEmbed {
        return Vec::new();
...
pub(super) fn studio_html_scaffold_execution_digest(
    brief: &StudioArtifactBrief,
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    selected_skills: &[StudioArtifactSelectedSkill],
    ...
    let scaffold = studio_html_scaffold_contract(blueprint, artifact_ir, candidate_seed)?;
...
pub(super) fn studio_jsx_scaffold_execution_digest(
    brief: &StudioArtifactBrief,
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    selected_skills: &[StudioArtifactSelectedSkill],
    ...
    let scaffold = studio_jsx_scaffold_contract(blueprint, artifact_ir, candidate_seed)?;
...
pub(super) fn studio_svg_scaffold_execution_digest(
    brief: &StudioArtifactBrief,
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    selected_skills: &[StudioArtifactSelectedSkill],
    ...
    let design_spine =
        studio_svg_promoted_design_skill_spine(brief, blueprint, artifact_ir, selected_skills)?;
    let scaffold = studio_svg_scaffold_contract(blueprint, artifact_ir, candidate_seed)?;
    let component_packs = studio_svg_component_pack_contracts(blueprint);
    let component_inventory = component_packs
        .iter()
        .map(|pack| pack.family.clone())
        .collect::<Vec<_>>()
...
pub(super) fn studio_pdf_scaffold_execution_digest(
    brief: &StudioArtifactBrief,
    blueprint: &StudioArtifactBlueprint,
    artifact_ir: &StudioArtifactIR,
    selected_skills: &[StudioArtifactSelectedSkill],
    ...
    let design_spine =
        studio_pdf_promoted_design_skill_spine(brief, blueprint, artifact_ir, selected_skills)?;
    let scaffold = studio_pdf_scaffold_contract(blueprint, artifact_ir, candidate_seed)?;
    let component_packs = studio_pdf_component_pack_contracts(blueprint);
    let component_inventory = component_packs
        .iter()
        .map(|pack| pack.family.clone())
        .collect::<Vec<_>>()
