...
fn canonicalize_artifact_request(
    ...
    let artifact_class = match renderer {
        ...
        StudioRendererKind::HtmlIframe => match request.artifact_class {
            StudioArtifactClass::Document | StudioArtifactClass::InteractiveSingleFile => {
                request.artifact_class
            }
            _ => StudioArtifactClass::Document,
        },
        StudioRendererKind::JsxSandbox => StudioArtifactClass::InteractiveSingleFile,
