...
pub(super) fn build_studio_artifact_direct_author_repair_prompt_for_runtime(
    title: &str,
    intent: &str,
    request: &StudioOutcomeArtifactRequest,
...
pub(super) fn studio_artifact_materialization_schema_contract() -> &'static str {
...
pub(super) fn studio_artifact_materialization_schema_contract_for_runtime(
...
pub(super) fn studio_artifact_renderer_authoring_guidance_for_runtime(
    request: &StudioOutcomeArtifactRequest,
    brief: &StudioArtifactBrief,
    candidate_seed: u64,
    runtime_kind: StudioRuntimeProvenanceKind,
...
pub(super) fn studio_artifact_renderer_authoring_guidance(
    request: &StudioOutcomeArtifactRequest,
    brief: &StudioArtifactBrief,
    candidate_seed: u64,
) -> String {
...
pub(super) fn html_factual_anchor_surface_directive(brief: &StudioArtifactBrief) -> String {
    let anchors = brief
        .factual_anchors
        .iter()
        .map(|item| item.trim())
...
pub(super) fn html_brief_evidence_topics(brief: &StudioArtifactBrief) -> Vec<String> {
