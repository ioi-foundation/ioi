...
## Summary
- case_dir: `/home/heathledger/Documents/ioi/repos/ioi/docs/evidence/agent-model-matrix/runs/2026-04-03T05-01-30-814Z/ollama-openai/computer-use-click-button-smoke/artifacts/agent/miniwob_click_button_smoke`
- env_id: `click-button`
- model: `llama3.2:3b`
- backend: `live_http`
- provider_calls: `1`
...
- final_last_event: `click target=#area > button:nth-of-type(1) x=0 y=0 at=1775192628493`
- sync_count: `6`
...
- page_url: `file:///tmp/ioi-miniwob-bridge/dbe6bd3a74dcae6c/miniwob/click-button.1.html`
...
## Phase Timing
- bootstrap_sync_ms: `1775192627928`
- browser_launch_started_at_ms: `1775192613300`
- browser_launch_finished_at_ms: `1775192627676`
- session_created_at_ms: `1775192627818`
- browser_navigation_started_at_ms: `1775192627818`
- browser_navigation_finished_at_ms: `1775192627952`
- initial_bridge_ready_observed_at_ms: `1775192627953` (+25 ms from bootstrap)
- first_step_service_started_at_ms: `1775192628477` (+549 ms from bootstrap)
- first_inference_started_at_ms: `1775192627955` (+27 ms from bootstrap)
- first_inference_finished_at_ms: `1775192628477` (+549 ms from bootstrap)
- first_bridge_input_event_ms: `1775192628493` (+565 ms from bootstrap)
- first_grounded_target_event_ms: `1775192628493` (+565 ms from bootstrap)
- terminal_sync_ms: `1775192628495` (+567 ms from bootstrap)
- first_step_service_finished_at_ms: `1775192628649` (+721 ms from bootstrap)
- case_finished_at_ms: `1775192628652` (+724 ms from bootstrap)
- first_inference_tool: `browser__click`
- first_inference_elapsed_ms: `522`
...
## Inference Calls
- call 1: method=chat_completions_tool_call start=1775192627955 finish=1775192628477 elapsed=522 tool=browser__click
