...
| Draft a professional email to my landlord asking whether the lease renewal paperwork is ready and keep it concise. | no | artifact_markdown | tool_execution | presentation_surface: expected 'communication_surface', got 'artifact_surface'; verification_required_checks_include: expected ['communication_surface_rendered'], got ['artifact_contract_recorded', 'artifact_surface_rendered'] |
...
- clarification: n/a
- failures:
  - presentation_surface: expected 'communication_surface', got 'artifact_surface'
  - verification_required_checks_include: expected ['communication_surface_rendered'], got ['artifact_contract_recorded', 'artifact_surface_rendered']
