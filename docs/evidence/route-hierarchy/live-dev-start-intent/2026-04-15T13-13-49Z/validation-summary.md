...
| Who is the current Secretary-General of the UN? | no | conversation_single_pass | tool_execution | selected_route_contains: expected substring 'adaptive_work_graph' in 'conversation_single_pass' |
| What's happening this week? | yes | conversation_plan_execute | tool_execution | ok |
...
| Summarize my Slack unread messages | yes | conversation_connector_single_pass | tool_execution | ok |
...
| A mortgage calculator where I can adjust rate, term, and down payment | no | n/a | n/a | route_family: expected 'artifacts', got None; output_intent: expected 'artifact', got None; file_output_intent: expected False, got None; artifact_output_intent: expected True, got None; selected_route_contains: expected substring 'artifact_html_iframe' in None |
...
- clarification: n/a
- failures:
  - selected_route_contains: expected substring 'adaptive_work_graph' in 'conversation_single_pass'

### What's happening this week?

- passed: yes
- route_family: research
- selected_route: conversation_plan_execute
- output_intent: tool_execution
- primary_tools: n/a
- broad_fallback_tools: n/a
...
- passed: yes
- route_family: integrations
- selected_route: conversation_connector_single_pass
- output_intent: tool_execution
- primary_tools: n/a
- broad_fallback_tools: n/a
...
- failures:
  - route_family: expected 'artifacts', got None
  - output_intent: expected 'artifact', got None
  - file_output_intent: expected False, got None
  - artifact_output_intent: expected True, got None
  - selected_route_contains: expected substring 'artifact_html_iframe' in None
