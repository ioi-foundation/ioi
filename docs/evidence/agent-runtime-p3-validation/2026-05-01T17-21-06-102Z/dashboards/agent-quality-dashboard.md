...
| Partial | Autopilot GUI retained-query tests | guide:2178 | No passing Autopilot GUI retained-query result was found in docs/evidence/autopilot-gui-harness-validation. |
