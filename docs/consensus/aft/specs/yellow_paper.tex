...
also an honest claim of unconditional classical \code{99\% Byzantine
agreement} in the ordinary permissioned setting. \AFT{} does not weaken the
...
classical sentence, not a residual qualifier. Here ``no qualifiers'' excludes
external helpers: no trusted relay, no privileged coordinator, no TEE, no
theorem-side bootstrap oracle, and no hidden external recovery service. It
...
historical-continuation machinery named above is fixed as part of the
protocol, no extra trusted relay, coordinator, or theorem-side bootstrap
service remains hiding behind the classical sentence. Those objects are
...
No hidden helper regime is meant to sit underneath that promotion: ``no
...
runtime mirrors the same story through a persistent historical-retrievability
...
Without that plane, uniqueness may still hold while timely revelation can
fail.
...
\code{docs/specs/formal/aft/canonical\_ordering/CanonicalOrderingOmissionTrace.tla},
paired with
\code{docs/specs/formal/aft/canonical\_ordering/CanonicalOrderingOmissionTrace.cfg}.
...
\code{docs/specs/formal/aft/canonical\_ordering/CanonicalCollapseRecursiveContinuity.tla},
paired with
\code{docs/specs/formal/aft/canonical\_ordering/CanonicalCollapseRecursiveContinuity.cfg}.
...
Remove that carrier and the paper is no longer claiming the same result,
...
revelation phrasing, provided the mechanism and system model are stated
honestly.
...
The word ``unconditional'' is used extensionally here: once the explicit
system model and the protocol-internal continuity machinery above are fixed, no further relay,
coordinator, privileged recovery oracle, or theorem-side bootstrap caveat
remains. Removing the retrievability / continuation plane would not reveal a
simpler hidden theorem; it would change the theorem being claimed.
``Universally'' means that the lower bound is no longer load-bearing across the
full promoted AFT theorem surface: canonical ordering, retrievability,
collapse, recovery, restart continuity, and sealed-effect release are
protocol-defined, endogenous, and publicly checkable rather than delegated to
an external trusted substrate.
...
inside its original model. The intended reading is therefore: same promoted
...
\embedartifact
  ...
  {app:gm-proof}
  {\detokenize{docs/specs/formal/aft/guardian_majority/GuardianMajorityProof.tla}}
  {\detokenize{../../../specs/formal/aft/guardian_majority/GuardianMajorityProof.tla}}

\embedartifact
  {GuardianMajority.tla}
  {app:gm-model}
  {\detokenize{docs/specs/formal/aft/guardian_majority/GuardianMajority.tla}}
  {\detokenize{../../../specs/formal/aft/guardian_majority/GuardianMajority.tla}}
...
\embedartifact
  ...
  {app:co-proof}
  {\detokenize{docs/specs/formal/aft/canonical_ordering/CanonicalOrderingProof.tla}}
  {\detokenize{../../../specs/formal/aft/canonical_ordering/CanonicalOrderingProof.tla}}

\embedartifact
  {CanonicalOrdering.tla}
  {app:co-model}
  {\detokenize{docs/specs/formal/aft/canonical_ordering/CanonicalOrdering.tla}}
  {\detokenize{../../../specs/formal/aft/canonical_ordering/CanonicalOrdering.tla}}
...
\embedartifact
  {AsymptoteProof.tla}
  {app:asymptote-proof}
  {\detokenize{docs/specs/formal/aft/AsymptoteProof.tla}}
  {\detokenize{../../../specs/formal/aft/AsymptoteProof.tla}}

\embedartifact
  {Asymptote.tla}
  {app:asymptote-model}
  {\detokenize{docs/specs/formal/aft/Asymptote.tla}}
  {\detokenize{../../../specs/formal/aft/Asymptote.tla}}
...
\embedartifact
  ...
  {app:ng-proof}
  {\detokenize{docs/specs/formal/aft/nested_guardian/NestedGuardianProof.tla}}
  {\detokenize{../../../specs/formal/aft/nested_guardian/NestedGuardianProof.tla}}

\embedartifact
  {NestedGuardian.tla}
  {app:ng-model}
  {\detokenize{docs/specs/formal/aft/nested_guardian/NestedGuardian.tla}}
  {\detokenize{../../../specs/formal/aft/nested_guardian/NestedGuardian.tla}}
...
\embedartifact
  ...
  {\detokenize{docs/specs/formal/aft/canonical_ordering/CanonicalOrderingOmissionTrace.tla}}
  {\detokenize{../../../specs/formal/aft/canonical_ordering/CanonicalOrderingOmissionTrace.tla}}

\embedartifact
  {CanonicalOrderingOmissionTrace.cfg}
  {app:co-omission-trace-cfg}
  {\detokenize{docs/specs/formal/aft/canonical_ordering/CanonicalOrderingOmissionTrace.cfg}}
  {\detokenize{../../../specs/formal/aft/canonical_ordering/CanonicalOrderingOmissionTrace.cfg}}

\embedartifact
  {CanonicalCollapseRecursiveContinuity.tla}
  {app:co-recursive-continuity}
  {\detokenize{docs/specs/formal/aft/canonical_ordering/CanonicalCollapseRecursiveContinuity.tla}}
  {\detokenize{../../../specs/formal/aft/canonical_ordering/CanonicalCollapseRecursiveContinuity.tla}}

\embedartifact
  {CanonicalCollapseRecursiveContinuity.cfg}
  {app:co-recursive-continuity-cfg}
  {\detokenize{docs/specs/formal/aft/canonical_ordering/CanonicalCollapseRecursiveContinuity.cfg}}
  {\detokenize{../../../specs/formal/aft/canonical_ordering/CanonicalCollapseRecursiveContinuity.cfg}}
...
\embedartifact
  ...
  {\detokenize{docs/specs/formal/aft/nested_guardian/NestedGuardianRecoveryRecurringInductionCore.tla}}
  {\detokenize{../../../specs/formal/aft/nested_guardian/NestedGuardianRecoveryRecurringInductionCore.tla}}

\embedartifact
  {NestedGuardianRecoveryRecurringProof.tla}
  {app:ng-recovery-recurring-proof}
  {\detokenize{docs/specs/formal/aft/nested_guardian/NestedGuardianRecoveryRecurringProof.tla}}
  {\detokenize{../../../specs/formal/aft/nested_guardian/NestedGuardianRecoveryRecurringProof.tla}}

\embedartifact
  {NestedGuardianRecoveryClassicalAgreementReduction.tla}
  {app:ng-recovery-reduction}
  {\detokenize{docs/specs/formal/aft/nested_guardian/NestedGuardianRecoveryClassicalAgreementReduction.tla}}
  {\detokenize{../../../specs/formal/aft/nested_guardian/NestedGuardianRecoveryClassicalAgreementReduction.tla}}

\embedartifact
  {NestedGuardianRecoveryClassicalAgreementTotality.tla}
  {app:ng-recovery-totality}
  {\detokenize{docs/specs/formal/aft/nested_guardian/NestedGuardianRecoveryClassicalAgreementTotality.tla}}
  {\detokenize{../../../specs/formal/aft/nested_guardian/NestedGuardianRecoveryClassicalAgreementTotality.tla}}

\embedartifact
  {NestedGuardianRecoveryClassicalAgreementCollapse.tla}
  {app:ng-recovery-collapse}
  {\detokenize{docs/specs/formal/aft/nested_guardian/NestedGuardianRecoveryClassicalAgreementCollapse.tla}}
  {\detokenize{../../../specs/formal/aft/nested_guardian/NestedGuardianRecoveryClassicalAgreementCollapse.tla}}
