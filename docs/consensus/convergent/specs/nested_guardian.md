...
NestedGuardian is the witness-augmented mode within the broader Convergent
...
- outer validators run the convergent Convergent deterministic message flow
...
- `formal/convergent/nested_guardian/NestedGuardianProof.tla` proves the
  unbounded witness-augmented safety kernel in TLAPS
- the executable TLA+ model in `formal/convergent/nested_guardian/` checks
...
mode should be treated as a witness-augmented convergent path with unbounded
