...
| Recovery/handoff/commit contracts | Started | The SDK now exposes fail-closed recovery policies, credential-safe human handoff state, outcome contracts, external-effect commit gates, and retention checks; daemon policy executor and Autopilot inspectors still need to consume them. |
