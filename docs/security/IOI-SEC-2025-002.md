...
Status: resolved security advisory (historical record).
Canonical owner: none; retained as a dated advisory record — it binds no current work
Document class: `decision-history`
Doctrine status: archived
Implementation status: built (patched; see the advisory body for the fixing commit)
...
**Status:** ✅ Patched  
**Fixed In:** Commit [`3e8d3c3`](https://github.com/ioi-network/ioi/commit/3e8d3c3bd265256a1e5a9c3f2d6794e14eedfad0)
...
* Commit: [`<commit-hash>`](https://github.com/ioi-network/ioi/commit/<commit-hash>)
...
Discovered by internal security review of the IOI Kernel Validator architecture.
