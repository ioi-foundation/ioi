...
**Status:** ✅ Patched  
**Fixed In:** Commit [`32c05a8c`](https://github.com/ioi-network/ioi-sdk/commit/tbd)

---

## 1. Summary

A replay vulnerability was discovered in the **misbehavior reporting subsystem** of the IOI SDK.  
...
| Transaction Processing | `crates/tx/src/unified/mod.rs` | Accepts forged reports without verifying canonicality |
...
| Tests | `crates/forge/tests/penalty_pos_e2e.rs`, `crates/forge/tests/penalty_poa_e2e.rs` | Replay protection test passed under vulnerable assumptions |
...
* Commit: [`TBD`](https://github.com/ioi-network/ioi-sdk/commit/TBD)
* Modules: `types`, `tx`, `forge`
* Tag: `v0.1.0`
...
| Date (UTC) | Event                                                        |
| ---------- | ------------------------------------------------------------ |
| 2025-11-07 | Vulnerability discovered during Forge PoS E2E replay testing |
