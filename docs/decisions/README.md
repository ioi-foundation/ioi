...
- [ADR 0050: Split AFT M12 Offline and Interactive Visibility](./0050-split-aft-m12-offline-and-interactive-visibility.md) (retains the M12a byte-portable impossibility result and opens QUV as a separately named, known-synchronous, non-portable M12b research candidate; no consensus or production claim follows)
- [ADR 0051: decentralized.cloud Is A Branded Public Front, A Job Primitive, And A Supply Registry — Never A Second Spine](./0051-decentralized-cloud-public-face-job-primitive-and-supply-registry.md) (permits a standalone public face and a human-or-agent `CloudJobRequest` over Hypervisor's optimized-placement lane, makes local capacity a venue, admits first-party supply only as a neutral receipted candidate, binds the routing fee to a minted `RoutingDecisionReceipt`, and keeps L1 sparse; nothing is built)
- [ADR 0052: Adopt A Hypervisor Bounded-Alpha Profile And Separate Base-Platform Acceptance From Application And Flagship Proofs](./0052-hypervisor-bounded-alpha-profile-and-base-platform-acceptance.md) (one supported single-operator Linux profile with one qualified harness/model route and a disclosed host-spawn venue; base-platform, optional-capability and flagship proofs are three acceptance classes never summed; sessions carry a closed default-empty authority profile enforced at daemon admission; application-specific contracts move out of shared core prose; canonical routes serve their owned surfaces; release qualification includes update/rollback and is not claimed early)
- [ADR 0053: The MVP Is The Governed Runtime — Marketplace, Commerce And Decentralized Cloud Are Product Tracks, And The Alpha Profile Widens Toward Useful Work](./0053-the-mvp-is-the-governed-runtime-and-the-alpha-widens-toward-useful-work.md) (adds the `product_track` program scope and re-scopes 30 units out of the release accounting; declares three profile widenings — a remote frontier model route, the microVM venue, the flagship developer journey — each a unit with a qualification bar and none claimed built; names the exact-effect review chain as the next kernel program)
- [ADR 0054: Defer The decentralized.* Candidate Engines, Place Through The Underlying Providers, And Move The Product Out Of This Repository](./0054-defer-the-decentralized-candidate-engines-and-place-through-the-underlying-providers.md) (supersedes ADR 0051; the engines were never live, the eight provider adapters already propose, and re-entry is a measured trigger rather than a plan)
