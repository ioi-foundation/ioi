---- MODULE CanonicalOrderingOmissionTrace_TTrace_1773787769 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CanonicalOrderingOmissionTrace_TTrace_1773787769.json", _TETrace)
...
\*
\*trace == IODeserialize("CanonicalOrderingOmissionTrace_TTrace_1773787769.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CanonicalOrderingOmissionTrace_TTrace_1773787769 ----
CONSTANTS
    Slots = { 1 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Mar 17 18:49:29 EDT 2026