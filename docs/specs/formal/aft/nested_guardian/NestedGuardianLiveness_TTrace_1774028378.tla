---- MODULE NestedGuardianLiveness_TTrace_1774028378 ----
...
_inv ==
    ~(
        ...
        /\
        witnessCerts = ({<<w2, s1, b1, 2>>})
        /\
        continuationPagePublished = ()
        /\
        reassignmentDepth = ((s1 :> 1))
        /\
        continuationBoundary = ()
        /\
        guardianReady = ((v1 :> TRUE @@ v2 :> TRUE))
        /\
        assignedWitness = ((s1 :> w2))
        /\
        finalized = ({})
        /\
        churnStage = (7)
        /\
        registryEpoch = ((v1 :> 2 @@ v2 :> 2))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("NestedGuardianLiveness_TTrace_1774028378.json", _TETrace)
...
\*
\*trace == IODeserialize("NestedGuardianLiveness_TTrace_1774028378.bin", TRUE)
\*
\*=============================================================================
\*
...
trace ==
    ...
    ([phase |-> "churn",continuationAnchorBoundary |-> 0,continuationAnchorPublished |-> FALSE,continuationFetched |-> FALSE,finalizerSets |-> (<<s1, b1, 1>> :> {} @@ <<s1, b1, 2>> :> {} @@ <<s1, b2, 1>> :> {} @@ <<s1, b2, 2>> :> {}),witnessCerts |-> {},continuationPagePublished |-> FALSE,reassignmentDepth |-> (s1 :> 0),continuationBoundary |-> 0,guardianReady |-> (v1 :> TRUE @@ v2 :> FALSE),assignedWitness |-> (s1 :> w1),finalized |-> {},churnStage |-> 1,registryEpoch |-> (v1 :> 1 @@ v2 :> 1),witnessCheckpoint |-> (w1 :> 1 @@ w2 :> 1),votes |-> {},witnessOnline |-> (w1 :> TRUE @@ w2 :> TRUE),continuationPageBoundary |-> 0]),
    ([phase |-> "churn",continuationAnchorBoundary |-> 0,continuationAnchorPublished |-> FALSE,continuationFetched |-> FALSE,finalizerSets |-> (<<s1, b1, 1>> :> {} @@ <<s1, b1, 2>> :> {} @@ <<s1, b2, 1>> :> {} @@ <<s1, b2, 2>> :> {}),witnessCerts |-> {},continuationPagePublished |-> FALSE,reassignmentDepth |-> (s1 :> 0),continuationBoundary |-> 0,guardianReady |-> (v1 :> TRUE @@ v2 :> FALSE),assignedWitness |-> (s1 :> w1),finalized |-> {},churnStage |-> 2,registryEpoch |-> (v1 :> 1 @@ v2 :> 1),witnessCheckpoint |-> (w1 :> 1 @@ w2 :> 1),votes |-> {},witnessOnline |-> (w1 :> FALSE @@ w2 :> TRUE),continuationPageBoundary |-> 0]),
    ([phase |-> "churn",continuationAnchorBoundary |-> 0,continuationAnchorPublished |-> FALSE,continuationFetched |-> FALSE,finalizerSets |-> (<<s1, b1, 1>> :> {} @@ <<s1, b1, 2>> :> {} @@ <<s1, b2, 1>> :> {} @@ <<s1, b2, 2>> :> {}),witnessCerts |-> {},continuationPagePublished |-> FALSE,reassignmentDepth |-> (s1 :> 1),continuationBoundary |-> 0,guardianReady |-> (v1 :> TRUE @@ v2 :> FALSE),assignedWitness |-> (s1 :> w2),finalized |-> {},churnStage |-> 3,registryEpoch |-> (v1 :> 1 @@ v2 :> 1),witnessCheckpoint |-> (w1 :> 1 @@ w2 :> 1),votes |-> {},witnessOnline |-> (w1 :> FALSE @@ w2 :> TRUE),continuationPageBoundary |-> 0]),
    ([phase |-> "churn",continuationAnchorBoundary |-> 0,continuationAnchorPublished |-> FALSE,continuationFetched |-> FALSE,finalizerSets |-> (<<s1, b1, 1>> :> {} @@ <<s1, b1, 2>> :> {} @@ <<s1, b2, 1>> :> {} @@ <<s1, b2, 2>> :> {}),witnessCerts |-> {},continuationPagePublished |-> FALSE,reassignmentDepth |-> (s1 :> 1),continuationBoundary |-> 0,guardianReady |-> (v1 :> TRUE @@ v2 :> FALSE),assignedWitness |-> (s1 :> w2),finalized |-> {},churnStage |-> 4,registryEpoch |-> (v1 :> 2 @@ v2 :> 1),witnessCheckpoint |-> (w1 :> 1 @@ w2 :> 1),votes |-> {},witnessOnline |-> (w1 :> FALSE @@ w2 :> TRUE),continuationPageBoundary |-> 0]),
    ([phase |-> "churn",continuationAnchorBoundary |-> 0,continuationAnchorPublished |-> FALSE,continuationFetched |-> FALSE,finalizerSets |-> (<<s1, b1, 1>> :> {} @@ <<s1, b1, 2>> :> {} @@ <<s1, b2, 1>> :> {} @@ <<s1, b2, 2>> :> {}),witnessCerts |-> {},continuationPagePublished |-> FALSE,reassignmentDepth |-> (s1 :> 1),continuationBoundary |-> 0,guardianReady |-> (v1 :> TRUE @@ v2 :> FALSE),assignedWitness |-> (s1 :> w2),finalized |-> {},churnStage |-> 5,registryEpoch |-> (v1 :> 2 @@ v2 :> 1),witnessCheckpoint |-> (w1 :> 1 @@ w2 :> 0),votes |-> {},witnessOnline |-> (w1 :> FALSE @@ w2 :> TRUE),continuationPageBoundary |-> 0]),
    ([phase |-> "churn",continuationAnchorBoundary |-> 0,continuationAnchorPublished |-> FALSE,continuationFetched |-> FALSE,finalizerSets |-> (<<s1, b1, 1>> :> {} @@ <<s1, b1, 2>> :> {} @@ <<s1, b2, 1>> :> {} @@ <<s1, b2, 2>> :> {}),witnessCerts |-> {},continuationPagePublished |-> FALSE,reassignmentDepth |-> (s1 :> 1),continuationBoundary |-> 1,guardianReady |-> (v1 :> TRUE @@ v2 :> FALSE),assignedWitness |-> (s1 :> w2),finalized |-> {},churnStage |-> 6,registryEpoch |-> (v1 :> 2 @@ v2 :> 1),witnessCheckpoint |-> (w1 :> 1 @@ w2 :> 0),votes |-> {},witnessOnline |-> (w1 :> FALSE @@ w2 :> TRUE),continuationPageBoundary |-> 0]),
    ([phase |-> "stable",continuationAnchorBoundary |-> 0,continuationAnchorPublished |-> FALSE,continuationFetched |-> FALSE,finalizerSets |-> (<<s1, b1, 1>> :> {} @@ <<s1, b1, 2>> :> {} @@ <<s1, b2, 1>> :> {} @@ <<s1, b2, 2>> :> {}),witnessCerts |-> {},continuationPagePublished |-> FALSE,reassignmentDepth |-> (s1 :> 1),continuationBoundary |-> 1,guardianReady |-> (v1 :> TRUE @@ v2 :> TRUE),assignedWitness |-> (s1 :> w2),finalized |-> {},churnStage |-> 7,registryEpoch |-> (v1 :> 2 @@ v2 :> 2),witnessCheckpoint |-> (w1 :> 1 @@ w2 :> 1),votes |-> {},witnessOnline |-> (w1 :> TRUE @@ w2 :> TRUE),continuationPageBoundary |-> 0]),
    ([phase |-> "stable",continuationAnchorBoundary |-> ,continuationAnchorPublished |-> ,continuationFetched |-> ,finalizerSets |-> (<<s1, b1, 1>> :> {} @@ <<s1, b1, 2>> :> {} @@ <<s1, b2, 1>> :> {} @@ <<s1, b2, 2>> :> {}),witnessCerts |-> {<<w2, s1, b1, 2>>},continuationPagePublished |-> ,reassignmentDepth |-> (s1 :> 1),continuationBoundary |-> ,guardianReady |-> (v1 :> TRUE @@ v2 :> TRUE),assignedWitness |-> (s1 :> w2),finalized |-> {},churnStage |-> 7,registryEpoch |-> (v1 :> 2 @@ v2 :> 2),witnessCheckpoint |-> (w1 :> 1 @@ w2 :> 1),votes |-> {},witnessOnline |-> (w1 :> TRUE @@ w2 :> TRUE),continuationPageBoundary |-> ])
    >>
----
...
---- CONFIG NestedGuardianLiveness_TTrace_1774028378 ----
CONSTANTS
    Validators = { v1 , v2 }
    Witnesses = { w1 , w2 }
    Blocks = { b1 , b2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Mar 20 13:39:38 EDT 2026