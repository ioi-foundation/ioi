...
- 2026-05-13: P0-C executable diagnostics repair `restore_preview`
- Evidence:
...
1. Add action execution for the remaining diagnostics repair decisions:
   `restore_apply`, `repair_retry`, and `operator_override`. Use the
   `restore_preview` executor as the reference pattern.
...
1. Execute the remaining diagnostics repair decisions from the graph policy:
   `restore_apply`, `repair_retry`, and `operator_override`.
