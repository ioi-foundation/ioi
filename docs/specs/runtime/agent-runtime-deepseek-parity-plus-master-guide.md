...
- 2026-05-14: P1-D coding-tool budget run-launch preflight
- Evidence:
  focused readiness and run-history tests proving prior
  `tui_coding_tool_rows` budget evidence blocks or annotates the workflow Run
  launch path for follow-up mutating coding-tool nodes, source contracts for
  the readiness model, composer controller/view, graph runtime options, and
  rail wiring, focused live daemon coding-tool proof, broad React Flow guard,
...
- Current slice proof: focused readiness and run-history tests,
  `tui_coding_tool_rows` run-launch preflight evidence, focused live daemon
  coding-tool proof, React Flow/source-contract guards, agent-ide build, and
  live GUI/workflow preflight.
- Latest GUI/workflow preflight is recorded in the validation ledger for the
  coding-tool budget run-launch preflight slice.
