...
- 2026-05-13: P0-A/P0-C React Flow run-inspector diagnostics repair
  actions
- Evidence:
  focused projection, run-inspector, Agent IDE, Autopilot app, Tauri daemon
  bridge, source contract, and live GUI preflight validation in the validation
  ledger
- Trace detail:
  `docs/specs/runtime/agent-runtime-deepseek-parity-plus-implementation-log.md`
  and
...
1. Prove the full blocked-diagnostics recovery loop from a projected React Flow
   row action click to daemon repair event emission, refreshed React Flow
   projection, and TUI replay.
