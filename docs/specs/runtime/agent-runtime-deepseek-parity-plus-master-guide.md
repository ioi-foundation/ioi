...
- 2026-05-14: P1-C daemon-gated workflow edit proposals
- Evidence:
  SDK/agent-ide builds, edit-proposal control/policy/event-projection/run-history
  unit tests, focused live daemon proposal reject/approve/apply/replay proof,
  prior policy-stack regression, React Flow source-contract guard, and live
...
1. Move to P1-D usage/cost/context polish: make proposal, approval, subagent,
   and coding runs consume the same run-level usage/context-pressure telemetry
   in the run inspector and TUI rows.
...
- Current slice proof: workflow edit proposal control/policy/event-projection
  and run-history unit tests, SDK/agent-ide builds, focused live React Flow
  proposal reject/approve/apply/replay proof, prior policy-stack regression,
...
- Latest GUI/workflow preflight is recorded in the validation ledger for the
  daemon-gated workflow edit proposal slice.

Next runtime implementation sequence:

1. Move to P1-D usage/cost/context polish: unify run-level usage and context
   telemetry across proposal, approval, coding-tool, subagent, and TUI rows.
