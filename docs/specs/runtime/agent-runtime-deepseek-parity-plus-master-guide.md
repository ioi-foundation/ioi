...
- 2026-05-13: P0-D keyboard-first TUI restore UX
- Evidence:
...
1. Add action execution for diagnostics repair decisions:
...
1. Execute diagnostics repair decisions from the graph policy:
   `repair_retry`, `restore_preview`, `restore_apply`, and
   `operator_override`.
