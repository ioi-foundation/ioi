...
- Current slice proof: telemetry-summary and coding-tool-control unit tests,
  agent-ide build, focused live daemon coding-tool summary-budget proof,
  approval regression proof, source-contract guards, and live GUI/workflow
  preflight.
- Latest GUI/workflow preflight is recorded in the validation ledger for the
  coding-tool summary-budget enforcement slice.
