...
- 2026-05-14: P1-D coding-tool budget run-history evidence
- Evidence:
  focused run-history and telemetry-summary tests proving
  `tui_coding_tool_rows` source filters expose prior coding-tool budget blocks,
  visible Runs rail budget evidence, focused live daemon coding-tool proof,
  React Flow/source-contract guards, agent-ide build, and live GUI/workflow
...
- Current slice proof: focused run-history and telemetry-summary tests,
  source-filtered Runs rail coding-tool budget evidence, focused live daemon
...
- Latest GUI/workflow preflight is recorded in the validation ledger for the
  coding-tool budget run-history evidence slice.

Next runtime implementation sequence:

1. Continue P1-D usage/cost/context polish: connect
   `tui_coding_tool_rows` run-history evidence to workflow readiness/run
   preflight so a later mutating coding-tool node is visibly warned or blocked
