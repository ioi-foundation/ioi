...
- 2026-05-13: P0-A/P0-C TUI diagnostics repair decision controls
- Evidence:
...
1. Add workflow recovery action nodes or run-inspector controls that execute
   diagnostics repair decisions directly from React Flow with graph/node
   identity, reusing the existing daemon endpoint and SDK method.
