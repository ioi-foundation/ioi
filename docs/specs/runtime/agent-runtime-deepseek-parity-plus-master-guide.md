...
- 2026-05-13: P0-A/P1-B TUI MCP search/fetch source-mode UX
- Evidence:
...
1. Thread executable diagnostics repair decisions into richer terminal TUI and
   workflow recovery UX, reusing the existing repair/restore daemon contracts.
