...
- 2026-05-13: P0-C diagnostics rollback/repair policy
- Evidence:
...
1. Promote restore preview/apply controls into the workflow binding editor so
   React Flow nodes can configure restore policy, conflict behavior, and apply
   authority.
2. Add workflow editor controls for diagnostics rollback/repair policy:
   preferred decision, restore preview/apply authority, and operator override
   requirements.
3. If a keyboard-first TUI gap appears while wiring restore, keep it
...
1. Promote restore preview/apply and diagnostics rollback/repair policy into
   workflow binding controls.
