...
| --- | --- | --- | --- |
| P0 | Blank composer Run safety | Invalid or blank workflows fail closed in the composer with validation/readiness evidence; no Chat render-blocked page. | Planned |
