...
| 186 | 2026-05-14 | P1-D. Usage, Cost, Context Telemetry / P0. Terminal Coding-Agent TUI / P0-B. Coding Tool Pack | CLI/TUI coding-tool budget-row producer | /tmp/ioi-autopilot-gui-harness-coding-tool-budget-tui-producer/2026-05-14T03-19-32-015Z/result.json | cargo fmt -p ioi-cli -- --check<br>cargo test -p ioi-cli --bin cli tui -- --nocapture<br>node --test --test-name-pattern "React Flow coding-tool budget gates consume runtime telemetry summary before mutation" scripts/lib/live-runtime-daemon-contract.test.mjs<br>node --test --test-name-pattern "agent CLI exposes model, thinking, and stream control contracts&#124;agent TUI thin shell is daemon-backed" scripts/lib/live-runtime-daemon-contract.test.mjs<br>node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs<br>node --import tsx --test --test-name-pattern "coding tool budget&#124;TUI coding-tool budget" packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts<br>node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs<br>npm run validate:autopilot-gui-harness -- --output-root /tmp/ioi-autopilot-gui-harness-coding-tool-budget-tui-producer |
| 187 | 2026-05-14 | P1-D. Usage, Cost, Context Telemetry / P0-B. Coding Tool Pack | coding-tool budget telemetry-summary aggregation | /tmp/ioi-autopilot-gui-harness-coding-tool-budget-telemetry-summary/2026-05-14T03-27-24-067Z/result.json | node --import tsx --test packages/agent-ide/src/runtime/workflow-runtime-telemetry-summary.test.ts packages/agent-ide/src/runtime/workflow-runtime-coding-tool-control-nodes.test.ts<br>node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs<br>node --test --test-name-pattern "React Flow coding-tool budget gates consume runtime telemetry summary before mutation" scripts/lib/live-runtime-daemon-contract.test.mjs<br>npm run build --workspace=@ioi/agent-ide<br>node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs<br>npm run validate:autopilot-gui-harness -- --output-root /tmp/ioi-autopilot-gui-harness-coding-tool-budget-telemetry-summary<br>git diff --check |
| 188 | 2026-05-14 | P1-D. Usage, Cost, Context Telemetry / P0-B. Coding Tool Pack | coding-tool budget run-history evidence | /tmp/ioi-autopilot-gui-harness-coding-tool-budget-run-history/2026-05-14T03-39-35-777Z/result.json | node --import tsx --test packages/agent-ide/src/runtime/workflow-run-history-model.test.ts packages/agent-ide/src/runtime/workflow-runtime-telemetry-summary.test.ts<br>node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs<br>npm run build --workspace=@ioi/agent-ide<br>node --test --test-name-pattern "React Flow coding-tool budget gates consume runtime telemetry summary before mutation" scripts/lib/live-runtime-daemon-contract.test.mjs<br>node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs<br>npm run validate:autopilot-gui-harness -- --output-root /tmp/ioi-autopilot-gui-harness-coding-tool-budget-run-history<br>git diff --check |
| 189 | 2026-05-14 | P1-D. Usage, Cost, Context Telemetry / P0-B. Coding Tool Pack | coding-tool budget readiness preflight | /tmp/ioi-autopilot-gui-harness-coding-tool-budget-readiness-preflight/2026-05-14T03-48-02-824Z/result.json | node --import tsx --test packages/agent-ide/src/runtime/workflow-readiness-model.test.ts packages/agent-ide/src/runtime/workflow-run-history-model.test.ts<br>node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs<br>npm run build --workspace=@ioi/agent-ide<br>node --test --test-name-pattern "React Flow coding-tool budget gates consume runtime telemetry summary before mutation" scripts/lib/live-runtime-daemon-contract.test.mjs<br>node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs<br>npm run validate:autopilot-gui-harness -- --output-root /tmp/ioi-autopilot-gui-harness-coding-tool-budget-readiness-preflight<br>git diff --check |
| 190 | 2026-05-14 | P1-D. Usage, Cost, Context Telemetry / P0-B. Coding Tool Pack | coding-tool budget run-launch preflight | /tmp/ioi-autopilot-gui-harness-coding-tool-budget-run-launch-preflight/2026-05-14T03-58-36-539Z/result.json | node --import tsx --test packages/agent-ide/src/runtime/workflow-readiness-model.test.ts packages/agent-ide/src/runtime/workflow-run-history-model.test.ts<br>node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs<br>npm run build --workspace=@ioi/agent-ide<br>node --test --test-name-pattern "React Flow coding-tool budget gates consume runtime telemetry summary before mutation" scripts/lib/live-runtime-daemon-contract.test.mjs<br>node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs<br>npm run validate:autopilot-gui-harness -- --output-root /tmp/ioi-autopilot-gui-harness-coding-tool-budget-run-launch-preflight<br>git diff --check |
...
| 197 | 2026-05-14 | P1-D. Usage, Cost, Context Telemetry / P0-B. Coding Tool Pack | reusable coding-tool budget recovery template | /tmp/ioi-autopilot-gui-harness-coding-tool-budget-recovery-template/2026-05-14T12-58-07-902Z/result.json | node --import tsx --test --test-reporter=spec packages/agent-ide/src/runtime/workflow-runtime-coding-tool-budget-recovery-subflow.test.ts packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts<br>node --test --test-reporter=spec --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs<br>npm run build -w packages/agent-ide<br>git diff --check<br>npm run validate:autopilot-gui-harness -- --output-root /tmp/ioi-autopilot-gui-harness-coding-tool-budget-recovery-template |
...
- `node --test --import tsx packages/agent-ide/src/runtime/workflow-runtime-terminal-coding-loop-subflow.test.ts packages/agent-ide/src/runtime/workflow-runtime-terminal-coding-loop-materialization.test.ts packages/agent-ide/src/runtime/workflow-runtime-terminal-coding-loop-execution.test.ts`
- `node --check scripts/lib/live-runtime-daemon-contract.test.mjs`
- `node --test --test-reporter=spec --test-name-pattern "React Flow terminal coding-loop template executes" scripts/lib/live-runtime-daemon-contract.test.mjs`
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
- `npm run build --workspace=@ioi/agent-ide`
...
- The execution helper tests passed for node ordering, placeholder resolution,
  context update, artifact preservation, and result retrieval targeting the
  original test tool-call id.
- The live daemon contract passed for the complete React Flow-authored
  terminal loop: status, diff, inspect, patch dry-run, approval-gated patch
  apply, test artifact spillover, diagnostics, artifact read, and result
  retrieval.
- The workflow runtime source contract passed and now guards the execution
  helper, index export, and live daemon proof.
- The full live Autopilot GUI harness passed with the terminal-loop creator and
  run-inspector GUI proof artifacts present in the evidence bundle.
...
- `node --test --import tsx packages/agent-ide/src/runtime/workflow-runtime-terminal-coding-loop-subflow.test.ts packages/agent-ide/src/runtime/workflow-runtime-terminal-coding-loop-materialization.test.ts`
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
- `node --test scripts/lib/autopilot-gui-harness-contract.test.mjs`
- `node --import tsx scripts/lib/workflow-terminal-coding-loop-creator-gui-probe.mjs /tmp/workflow-terminal-coding-loop-creator-proof.json`
- `node --import tsx scripts/lib/workflow-terminal-coding-loop-run-inspector-probe.mjs /tmp/workflow-terminal-coding-loop-run-inspector-proof.json`
- `npm run build --workspace=@ioi/agent-ide`
- `npm run validate:autopilot-gui-harness`
  - preflight passed and wrote
...
- docs/evidence/autopilot-gui-harness-validation/2026-05-14T15-31-52-944Z/workflow-telemetry-budget-chain-run-inspector-proof.json
...
- `node --import tsx --test --test-reporter=spec packages/agent-ide/src/runtime/workflow-runtime-telemetry-budget-chain-materialization.test.ts packages/agent-ide/src/runtime/workflow-runtime-telemetry-source-binding.test.ts`
  - focused TS tests passed for materializing a four-node chain, hydrating an
    existing compatible chain, blocking missing telemetry evidence, and surfacing
    readiness failure when an upstream telemetry binding is removed.
- `node --import tsx scripts/lib/workflow-telemetry-budget-chain-run-inspector-probe.mjs /tmp/workflow-telemetry-budget-chain-run-inspector-proof.json`
  - targeted proof passed for the run-inspector button, view/controller/rail
    wiring, materialization, hydration, missing-evidence blocker, readiness pass,
    and broken-upstream-binding readiness failure.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - source-contract guard passed for the helper, exports, focused tests,
    run-inspector UI affordance, probe script, and harness keys.
- `node --test scripts/lib/autopilot-gui-harness-contract.test.mjs`
  - GUI harness contract test passed with the new artifact and runtime
...
- `npm run validate:autopilot-gui-harness:run`
  - escalated live GUI run wrote
    `docs/evidence/autopilot-gui-harness-validation/2026-05-14T15-31-52-944Z/result.json`,
    was not blocked, all retained chat scenarios passed, and
    `workflow_telemetry_budget_chain_run_inspector` passed. The overall harness
...
- `node --import tsx scripts/lib/workflow-telemetry-budget-chain-creator-gui-probe.mjs /tmp/workflow-telemetry-budget-chain-creator-proof.json`
  - targeted proof passed for the workflow creator control wiring, shared
    React Flow insertion mapper, four generated nodes, three generated edges,
    daemon request compilation, readiness-positive case, negative
    missing-upstream-binding case, and telemetry-source quick binding.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - source-contract guard passed.
- `node --test scripts/lib/autopilot-gui-harness-contract.test.mjs`
  - GUI harness contract tests passed with the new artifact/runtime-consistency
    requirement.
- `node --import tsx --test --test-reporter=spec packages/agent-ide/src/runtime/workflow-runtime-telemetry-budget-chain-subflow.test.ts`
  - telemetry budget-chain subflow regression passed.
- `npm run build --workspace=@ioi/agent-ide`
  - agent-ide TypeScript and Vite build passed.
- `npm run validate:autopilot-gui-harness`
  - GUI harness preflight passed and wrote
...
- `npm run validate:autopilot-gui-harness:run`
  - escalated live GUI run wrote
    `docs/evidence/autopilot-gui-harness-validation/2026-05-14T15-09-35-601Z/result.json`,
    was not blocked, all eight retained chat scenarios passed, and
    `workflow_telemetry_budget_chain_creator` passed. The overall harness
    validator remains red on pre-existing package/activation evidence artifact
    gaps unrelated to this slice.
- `git diff --check -- ...`
...
- `node --import tsx --test --test-reporter=spec packages/agent-ide/src/runtime/workflow-runtime-telemetry-budget-chain-subflow.test.ts`
  - focused TS test passed for generated node/edge topology, daemon request
    compilation, activation readiness, negative missing-binding validation, and
    telemetry-source quick binding compatibility.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - source-contract guard passed for the helper, exports, composer controller,
    workflow-creator UI entry point, and focused test coverage.
- `npm run build --workspace=@ioi/agent-ide`
  - agent-ide TypeScript and Vite build passed.
- `node scripts/run-autopilot-gui-harness-validation.mjs --preflight`
  - direct harness preflight passed after replacing a fragile nested `node -e`
    package-script check with an in-process package read.
- `npm run validate:autopilot-gui-harness`
  - npm preflight passed and wrote
    `docs/evidence/autopilot-gui-harness-validation/2026-05-14T14-23-27-944Z/result.json`.
- `npm run validate:autopilot-gui-harness:run`
  - escalated live GUI run launched the desktop app, produced
    `docs/evidence/autopilot-gui-harness-validation/2026-05-14T14-47-23-326Z/result.json`,
    was not blocked, and all eight retained chat scenarios passed. The overall
    harness validator remains red on pre-existing package/activation evidence
    artifact gaps unrelated to the telemetry-chain template.
- `git diff --check -- ...`
  - scoped whitespace check passed for the files changed in this slice.
...
- `node --import tsx --test --test-reporter=spec packages/agent-ide/src/runtime/workflow-runtime-telemetry-source-binding.test.ts packages/agent-ide/src/runtime/workflow-runtime-usage-control-nodes.test.ts packages/agent-ide/src/runtime/workflow-runtime-context-budget-control-nodes.test.ts packages/agent-ide/src/runtime/workflow-runtime-compaction-policy-control-nodes.test.ts packages/agent-ide/src/runtime/workflow-runtime-coding-tool-control-nodes.test.ts`
  - focused TS tests passed for binding run-history telemetry into usage,
    context-budget, compaction-policy, and coding-tool budget-gate nodes and
    clearing the new readiness issues.
- `npm run build -w packages/agent-ide`
  - agent-ide TypeScript and Vite build passed.
- `node --test --test-reporter=spec scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - source-contract guard passed for the binding helper, focused tests,
    validation issues, controller callback, run-inspector affordance, and
    coding-tool telemetry consumption.
- `node --test --test-reporter=spec --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live source-contract guard passed for keeping telemetry-source binding
    workflow-addressable beside existing runtime controls.
- `git diff --check`
  - whitespace check passed.
...
- `node --import tsx --test --test-reporter=spec packages/agent-ide/src/runtime/workflow-runtime-coding-tool-budget-recovery-binding.test.ts packages/agent-ide/src/runtime/workflow-readiness-model.test.ts packages/agent-ide/src/runtime/workflow-runtime-coding-tool-budget-recovery-subflow.test.ts`
  - focused TS tests passed for selecting blocked-run budget evidence, binding
    request/approve/reject/retry template nodes, and clearing readiness issues
    before daemon request compilation.
- `npm run build -w packages/agent-ide`
  - agent-ide TypeScript and Vite build passed.
- `node --test --test-reporter=spec scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - source-contract guard passed for the binding helper, focused tests,
    controller callback, and run-inspector affordance.
- `node --test --test-reporter=spec --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live source-contract guard passed for keeping the recovery binding action
    workflow-addressable beside existing runtime controls.
- `git diff --check`
  - whitespace check passed.
...
- apps/autopilot/src-tauri/src/project/workflow_project_tests/activation_and_portability.rs
- scripts/lib/workflow-runtime-event-projection-contract.test.mjs
- scripts/lib/live-runtime-daemon-contract.test.mjs
- docs/specs/runtime/agent-runtime-deepseek-parity-plus-master-guide.md
- docs/specs/runtime/agent-runtime-deepseek-parity-plus-implementation-log.md
...
- `node --import tsx --test --test-reporter=spec packages/agent-ide/src/runtime/workflow-readiness-model.test.ts packages/agent-ide/src/runtime/workflow-runtime-coding-tool-budget-recovery-subflow.test.ts`
  - focused TS readiness/template tests passed for unbound and mapped recovery
    template inputs.
- `cargo test workflow_activation_readiness_blocks_unbound_coding_budget_recovery_templates --manifest-path apps/autopilot/src-tauri/Cargo.toml`
  - focused Tauri activation-readiness test passed for missing and fixed
    recovery-template bindings.
- `cargo fmt --manifest-path apps/autopilot/src-tauri/Cargo.toml -- --check`
  - Rust formatting check passed.
- `node --test --test-reporter=spec scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - source-contract guard passed for workflow validation/readiness coverage.
- `node --test --test-reporter=spec --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live source-contract guard passed for package and Tauri validation paths.
- `npm run build -w packages/agent-ide`
  - agent-ide TypeScript and Vite build passed.
- `git diff --check`
  - whitespace check passed.
...
- `node --import tsx --test --test-reporter=spec packages/agent-ide/src/runtime/workflow-runtime-coding-tool-budget-recovery-subflow.test.ts packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts`
  - focused TS subflow/projection tests passed, including configurable
    runtime-input template request compilation.
- `node --test --test-reporter=spec --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - source-contract guard passed for the template helper, controller callback,
    and React Flow composition helper button.
- `npm run build -w packages/agent-ide`
  - agent-ide TypeScript and Vite build passed.
- `git diff --check`
  - whitespace check passed.
...
- `node --import tsx --test --test-reporter=spec packages/agent-ide/src/runtime/workflow-runtime-coding-tool-budget-recovery-subflow.test.ts packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts`
  - focused TS subflow and projection tests passed.
- `npm run build -w packages/agent-ide`
  - agent-ide TypeScript and Vite build passed.
- `node --test --test-reporter=spec --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - source-contract guard passed for the helper, run-inspector affordance, and
    controller/view/rail wiring.
- `git diff --check`
  - whitespace check passed.
...
- apps/autopilot/src-tauri/src/project/workflow_project_tests/test_harness_and_runs.rs
- scripts/lib/workflow-runtime-event-projection-contract.test.mjs
- scripts/lib/live-runtime-daemon-contract.test.mjs
- docs/specs/runtime/agent-runtime-deepseek-parity-plus-master-guide.md
- docs/specs/runtime/agent-runtime-deepseek-parity-plus-implementation-log.md
...
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-readiness-model.test.ts packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts packages/agent-ide/src/runtime/workflow-run-history-model.test.ts`
  - Focused readiness, projection, and run-history tests passed with
    workflow-authored recovery policy in run-launch annotations and
    run-inspector recovery actions.
- `cargo test coding_tool_budget_preflight --lib` from `apps/autopilot/src-tauri`
  - Focused Tauri workflow-run tests passed with recovery-policy propagation,
    override-policy enforcement, and retry-limit exhaustion checks.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - Runtime projection source-contract guard passed with the shared recovery
    policy helper, run-inspector policy markers, and readiness helper import.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - Broad React Flow/runtime source-contract regression passed with editor
    recovery-policy controls, projected recovery policy, and Tauri retry-limit
    source guards.
- `npm run build --workspace=@ioi/agent-ide`
  - Agent IDE build passed.
- `cargo fmt --manifest-path apps/autopilot/src-tauri/Cargo.toml -- --check`
...
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - Runtime projection source-contract guard passed with the recovery schema,
    run-inspector recovery action markers, approved-retry event kind, and typed
    `codingToolBudgetRecovery` run option.
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts packages/agent-ide/src/runtime/workflow-runtime-policy-stack.test.ts packages/agent-ide/src/runtime/workflow-run-history-model.test.ts`
  - Focused projection, policy-stack, and run-history tests passed, including
    recovery action descriptors, daemon approved-retry recognition, and replay
    of request/decision/retry recovery chains.
- `npm run build --workspace=@ioi/agent-ide`
  - Agent IDE build passed.
- `cargo test coding_tool_budget_preflight --lib` from `apps/autopilot/src-tauri`
  - Focused Tauri workflow-run tests passed, including durable launch-policy
    block persistence and the approval/retry recovery flow.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - Broad React Flow/runtime source-contract regression passed with recovery
    button markers and daemon policy-lane source strings.
...
- apps/autopilot/src-tauri/src/project/workflow_run_policy_lane.rs
- apps/autopilot/src-tauri/src/project/commands.rs
- apps/autopilot/src-tauri/src/project/types.rs
...
- `cargo test workflow_project_run_records_coding_tool_budget_preflight_policy_block --manifest-path apps/autopilot/src-tauri/Cargo.toml`
  - Focused Tauri workflow run test passed, proving blocked preflight creates a
    durable run sidecar with `policy_blocked` timeline event, canonical
    runtime thread event, TUI coding-tool budget row, receipt refs, policy
    refs, and blocked node ids.
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts packages/agent-ide/src/runtime/workflow-run-history-model.test.ts packages/agent-ide/src/runtime/workflow-runtime-telemetry-summary.test.ts packages/agent-ide/src/runtime/workflow-readiness-model.test.ts`
  - Focused projection, run-history, telemetry-summary, and readiness tests
    passed, including daemon-owned coding-budget launch-block replay.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - Runtime projection source-contract guard passed with the new preflight
    block reason and run-history replay tests.
- `node --test --test-name-pattern "React Flow coding-tool budget gates consume runtime telemetry summary before mutation" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - Focused live daemon coding-tool budget proof passed with policy-lane source
    guards.
- `npm run build --workspace=@ioi/agent-ide`
  - Agent IDE build passed.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
...
- `cargo fmt --manifest-path apps/autopilot/src-tauri/Cargo.toml -- --check`
  - Tauri Rust formatting check passed.
...
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-readiness-model.test.ts packages/agent-ide/src/runtime/workflow-run-history-model.test.ts`
  - Focused readiness and run-history tests passed, including launch
    annotations for prior `tui_coding_tool_rows` budget evidence.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - Runtime event projection/source-contract guard passed for the launch
    preflight annotation, composer controller/view wiring, and typed run
    request option.
- `npm run build --workspace=@ioi/agent-ide`
  - Agent IDE build passed.
- `node --test --test-name-pattern "React Flow coding-tool budget gates consume runtime telemetry summary before mutation" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - Focused live daemon coding-tool summary-budget proof passed.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - Broad React Flow/runtime source-contract regression passed, including the
    run-launch preflight source strings.
...
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-readiness-model.test.ts packages/agent-ide/src/runtime/workflow-run-history-model.test.ts`
  - Focused readiness and run-history tests passed, including a blocked
    coding-budget preflight derived from prior `tui_coding_tool_rows` evidence.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - Runtime event projection/source-contract guard passed for the new readiness
    preflight model, panel, and rail evidence wiring.
- `npm run build --workspace=@ioi/agent-ide`
  - Agent IDE build passed.
- `node --test --test-name-pattern "React Flow coding-tool budget gates consume runtime telemetry summary before mutation" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - Focused live daemon coding-tool summary-budget proof passed.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - Broad React Flow/runtime source-contract regression passed, including the
    readiness preflight source strings.
...
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-run-history-model.test.ts packages/agent-ide/src/runtime/workflow-runtime-telemetry-summary.test.ts`
  - Focused run-history and telemetry-summary tests passed, including
    source-filtered `tui_coding_tool_rows` budget evidence.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - Runtime event projection/source-contract guard passed for the new run
    source filter, budget evidence card, source labels, and visible TUI row
    count contracts.
- `npm run build --workspace=@ioi/agent-ide`
  - Agent IDE build passed.
- `node --test --test-name-pattern "React Flow coding-tool budget gates consume runtime telemetry summary before mutation" scripts/lib/live-runtime-daemon-contract.test.mjs`
...
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-runtime-telemetry-summary.test.ts packages/agent-ide/src/runtime/workflow-runtime-coding-tool-control-nodes.test.ts`
  - Focused telemetry-summary and coding-tool budget-control tests passed,
    including TUI `coding_tool_budget` row aggregation into a
    `tui_coding_tool_rows` summary source.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - Runtime event projection source-contract guard passed for the new summary
    source kind, row count, and test fixture coverage.
- `node --test --test-name-pattern "React Flow coding-tool budget gates consume runtime telemetry summary before mutation" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - Live daemon proof passed: an actual CLI/TUI coding-tool budget row became
    a telemetry summary source, then blocked a follow-up React Flow
...
Guide section: P1-D. Usage, Cost, Context Telemetry / P0. Terminal Coding-Agent
TUI / P0-B. Coding Tool Pack
...
- `cargo fmt -p ioi-cli -- --check`
  - CLI Rust formatting check passed.
- `cargo test -p ioi-cli --bin cli tui -- --nocapture`
  - Focused TUI unit filter passed, including the new
    `tui_coding_tool_budget_rows_project_policy_blocks` and line-mode
    control-state coverage.
- `node --test --test-name-pattern "React Flow coding-tool budget gates consume runtime telemetry summary before mutation" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - Live daemon proof passed using actual `ioi agent tui --json`
    `coding_tool_rows` from the live budget-block event before React Flow
    projection.
- `node --test --test-name-pattern "agent CLI exposes model, thinking, and stream control contracts|agent TUI thin shell is daemon-backed" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - CLI/TUI source-contract guards passed for the new control-state row lane.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - Runtime event projection source-contract guard passed.
- `node --import tsx --test --test-name-pattern "coding tool budget|TUI coding-tool budget" packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts`
  - Focused React Flow coding-tool budget projection tests passed.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - Broad React Flow/runtime source-contract regression passed.
...
Guide section: P1-D. Usage, Cost, Context Telemetry / P1-A. Subagent Runtime
Parity
...
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-runtime-telemetry-summary.test.ts packages/agent-ide/src/runtime/workflow-run-history-model.test.ts`
  - telemetry-summary and run-history tests passed.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - source-contract guard passed with telemetry summary, run inspector, and
    export coverage.
- `node --check scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live contract syntax check passed.
- `npm run build --workspace=@ioi/agent-ide`
  - agent-ide TypeScript/Vite build passed.
- `node --test --test-name-pattern "daemon aggregates usage" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live daemon usage/subagent/context telemetry proof passed with the shared
    summary asserted over SDK events and TUI projection rows.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - broad React Flow/runtime source-contract regression passed.
...
- `npm run build --workspace=@ioi/agent-sdk`
  - SDK declaration and bundle build passed with `approval_decision` event
    normalization.
- `npm run build --workspace=@ioi/agent-ide`
  - agent-ide TypeScript/Vite build passed.
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-runtime-policy-stack.test.ts packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts packages/agent-ide/src/runtime/workflow-run-history-model.test.ts`
  - focused policy-stack, event-projection, and run-history model tests passed.
- `node --test --test-name-pattern "React Flow policy stack replays workspace trust and coding approval gates in order" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live daemon proof passed for workspace trust warning, acknowledgement,
    approval requirement, approval decision, approved retry, and idempotent
    replay with preserved graph/node identity.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - source-contract guard passed with the policy-stack model and run-inspector
    surface.
...
- `npm run check:runtime-layout`
  - runtime package/source-contract guard passed.
- `npm run build --workspace=@ioi/agent-ide`
  - agent-ide TypeScript/Vite build passed.
- `npm run build --workspace=@ioi/agent-sdk`
...
- `cargo test runtime_thread_mode_node_builds_react_flow_control_request --manifest-path apps/autopilot/src-tauri/Cargo.toml`
  - targeted Tauri workflow compiler contract passed for
    `runtime_thread_mode`.
- `node --test --test-name-pattern "workspace trust" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live daemon proof passed for React Flow-authored thread-mode requests,
    daemon workspace trust warning records, run-inspector acknowledgement
    action descriptors, daemon acknowledgement execution, SDK event mapping,
    and React Flow replay of `workspace_trust_acknowledged`.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - source-contract guard passed with the new node and helper contracts.
...
- `node --test --test-name-pattern "daemon owns thread mode, model, and thinking controls for TUI and React Flow" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - mode-control regression passed.
- `node --test --test-name-pattern "daemon requires approval before review-mode mutating coding tools from React Flow" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - review-mode mutating coding-tool approval gate, daemon event, SDK event,
    React Flow `human_gate`, TUI approval-row, and no-workspace-mutation proof
    passed.
- `node --test --test-name-pattern "coding tool pack invokes status, diff, inspect, apply patch, diagnostics, test run, and artifact retrieval across daemon, SDK, CLI, TUI, and React Flow" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - default coding-pack regression passed.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - source-contract guard passed.
...
- `node --check packages/runtime-daemon/src/index.mjs`
  - runtime daemon syntax passed with `context.pressure_alert` fixture and
    runtime-service bridge event emission.
- `node --import tsx --test --test-name-pattern "context-pressure alerts" packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts`
  - focused React Flow projection test passed for blocked alert rows,
    `hook_policy` identity, subagent aggregate scope, and action descriptors.
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-run-history-model.test.ts`
  - run-history model suite passed with live telemetry hydration including a
    context-pressure alert action row.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - workflow-addressable source-contract guard passed with context-pressure
    action rows and compact control execution wiring.
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts`
  - full runtime event projection suite passed.
- `npm run build --workspace=@ioi/agent-sdk`
  - SDK declaration and bundle build passed.
...
- packages/agent-ide/src/runtime/workflow-runtime-live-telemetry.ts
- packages/agent-ide/src/WorkflowComposer/controller.tsx
- packages/agent-ide/src/runtime/workflow-run-history-model.test.ts
- apps/autopilot/src-tauri/src/project/commands.rs
- apps/autopilot/src-tauri/src/project/workflow_project_tests/test_harness_and_runs.rs
...
- `node --import tsx --test --test-name-pattern "live telemetry" packages/agent-ide/src/runtime/workflow-run-history-model.test.ts`
  - focused React Flow model test passed for an in-flight running run hydrated
    from live `usage_delta` and `context_pressure_delta` events.
...
- `cargo test --manifest-path apps/autopilot/src-tauri/Cargo.toml workflow_run_project_reuses_prebound_thread_for_live_telemetry_hydration -- --nocapture`
  - Tauri regression passed, proving `run_workflow_project` reuses a
    GUI-created thread id and preserves final run/thread alignment.
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-run-history-model.test.ts`
  - full run-history model suite passed.
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts`
  - full runtime event projection suite passed.
- `cargo check --manifest-path apps/autopilot/src-tauri/Cargo.toml`
  - Tauri project check passed.
- `npm run build --workspace=@ioi/agent-ide`
  - Agent IDE build passed.
...
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-runtime-usage-control-nodes.test.ts`
  - 3 request-builder tests passed for thread, run, and workflow usage-meter
    daemon requests.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - React Flow source-contract guard passed with `UsageMeterNode`,
    `runtime_usage_meter`, and usage-meter metadata assertions.
- `node scripts/generate-runtime-action-contracts.mjs --check`
  - generated TypeScript and Rust runtime action contracts were up to date.
- `node --check packages/runtime-daemon/src/index.mjs`
  - daemon route metadata echo changes passed syntax validation.
- `npm run build --workspace=@ioi/agent-ide`
  - Agent IDE TypeScript and Vite build passed with the new node kind and
...
- `node --test --test-name-pattern "React Flow usage meter" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live daemon proof passed for a React Flow-authored usage meter reading
    thread and run usage telemetry with graph/node identity preserved.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - workflow-addressable regression guard remained green.
...
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts`
  - 12 projection tests passed, including collapsible subagent child-subflow
    descriptors and React Flow node/edge projection.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - runtime projection source contract passed with subflow descriptors and
    run-inspector rendering hooks.
- `node --check scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live daemon contract syntax check passed.
- `npm run build --workspace=@ioi/agent-ide`
  - React Flow package build passed with child-subflow projection and
    run-inspector rendering.
- `node --test --test-name-pattern "React Flow subagent fan-out workflow compiles nodes into live daemon controls" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live React Flow fan-out proof passed and required explorer, implementer,
    and verifier child runs to project as grouped subflows.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - workflow-addressability source guard passed with subflow rendering hooks.
...
Guide section: P1. Subagent Runtime Parity / P0. Terminal Coding-Agent TUI
...
- `cargo test -p ioi-cli --bin cli agent_tui -- --nocapture`
  - focused Rust TUI route/parser/control-state tests passed.
- `node --check scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live daemon contract syntax check passed.
- `npm run build --workspace=@ioi/agent-ide`
  - React Flow projection build passed with subagent row fields.
- `node --import tsx --test packages/agent-ide/src/runtime/workflow-runtime-event-projection.test.ts`
  - 12 projection tests passed, including TUI `subagent_rows`.
- `node --test --test-name-pattern "agent TUI line-mode slash commands control daemon turns and keep React Flow identity" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - live line-mode proof passed for `/subagent` list/spawn/wait/result/input/
    cancel/resume/assign/propagate route controls and projected rows.
- `node --test --test-name-pattern "agent CLI exposes model, thinking, and stream control contracts|agent TUI thin shell is daemon-backed" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - CLI/TUI source-contract and thin shell regressions passed.
- `node --test scripts/lib/workflow-runtime-event-projection-contract.test.mjs`
  - source contract passed for React Flow TUI control projection.
- `node --test --test-name-pattern "React Flow memory, authority/tooling, doctor, skill, hook, and package node contracts remain workflow-addressable" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - broader workflow-addressable control node regression passed.
...
- A broad non-bin `cargo test -p ioi-cli agent_tui -- --nocapture` remains
  blocked by pre-existing integration-test compile errors that still require
  `StartAgentParams.runtime_route_frame` in unrelated e2e harnesses. This slice
  uses the focused `--bin cli agent_tui` target as evidence.
...
- `npm run typecheck --workspace=@ioi/agent-sdk`
  - SDK strict TypeScript check passed with subagent control/result types and
    mock substrate implementation.
- `npm test --workspace=@ioi/agent-sdk`
  - SDK build plus 12 tests passed, including the explicit mock
    `Thread` subagent wrapper coverage.
- `node --test --test-name-pattern "SDK client and Thread wrappers drive daemon SubagentManager routes" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - focused live daemon proof passed for SDK client and `Thread` wrapper route
    calls with React Flow graph/node identity preserved.
- `node --test --test-name-pattern "SubagentManager|subagent cancellation" scripts/lib/live-runtime-daemon-contract.test.mjs`
  - existing direct daemon SubagentManager and cancellation propagation
    regressions plus the new SDK wrapper proof passed.
