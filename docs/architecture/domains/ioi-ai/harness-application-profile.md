...
Implementation refs:
  ...
  - `apps/ioi-ai/orchestration/src/orchestrations.ts` (the composition; the two daemon GoalRun modules previously named here were deleted 2026-09-18 under R-192 slice S5-1)
