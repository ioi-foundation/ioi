...
**Marketplace neutrality, MoW router neutrality, and contribution accounting are the economic layer that prevents the default harness or first-party marketplace from cannibalizing worker, training, benchmark, and service markets.**
