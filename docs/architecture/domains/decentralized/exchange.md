# decentralized.exchange — moved out of this repository

Status: archived forwarding record.
Canonical owner: none in this repository. decentralized.exchange moved to its own repository on
...
decentralized.exchange was specified here as the route-intelligence engine for swaps.
