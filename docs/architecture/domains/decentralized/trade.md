# decentralized.trade — moved out of this repository

Status: archived forwarding record.
Canonical owner: none in this repository. decentralized.trade moved to its own repository on
...
decentralized.trade was specified here as the venue-intelligence surface over exchange routing.
