# Wallet Protocol / SDK Packaging Plan (Phase 0–8)

Status: archived implementation plan (verbatim extraction).
Doctrine status: archived
Implementation status: n/a (historical record)
Archived from: `docs/architecture/_meta/wallet-protocol-sdk-packaging-plan.md` on 2026-07-05.
