# Agentgres v2.0 Detailed Reference Module (former docs/specs/agentgres-spec.md)
...
Archived from: `docs/architecture/components/agentgres/doctrine.md` on 2026-07-05.
Canonical owner: `docs/architecture/components/agentgres/doctrine.md` (live doctrine); this file is history, not authority.
