# wallet.network v3.2 Product Context Module (Sovereign IAM Hub product spec)
...
Archived from: `docs/architecture/components/wallet-network/doctrine.md` on 2026-07-05.
Canonical owner: `docs/architecture/components/wallet-network/doctrine.md` (live doctrine); this file is history, not authority.
