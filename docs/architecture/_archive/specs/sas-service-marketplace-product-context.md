# sas.xyz Service Marketplace Product Context Module
...
Archived from: `docs/architecture/domains/sas/service-marketplace.md` on 2026-07-05.
Canonical owner: `docs/architecture/domains/sas/service-marketplace.md` (live doctrine); this file is history, not authority.
