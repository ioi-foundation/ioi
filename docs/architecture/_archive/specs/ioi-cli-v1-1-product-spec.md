# IOI CLI v1.1 Product Spec (former docs/specs/ioi-cli.md)
...
Archived from: `docs/architecture/components/daemon-runtime/doctrine.md` on 2026-07-05.
Canonical owner: `docs/architecture/components/daemon-runtime/doctrine.md` (live doctrine); this file is history, not authority.
