...
| SDK, CLI, GUI, harness, benchmark, compositor boundaries | [`runtime-package-boundaries.md`](../../implementation/runtime-package-boundaries.md) | [`runtime-module-map.md`](../../implementation/runtime-module-map.md) | pre-next-leg checklist |
