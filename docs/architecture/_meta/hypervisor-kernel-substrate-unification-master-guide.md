...
733-737 are intentionally left expanded as the current runtime bridge thread/turn,
...
facade-retirement seams. The next compaction pass is pending after the next seam is clear enough to preserve evidence, distinguish
