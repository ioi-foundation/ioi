...
Current lane note: after Slice 978, public runtime account, runtime-node, tool
...
daemon-store pass-through wrappers or JS artifact-store readback while direct
...
helpers are scaffolding only until Rust daemon-core catalog, lifecycle, memory,
and conversation-artifact projection over
