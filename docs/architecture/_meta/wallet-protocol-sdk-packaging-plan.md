# Wallet Protocol / SDK Packaging Plan
...
Implementation-plan-class content does not live under `docs/architecture/`
(see [`doc-classes.md`](./doc-classes.md)). The full Phase 0–8 packaging plan
is archived unchanged at the path above.
