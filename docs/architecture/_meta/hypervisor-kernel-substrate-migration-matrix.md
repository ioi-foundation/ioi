...
Last matrix compaction pass: 2026-06-07, after computer-use request-lease target-ref alias retirement slice 617 clarified the active seam.
...
Current expected behavior after Slice 617 and the fifty-second 2026-06-07 matrix compaction pass:
...
- Slices 572-617 retired SDK runtime usage record aliases and Rust/daemon
  ...
  lease identity or populate thread-tool target payloads; IDE runtime telemetry summary
