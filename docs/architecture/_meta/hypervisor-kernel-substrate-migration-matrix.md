...
Last matrix compaction pass: 2026-06-07, after runtime-engine request alias retirement slice 612 clarified the active seam.
...
Current expected behavior after Slice 612 and the forty-seventh 2026-06-07 matrix compaction pass:
...
- Slices 572-612 retired SDK runtime usage record aliases and Rust/daemon
  ...
  record-state admission; IDE runtime telemetry summary
