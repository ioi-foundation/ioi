...
Last matrix compaction pass: 2026-06-07, after computer-use request-lease observation-retention alias retirement slice 619 clarified the active seam.
...
Current expected behavior after Slice 619 and the fifty-fourth 2026-06-07 matrix compaction pass:
...
- Slices 572-619 retired SDK runtime usage record aliases and Rust/daemon
