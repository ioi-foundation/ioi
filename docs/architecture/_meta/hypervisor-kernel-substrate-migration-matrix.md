...
slice 655, and managed-session inspection bridge request alias evidence through
slice 656.
...
Current expected behavior after Slice 656 and the ninety-second 2026-06-07 matrix compaction pass:
...
- Slices 572-656 retired SDK runtime usage record aliases and Rust/daemon
