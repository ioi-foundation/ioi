...
Last matrix compaction pass: 2026-06-07, after daemon memory commit option alias retirement slice 584 clarified the active seam.
...
Current expected behavior after Slice 584 and the nineteenth 2026-06-07 matrix compaction pass:
...
- Slices 572-584 retired SDK runtime usage record aliases and Rust/daemon
  ...
  options no longer satisfy Rust admission;
