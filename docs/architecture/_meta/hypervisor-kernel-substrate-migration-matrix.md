...
Last matrix compaction pass: 2026-06-07, after controlled-relaunch broker launch alias retirement slice 591 clarified the active seam.
...
Current expected behavior after Slice 591 and the twenty-sixth 2026-06-07 matrix compaction pass:
...
- Slices 572-591 retired SDK runtime usage record aliases and Rust/daemon
  ...
  controlled browser process can be started;
