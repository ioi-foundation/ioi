...
Last matrix compaction pass: 2026-06-07, after computer-use request-lease approval alias retirement slice 614 clarified the active seam.
...
Current expected behavior after Slice 614 and the forty-ninth 2026-06-07 matrix compaction pass:
...
- Slices 572-614 retired SDK runtime usage record aliases and Rust/daemon
  ...
  for act requests; IDE runtime telemetry summary
