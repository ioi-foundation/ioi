...
create-run diagnostics-mode option alias evidence through slice 677.
...
Current expected behavior after Slice 677 and the one-hundred-thirteenth 2026-06-07 matrix compaction pass:
