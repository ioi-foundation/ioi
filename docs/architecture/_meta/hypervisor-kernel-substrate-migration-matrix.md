...
bridge-field/head evidence through slice 652.
...
Current expected behavior after Slice 652 and the eighty-eighth 2026-06-07 matrix compaction pass:
...
- Slices 572-652 retired SDK runtime usage record aliases and Rust/daemon
