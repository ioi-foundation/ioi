...
runtime usage event timestamp alias evidence through slice 679.
...
Current expected behavior after Slice 679 and the one-hundred-fifteenth 2026-06-07 matrix compaction pass:
