...
Last matrix compaction pass: 2026-06-07, after diagnostics repair decision fail-closed detail alias retirement slice 587 clarified the active seam.
...
Current expected behavior after Slice 587 and the twenty-second 2026-06-07 matrix compaction pass:
...
- Slices 572-587 retired SDK runtime usage record aliases and Rust/daemon
