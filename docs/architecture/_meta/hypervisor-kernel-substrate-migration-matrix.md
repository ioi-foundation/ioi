...
Last matrix compaction pass: 2026-06-07, after signed replay notebook restore/snapshot input alias retirement slice 638 clarified the active seam.
...
Current expected behavior after Slice 638 and the seventy-third 2026-06-07 matrix compaction pass:
...
- Slices 572-638 retired SDK runtime usage record aliases and Rust/daemon
