...
Last matrix compaction pass: 2026-06-07, after Rust thread-control agent-state model-route input alias retirement slice 611 clarified the active seam.
...
Current expected behavior after Slice 611 and the forty-sixth 2026-06-07 matrix compaction pass:
...
- Slices 572-611 retired SDK runtime usage record aliases and Rust/daemon
  ...
  selection; IDE runtime telemetry summary
