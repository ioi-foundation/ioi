...
Last matrix compaction pass: 2026-06-07, after runtime skill-hook governance alias retirement slice 610 clarified the active seam.
...
Current expected behavior after Slice 610 and the forty-fifth 2026-06-07 matrix compaction pass:
...
- Slices 572-610 retired SDK runtime usage record aliases and Rust/daemon
  ...
  external hook-style fields remain accepted; IDE runtime telemetry summary
