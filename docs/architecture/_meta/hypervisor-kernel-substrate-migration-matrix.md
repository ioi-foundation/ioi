...
Last matrix compaction pass: 2026-06-07, after runtime thread-control model payload alias retirement slice 609 clarified the active seam.
...
Current expected behavior after Slice 609 and the forty-fourth 2026-06-07 matrix compaction pass:
...
- Slices 572-609 retired SDK runtime usage record aliases and Rust/daemon
  ...
  model routing; IDE runtime telemetry summary readers now ignore retired camelCase
