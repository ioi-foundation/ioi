...
Last matrix compaction pass: 2026-06-07, after computer-use request-lease result-output alias retirement slice 621 clarified the active seam.
...
Current expected behavior after Slice 621 and the fifty-sixth 2026-06-07 matrix compaction pass:
...
- Slices 572-621 retired SDK runtime usage record aliases and Rust/daemon
