...
Last matrix compaction pass: 2026-06-07, after computer-use request-lease action-kind alias retirement slice 615 clarified the active seam.
...
Current expected behavior after Slice 615 and the fiftieth 2026-06-07 matrix compaction pass:
...
- Slices 572-615 retired SDK runtime usage record aliases and Rust/daemon
  ...
  inspect/read lease request into act-level wallet.network authority; IDE runtime
  telemetry summary
