...
Last matrix compaction pass: 2026-06-07, after worker contribution request/worker alias retirement slice 642 clarified the active seam.
...
Current expected behavior after Slice 642 and the seventy-seventh 2026-06-07 matrix compaction pass:
...
- Slices 572-642 retired SDK runtime usage record aliases and Rust/daemon
