...
task/job run-id lookup alias evidence through slice 680.
...
Current expected behavior after Slice 680 and the one-hundred-sixteenth 2026-06-07 matrix compaction pass:
