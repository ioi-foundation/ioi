...
Last matrix compaction pass: 2026-06-07, after signed replay event-kind identity helper slice 639 clarified the active seam.
...
Current expected behavior after Slice 639 and the seventy-fourth 2026-06-07 matrix compaction pass:
...
- Slices 572-639 retired SDK runtime usage record aliases and Rust/daemon
