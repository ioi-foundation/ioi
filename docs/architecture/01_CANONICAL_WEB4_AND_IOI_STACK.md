...
A Web4 application has autonomous execution as a first-class capability. It can run workers, workflows, tools, connectors, model calls, and service deliveries, while preserving authority boundaries and verifiable state.
...
wallet.network
  identity, secrets, capability grants, approvals, payments, revocation
...
2. **Capability-scoped authority** — autonomous actors receive bounded powers, not ambient authority.
...
| wallet.network | Authority vault and capability control plane. |
