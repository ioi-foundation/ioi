...
- What responsibilities does it expose?
- Which primitive capabilities and authority scopes does it require?
- How is it verified?
...
→ runtime checks primitive capabilities
→ wallet.network authorizes authority scopes if needed
...
4. No hidden primitive capability or authority scope requirements outside manifest.
