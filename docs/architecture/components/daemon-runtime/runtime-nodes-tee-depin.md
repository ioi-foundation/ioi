...
Canonical owner: this file for runtime-node and execution-privacy doctrine; low-level task capsule protocol lives in [`task-capsule-protocol.md`](./task-capsule-protocol.md).
