...
\textbf{Foundry}, \textbf{Missions}, Governance approvals, and the
Environments and Operations substrate views are application surfaces over
the same Core, not separate runtime truths. Editor integrations, terminals, remote VMs, browser
