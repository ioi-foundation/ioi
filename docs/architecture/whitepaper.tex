...
truth. \textbf{ioi.ai} is the intent and coordination surface that may
...
\emph{decentralized.cloud} is not a mandatory gateway in this path; it
is reserved future product space for a possible public provider catalog
or P2P/PQ-aware cloud-routing layer.
