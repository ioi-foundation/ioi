...
GoalRun create/start/reconcile path exists and remains partial. Generic
WorkResult admission is merged, and the hosted OutcomeRoom graph through
participants, frontier/claims, offers, Attempts, Findings, OutcomeDelta, and
VerifierChallenge is merged but partial. Wider role topology, generalized
multi-harness and remaining orchestration, federation, acceptance/verdict, and
settlement remain planned. Multi-path attempt comparison is partial.
Thread forks, replay,
