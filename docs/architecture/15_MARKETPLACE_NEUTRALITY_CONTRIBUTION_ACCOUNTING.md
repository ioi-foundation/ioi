...
The user should retain the right to run locally/default unless the task requires licensed data, external capability, hosted service, or third-party authority.
