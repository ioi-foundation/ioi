...
run_proof "formal/convergent/guardian_majority" "GuardianMajorityProof.tla"
run_proof "formal/convergent/nested_guardian" "NestedGuardianProof.tla"
run_model "formal/convergent/guardian_majority" "GuardianMajority.cfg" "GuardianMajority.tla"
run_model "formal/convergent/nested_guardian" "NestedGuardian.cfg" "NestedGuardian.tla"
