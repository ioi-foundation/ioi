...
MODELS=(
  ...
  "maximal_visibility/QuvEndToEndRefinement.cfg|maximal_visibility/QuvEndToEndRefinement.tla"
  "maximal_visibility/QuvEndToEndRefinementUnowned.cfg|maximal_visibility/QuvEndToEndRefinement.tla"
  "maximal_visibility/QuvEndToEndRefinementSolo.cfg|maximal_visibility/QuvEndToEndRefinement.tla"
  "maximal_visibility/QuvEndToEndRefinementHandoff.cfg|maximal_visibility/QuvEndToEndRefinement.tla"
  "maximal_visibility/QuvEndToEndRefinementTwoDomain.cfg|maximal_visibility/QuvEndToEndRefinement.tla"
)
...
COUNTERMODELS=(
  ...
  "maximal_visibility/QuvEndToEndRefinementReachable.cfg|maximal_visibility/QuvEndToEndRefinement.tla|Invariant NoExecutedSecondSlot is violated"
  "maximal_visibility/QuvEndToEndRefinementPredecessorInKey.cfg|maximal_visibility/QuvEndToEndRefinement.tla|Invariant NoConflictingAccepts is violated"
  "maximal_visibility/QuvEndToEndRefinementLateReply.cfg|maximal_visibility/QuvEndToEndRefinement.tla|Invariant NoConflictingAccepts is violated"
  "maximal_visibility/QuvEndToEndRefinementSkipExecutorQuv.cfg|maximal_visibility/QuvEndToEndRefinement.tla|Invariant NoClaimWithoutOwnLiveAccept is violated"
  "maximal_visibility/QuvEndToEndRefinementClaimAfterExpiry.cfg|maximal_visibility/QuvEndToEndRefinement.tla|Invariant NoClaimAfterExpiryOrFence is violated"
  "maximal_visibility/QuvEndToEndRefinementCallBeforeClaim.cfg|maximal_visibility/QuvEndToEndRefinement.tla|Invariant NoBlindReplayAfterCrash is violated"
  "maximal_visibility/QuvEndToEndRefinementUnauthenticatedRecovery.cfg|maximal_visibility/QuvEndToEndRefinement.tla|Invariant RecoveryNeverAdvancesBeyondAuthenticatedRecords is violated"
  "maximal_visibility/QuvEndToEndRefinementResourceIdSplitsKey.cfg|maximal_visibility/QuvEndToEndRefinement.tla|Invariant AtMostOneExternalMutationPerStableKey is violated"
  "maximal_visibility/QuvEndToEndRefinementActivateFromBytes.cfg|maximal_visibility/QuvEndToEndRefinement.tla|Invariant NoSuccessorAuthorityFromBytes is violated"
)
