...
import { sortedUniqueStrings, uniqueStrings } from "./strings";
import {
  workflowHarnessActivationIdGateClickProofBlockers,
  workflowHarnessPackageImportActivationApplyProofBlockers,
} from "./proof-blockers";

// Implementations moved to ./proof-blockers and ./strings; re-export the proof
// blockers so existing `from "./core"` consumers (and the activation /
// package-evidence facades) keep working unchanged.
export {
  workflowHarnessActivationIdGateClickProofBlockers,
  workflowHarnessPackageImportActivationApplyProofBlockers,
};
...
export const DEFAULT_AGENT_HARNESS_COMPONENTS: WorkflowHarnessComponentSpec[] =
  [
    ...
    makeComponent({
      ...
      label: "GUI harness contract",
      description:
        "Validates the compact Hypervisor app harness contract without resurrecting campaign-specific GUI validation scaffolds.",
      kernelRef: "scripts/lib/hypervisor-app-harness-contract.mjs",
      capabilityScope: ["gui.validate", "harness.validate"],
      eventKinds: ["HypervisorGuiHarnessContract", "CleanChatUxValidation"],
      evidence: ["retained_queries", "provider_gates", "quality_ledger"],
      group: "Validation",
      icon: "monitor-check",
      timeoutMs: 600000,
    }),
  ...
  switch (component.kind) {
    ...
    case "runtime_task":
      return {
        ...
        runtimeTaskEndpoint: "/v1/tasks",
        runtimeTaskField: "runtimeTask",
        runtimeTaskStatusField: "runtimeTask.status",
        runtimeTaskCancelEndpoint: "/v1/tasks/{taskId}/cancel",
        runtimeTaskCancelable: true,
        runtimeTaskCancelRoute: "task_cancel_route",
        ...
        runtimeTask: {
          ...
          cancelable: true,
          cancelEndpoint: "/v1/tasks/task_default_harness_empty/cancel",
          endpoints: {
            self: "/v1/tasks/task_default_harness_empty",
            cancel: "/v1/tasks/task_default_harness_empty/cancel",
    ...
    case "runtime_job":
      return {
        ...
        runtimeJob: {
          ...
          retryCount: 0,
          cancelable: true,
          cancelEndpoint: "/v1/jobs/job_default_harness_empty/cancel",
          endpoints: {
            self: "/v1/jobs/job_default_harness_empty",
            cancel: "/v1/jobs/job_default_harness_empty/cancel",
            run: "/v1/runs/run_default_harness_empty",
    ...
    case "pr_attempt":
      return {
        ...
        prAttempt: {
          ...
          attemptId: "pr_attempt_default_harness_empty",
          runId: null,
          repositoryContextId: "repoctx_default_harness_empty",
          branchPolicyId: "branch_policy_default_harness_empty",
          githubContextId: "github_context_default_harness_empty",
          ...
          summary:
            "Default harness PR attempt is preview-only until repository, branch, GitHub, and authority context are supplied.",
          previewOnly: true,
          readOnly: true,
          provider: "github",
          action: "pr_create",
          ...
          artifacts: [
            ...
            { artifactName: "pr-branch.json", mediaType: "application/json" },
            { artifactName: "pr-diff.patch", mediaType: "text/x-diff" },
          ],
          redaction: {
    ...
    case "review_gate":
      return {
        ...
        reviewGate: {
          ...
          gateId: "review_gate_default_harness_empty",
          runId: null,
          repositoryContextId: "repoctx_default_harness_empty",
          branchPolicyId: "branch_policy_default_harness_empty",
          githubContextId: "github_context_default_harness_empty",
          ...
          decision: "blocked",
          summary:
            "Default harness review gate blocks PR creation until review policy is satisfied.",
          readOnly: true,
          previewOnly: true,
          reviewRequired: true,
          approvalRequired: true,
          ...
          branch: null,
          defaultBranch: null,
          prAttemptStatus: "blocked",
          prAttemptOutcome: "failed_precondition",
          requiredReviewers: ["code-owner"],
          satisfiedReviewers: [],
          requiredChecks: [
          ...
          passedChecks: [],
          blockers: ["review_not_satisfied", "pr_attempt_not_ready"],
          ...
          preconditions: {
            repositoryContextPresent: false,
            branchPolicyPassed: false,
            githubContextAvailable: false,
            prAttemptPresent: false,
            prAttemptReady: false,
            diffArtifactAttached: false,
            branchArtifactAttached: false,
            reviewPolicySatisfied: false,
            networkLookupPerformed: false,
            mutationExecuted: false,
          },
          redaction: {
    ...
    case "hook_policy":
      return {
        ...
        hookInvocationLedger: {
          schemaVersion: "ioi.agent-runtime.hook-invocation-ledger.v1",
          object: "ioi.agent_hook_invocation_ledger",
          ledgerId: "hook_invocations_default_harness_policy_empty",
          mode: "preview_only",
          hookExecutionEnabled: false,
          commandExecutionEnabled: false,
          emittedEventKinds: ["workflow_activation", "pre_model", "post_model"],
          ...
          escalations: [],
          records: [],
          evidenceRefs: ["hook_invocation_ledger", "hook_escalation_receipt"],
        },
      };
    case "memory_read":
    case "memory_search":
