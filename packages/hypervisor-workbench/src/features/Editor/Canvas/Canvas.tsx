// packages/hypervisor-workbench/src/features/Editor/Canvas/Canvas.tsx
...
export function Canvas({
  ...
  return (
    <div className="hypervisor-workbench-react-flow-surface" style={{ width: '100%', height: '100%', background: 'var(--bg-dark)' }}
