// packages/hypervisor-workbench/src/features/Shell/ActivityBar.tsx
...
const workspaceItems = [
  { id: "catalog", icon: <Icons.Folder />, label: "Catalog" },
  { id: "environments", icon: <Icons.Trigger />, label: "Environment Management" },
