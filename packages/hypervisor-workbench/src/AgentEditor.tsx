...
function AgentEditorContent({
  ...
  return (
    <div className="hypervisor-workbench-root">
      <IDEHeader 
      ...
      <div className="hypervisor-workbench-workspace">
        <div className="hypervisor-workbench-sidebar">
          <Explorer
              runtime={runtime}
        ...
        <div className="hypervisor-workbench-editor-pane">
          <div className="hypervisor-workbench-canvas-shell">
            <Canvas 
            ...
            <div className="hypervisor-workbench-canvas-actions">
              <button
                type="button"
                className="hypervisor-workbench-canvas-action"
          ...
          {showConsole ? (
            <div className="hypervisor-workbench-console-slot">
              <Console 
                  logs={execution.logs}
            ...
            <button
              type="button"
              className="hypervisor-workbench-console-collapsed"
        ...
        <div className="hypervisor-workbench-inspector">
          <Inspector
