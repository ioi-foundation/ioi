...
const RUNTIME_CHROME_NODE_LABELS = {
  ...
  runtime_operator_interrupt: "Runtime operator interrupt",
  runtime_operator_steer: "Runtime operator steer",
  runtime_thread_mode: "Runtime thread mode",
  runtime_workspace_trust_gate: "Workspace trust gate",
  runtime_context_compact: "Runtime context compact",
  runtime_approval_request: "Runtime approval request",
  runtime_usage_meter: "Runtime usage meter",
  runtime_context_budget: "Runtime context budget",
  runtime_compaction_policy: "Runtime compaction policy",
  runtime_rollback_snapshot: "Runtime rollback snapshot",
  runtime_restore_gate: "Runtime restore gate",
  runtime_diagnostics_repair: "Runtime diagnostics repair",
  runtime_coding_tool_budget_recovery: "Coding tool budget recovery",
...
const RUNTIME_CHROME_NODE_LABELS_ES = {
  ...
  runtime_operator_interrupt: "Interrupcion de operador del runtime",
  runtime_operator_steer: "Direccion de operador del runtime",
  runtime_thread_mode: "Modo de hilo del runtime",
  runtime_workspace_trust_gate: "Puerta de confianza del workspace",
  runtime_context_compact: "Compactacion de contexto del runtime",
  runtime_approval_request: "Solicitud de aprobacion del runtime",
  runtime_usage_meter: "Medidor de uso del runtime",
  runtime_context_budget: "Presupuesto de contexto del runtime",
  runtime_compaction_policy: "Politica de compactacion del runtime",
  runtime_rollback_snapshot: "Snapshot de rollback del runtime",
  runtime_restore_gate: "Puerta de restauracion del runtime",
  runtime_diagnostics_repair: "Reparacion de diagnosticos del runtime",
  runtime_coding_tool_budget_recovery: "Recuperacion de presupuesto de herramienta de codigo",
...
export const WORKFLOW_RUNTIME_UI_REQUIRED_STRING_KEYS = [
  ...
  "runtime.node.runtime_operator_interrupt.label",
  "runtime.node.runtime_operator_steer.label",
  "runtime.node.runtime_thread_mode.label",
  "runtime.node.runtime_workspace_trust_gate.label",
  "runtime.node.runtime_context_compact.label",
  "runtime.node.runtime_approval_request.label",
  "runtime.node.runtime_usage_meter.label",
  "runtime.node.runtime_context_budget.label",
  "runtime.node.runtime_compaction_policy.label",
  "runtime.node.runtime_rollback_snapshot.label",
  "runtime.node.runtime_restore_gate.label",
  "runtime.node.runtime_diagnostics_repair.label",
  "runtime.node.runtime_coding_tool_budget_recovery.label",
