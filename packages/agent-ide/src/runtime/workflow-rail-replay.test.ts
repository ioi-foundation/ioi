        ...
        workerHandoffReceipts: [
          {
            ...
            sessionRecordId: "session-handoff",
            sessionId: "session-handoff",
            workerId: "worker-handoff",
            workflowId: "workflow-1",
            activationId: "activation-2",
            activationHash: "hash-2",
            harnessHash: "hash-2",
            registryRecordId: "registry-handoff",
            readinessProofId: "readiness-handoff",
            rollbackTarget: "activation:default-agent-harness:blessed-readonly",
            rollbackAvailable: true,
            launchAuthoritySource: "activation_record",
            accepted: true,
            handoffStatus: "launched",
            blockers: [],
            policyDecision: "allow_handoff",
            receiptRefs: ["envelope-handoff"],
            evidenceRefs: ["evidence-handoff"],
            createdAtMs: 1778190000005,
          },
        ],
        workerHandoffNodeAttemptIds: ["attempt-handoff"],
        workerHandoffNodeAttempts: [
          {
            ...
            componentKind: "handoff_bridge",
            policyDecision: "allow_handoff",
            receiptIds: ["receipt-handoff", "envelope-handoff"],
            replay: {
              ...nodeAttempt.replay,
              fixtureRef: "fixture-handoff",
            },
          },
        ],
        workerHandoffReplayFixtureRefs: ["fixture-handoff"],
      },
...
const cases = [
  ...
  ["fixture-handoff", "activation_worker_handoff", "ioi.agent-harness.handoff_bridge.v1"],
