...
const familyLabels: Record<string, string> = {
  ...
  runtime_operator_steer: "Steer",
  runtime_thread_mode: "Mode",
  runtime_workspace_trust_gate: "Trust",
  runtime_context_compact: "Compact",
  runtime_approval_request: "Approval",
  runtime_usage_meter: "Usage",
  runtime_context_budget: "Budget",
  runtime_compaction_policy: "Policy",
  runtime_rollback_snapshot: "Rollback",
  runtime_restore_gate: "Restore",
  runtime_diagnostics_repair: "Repair",
...
const familyTokens: Record<string, string> = {
  ...
  runtime_operator_steer: "ST",
  runtime_thread_mode: "TM",
  runtime_workspace_trust_gate: "WG",
  runtime_context_compact: "CC",
  runtime_approval_request: "AR",
  runtime_usage_meter: "UM",
  runtime_context_budget: "CB",
  runtime_compaction_policy: "CP",
  runtime_rollback_snapshot: "RS",
  runtime_restore_gate: "RG",
  runtime_diagnostics_repair: "RX",
  runtime_coding_tool_budget_recovery: "BR",
  function: "FN",
  model_binding: "MB",
  model_call: "AI",
  skill_context: "SK",
