...
test("runtime event payloads preserve computer-use and memory summaries", () => {
  ...
  const memory = runtime.payloadSummaryForRunEvent({
    ...
    data: {
      ...
      memory_key: "memory-key-one",
      memoryKey: "retired-memory-key",
      agent_id: "agent-canonical",
      agentId: "agent-retired",
      thread_id: "thread-canonical",
      threadId: "thread-retired",
      target_type: "thread",
      targetType: "retired-target",
      target_id: "thread-canonical",
      targetId: "thread-retired",
      ...
      workflow_graph_id: "memory.graph",
      workflowGraphId: "retired.memory.graph",
      workflow_node_id: "memory.node",
      workflowNodeId: "retired.memory.node",
      workflow_node_type: "memory_policy",
      workflowNodeType: "retired_memory_policy",
      ...
      evidence_refs: ["memory-canonical"],
      evidenceRefs: ["memory-retired"],
    },
  });
