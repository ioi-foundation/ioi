...
export async function startRuntimeDaemonServiceWithStore({
  ...
  const store = new StateStore(stateDir, {
    ...
    daemonCoreThreadLifecycleApi: options.daemonCoreThreadLifecycleApi,
    daemonCoreWorkspaceTrustApi: options.daemonCoreWorkspaceTrustApi,
    daemonCoreThreadMemoryApi: options.daemonCoreThreadMemoryApi,
