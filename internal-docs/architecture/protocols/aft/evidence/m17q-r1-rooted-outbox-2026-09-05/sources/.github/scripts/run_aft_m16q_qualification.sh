...
for required_case in tests::rooted_outbox_scope_precedes_discovery_and_rejects_foreign_recovery tests::outbox_streaming_recovery_refuses_truncation_and_trailing_bytes outbox_decode::tests::entry_budget_rejects_declared_vector_before_reading_body; do
