...
impl JournalMemberStore {
    #[cfg(test)]
    pub(in crate::aft::query_unanimity) fn fail_next_anchor_commit(&mut self) {
        self.persistence.fail_next_anchor_commit();
    }
...
impl MemberJournalPersistence {
    #[cfg(test)]
    pub(in crate::aft::query_unanimity) fn fail_next_anchor_commit(&mut self) {
        self.journal.fail_anchor_at = Some(super::anchor_reservation::AnchorPhase::InactiveDurable);
    }
