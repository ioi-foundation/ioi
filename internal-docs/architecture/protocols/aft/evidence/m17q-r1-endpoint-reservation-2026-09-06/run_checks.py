#!/usr/bin/env python3
"""Scoped endpoint reservation checks; not full M16Q qualification."""
...
files += ['crates/agentgres/src/consequence/resource_reservation.rs', '.github/scripts/check_aft_endpoint_reservation.py']
...
put('completed.json',{'completed':now(),'source_changes':changed,'passing':passing,'scope':'scoped endpoint data reservation; receipt/global profile/refinement/full R2/review outstanding'})
