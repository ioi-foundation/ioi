---- MODULE QuvAdmissionOrder_TTrace_1788611627 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("QuvAdmissionOrder_TTrace_1788611627.json", _TETrace)
...
\*
\*trace == IODeserialize("QuvAdmissionOrder_TTrace_1788611627.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([bypasses |-> 0,served |-> FALSE,active |-> "idle",queue |-> <<"worker">>]),
    ([bypasses |-> 0,served |-> TRUE,active |-> "worker",queue |-> <<>>]),
    ([bypasses |-> 0,served |-> TRUE,active |-> "idle",queue |-> <<>>])
    >>
----
...
---- CONFIG QuvAdmissionOrder_TTrace_1788611627 ----
CONSTANTS
    Domains = { d1 }
    FIFO = FALSE
    d1 = d1
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Sep 05 08:33:47 EDT 2026