---- MODULE QuvAdmissionOrder_TTrace_1788611626 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("QuvAdmissionOrder_TTrace_1788611626.json", _TETrace)
...
\*
\*trace == IODeserialize("QuvAdmissionOrder_TTrace_1788611626.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG QuvAdmissionOrder_TTrace_1788611626 ----
CONSTANTS
    Domains = { d1 , d2 }
    FIFO = TRUE
    d2 = d2
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Sep 05 08:33:46 EDT 2026