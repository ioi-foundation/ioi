        ...
        + Debug,
{
    ...
    let (gate, preparation_service) = {
        ...
        let preparation_service = if independent_preparation {
            ...
            Some(Duration::from_millis(service_millis))
        } else {
            None
        };
        (context.aft_quv_admission.clone(), preparation_service)
    };
