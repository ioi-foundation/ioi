...
checks=[('core',['cargo','test','--locked','-p','ioi-consensus','--features','aft','--lib','aft::query_unanimity']),
        ...
        ('benchmark',['cargo','test','--locked','-p','ioi-consensus','--features','aft','--lib',
                      'aft::query_unanimity::tests::m16q_profiles_mldsa_signing_and_durable_write_before_reply','--','--exact','--ignored','--nocapture'])]
results=[]
