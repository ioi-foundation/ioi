...
mod tests {
    ...
    fn policy_root_binds_authority_and_complete_timing_bounds() {
        ...
        .unwrap();
        // Independently assembled SCALE fixture: evidence/m17q-r1-consequence-profile-2026-09-06/policy_vector.py.
        assert_eq!(
            hex::encode(baseline),
            "4abba2118280e71d1eaaf947b8e309e64309866f62982c96f24fd6fdfc675056"
        );
        assert_ne!(
            baseline,
            quv_policy_root(
