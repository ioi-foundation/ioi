...
files = ['Cargo.lock', 'crates/types/src/app/query_unanimity.rs',
...
checks = [('core',['cargo','test','--locked','-p','ioi-consensus','--features','aft','--lib','aft::query_unanimity']),
          ('network',['cargo','test','--locked','-p','ioi-networking','--lib','pq_channel']),
          ...
          ('formal',['bash','.github/scripts/run_aft_formal_checks.sh','--quv-byte-reserve-only'])]
results=[]
