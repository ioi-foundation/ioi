#!/usr/bin/env python3
"""Scoped receipt admission checks; not full M16Q qualification."""
...
checks=[('pressure-checker',['python3','.github/scripts/check_aft_quv_readiness_evidence.py','--self-test']),('policy-types',['cargo','test','--locked','-p','ioi-types','--lib','app::consequence::tests']),
 ('quv-core',['cargo','test','--locked','-p','ioi-consensus','--features','aft','--lib','aft::query_unanimity::']),
 ...
 ('formal',['bash','.github/scripts/run_aft_formal_checks.sh','--quv-receipt-admission-only'])]
...
put('completed.json',{'completed':now(),'source_changes':changed,'passing':passing,'scope':'scoped receipt admission validation; prior process evidence predates this production change; aggregate admission/profile/full transition refinement/R2/review outstanding'})
