...
const POLICY_ROOT_DOMAIN_V0: &[u8] = b"ioi/aft/quv-policy/v7-consequence-admission";
...
mod tests {
    ...
    fn policy_root_binds_authority_and_complete_timing_bounds() {
        ...
        .unwrap();
        // Independently assembled SCALE fixture: evidence/m17q-r1-receipt-admission-2026-09-06/policy_vector.py.
        assert_eq!(
            hex::encode(baseline),
