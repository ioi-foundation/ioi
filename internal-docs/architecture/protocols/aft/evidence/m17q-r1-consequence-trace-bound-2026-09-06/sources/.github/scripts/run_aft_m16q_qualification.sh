...
for required_case in receipt_trace_bound_refuses_extra_ambiguity_without_mutating_state pq_resource_format_bounds_cover_maximum_tokens_and_refuse_noncanonical_evidence; do
