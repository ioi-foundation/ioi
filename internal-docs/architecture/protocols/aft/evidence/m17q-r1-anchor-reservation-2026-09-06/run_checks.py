#!/usr/bin/env python3
"""Scoped integrated record/anchor reservation verification, not full R2 qualification."""
...
for directory,suffixes in [('crates/validator/src/standard/orchestration/quv',{'.rs'}),
