#!/usr/bin/env python3
"""Check retained worker diagnostics; never independent authorization or timing proof."""
import argparse
import copy
import hashlib
import json
...
def validate(records):
    ...
    return {'worker_starts': started, 'accepted_worker_completions': completed,
        ...
        'scope': 'host diagnostics matched to own live acceptance; not storage/refinement or clean timing proof'}
