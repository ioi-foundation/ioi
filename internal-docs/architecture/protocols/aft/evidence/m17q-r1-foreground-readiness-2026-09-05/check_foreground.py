...
commands = {
    'release-observations': ['python3', str(base / 'analyze_admission_releases.py'), str(process / 'components')],
...
disposition = {'disposition': 'PASS_SCOPED_CAMPAIGN' if passed else 'REPAIR_OR_INVESTIGATION_REQUIRED',
               ...
               'scope': 'Selected initial-slot foreground assertions and host observations; does not exercise noninitial readiness, full R2, a worst-case bound or whole R1 closure.'}
