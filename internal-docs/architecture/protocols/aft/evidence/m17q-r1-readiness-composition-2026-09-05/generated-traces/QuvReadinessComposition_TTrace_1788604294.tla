---- MODULE QuvReadinessComposition_TTrace_1788604294 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("QuvReadinessComposition_TTrace_1788604294.json", _TETrace)
...
\*
\*trace == IODeserialize("QuvReadinessComposition_TTrace_1788604294.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([refused |-> FALSE,introducedAt |-> 0,fastDone |-> 1,slot |-> 1,slowDone |-> 1]),
    ([refused |-> FALSE,introducedAt |-> 4,fastDone |-> 5,slot |-> 2,slowDone |-> 5]),
    ([refused |-> FALSE,introducedAt |-> 8,fastDone |-> 9,slot |-> 3,slowDone |-> 9]),
    ([refused |-> FALSE,introducedAt |-> 12,fastDone |-> 13,slot |-> 4,slowDone |-> 13]),
    ([refused |-> FALSE,introducedAt |-> 16,fastDone |-> 17,slot |-> 5,slowDone |-> 17])
    >>
----
...
---- CONFIG QuvReadinessComposition_TTrace_1788604294 ----
CONSTANTS
    WaitBound = 3
    FastService = 1
    SlowService = 1
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Sep 05 06:31:34 EDT 2026