...
impl QuvConsequenceAdmissionProfileV0 {
    ...
    /// Active, per-domain, historical and active-operation field order.
    pub const ROOTED_FIELDS: [u64; 4] = [
        Self::ACTIVE as u64,
...
impl QuvConsequenceStorageProfileV0 {
    ...
    /// Storage field order introduced by v6 and retained inside policy-root v7.
    pub const ROOTED_FIELDS: [u64; 13] = [
        Self::FORMAT_VERSION,
