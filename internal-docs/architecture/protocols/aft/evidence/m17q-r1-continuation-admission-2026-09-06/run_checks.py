#!/usr/bin/env python3
"""Scoped continuation admission checks; not full M16Q qualification."""
...
files += ['crates/cli/tests/aft_e2e.rs','crates/validator/src/standard/orchestration/quv/admission.rs','crates/validator/src/standard/orchestration/runtime_finality.rs','crates/agentgres/src/recognized_effect.rs','crates/consensus/src/aft/query_unanimity.rs','crates/agentgres/src/consequence/resource_reservation.rs','crates/agentgres/src/consequence/receipt_reservation.rs', '.github/scripts/check_aft_endpoint_reservation.py', '.github/scripts/check_aft_receipt_reservation.py']
...
checks=[('runtime-finality',['cargo','test','--locked','-p','ioi-validator','--features','consensus-aft','--lib','standard::orchestration::runtime_finality::tests::']),
 ...
 ('formal',['bash','.github/scripts/run_aft_formal_checks.sh','--quv-continuation-admission-only'])]
