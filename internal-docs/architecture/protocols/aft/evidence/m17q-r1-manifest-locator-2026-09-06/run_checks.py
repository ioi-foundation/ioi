#!/usr/bin/env python3
"""Scoped manifest locator refinement checks; not full M16Q qualification."""
...
checks=[('runtime-finality',['cargo','test','--locked','-p','ioi-validator','--features','consensus-aft','--lib','standard::orchestration::runtime_finality::tests::']),
...
put('completed.json',{'completed':now(),'source_changes':changed,'passing':passing,'scope':'scoped derived locator refinement; aggregate admission/profile/full transition refinement/R2/review outstanding'})
