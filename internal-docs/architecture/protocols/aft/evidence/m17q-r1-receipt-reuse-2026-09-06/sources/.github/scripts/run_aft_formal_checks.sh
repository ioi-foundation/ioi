...
PROOFS=(
  "consequence/QuvReceiptReuseProof.tla"
  "consequence/QuvRegistryBootstrapProof.tla"
  "consequence/QuvQueuedEffectPreparationProof.tla"
  "concurrency/QuvContinuationAdmissionProof.tla"
...
MODELS=(
  "consequence/QuvReceiptReuse.cfg|consequence/QuvReceiptReuse.tla"
  "consequence/QuvRegistryBootstrap.cfg|consequence/QuvRegistryBootstrap.tla"
  "consequence/QuvRegistryIdentity.cfg|consequence/QuvManifestLocator.tla"
  "concurrency/QuvReceiptAdmission.cfg|concurrency/QuvAdmissionOrder.tla"
  "consequence/QuvQueuedEffectPreparation.cfg|consequence/QuvQueuedEffectPreparation.tla"
  "concurrency/QuvContinuationAdmission.cfg|concurrency/QuvContinuationAdmission.tla"
...
COUNTERMODELS=(
  "consequence/QuvReceiptReuseRewrite.cfg|consequence/QuvReceiptReuse.tla|Invariant ReusePreservesData is violated"
  "consequence/QuvReceiptReuseFallback.cfg|consequence/QuvReceiptReuse.tla|Invariant ActiveOnlyAuthority is violated"
  "consequence/QuvQueuedEffectPreparationEarly.cfg|consequence/QuvQueuedEffectPreparation.tla|Invariant PreparedAfterAdmission is violated"
  "consequence/QuvQueuedEffectPreparationLocked.cfg|consequence/QuvQueuedEffectPreparation.tla|Invariant QueueReleasesStore is violated"
  "consequence/QuvQueuedEffectPreparationStale.cfg|consequence/QuvQueuedEffectPreparation.tla|Invariant PreparationCheck is violated"
  "consequence/QuvQueuedEffectPreparationFinal.cfg|consequence/QuvQueuedEffectPreparation.tla|Invariant CallWasAuthorized is violated"
  "concurrency/QuvContinuationAdmissionEarly.cfg|concurrency/QuvContinuationAdmission.tla|Invariant Ownership is violated"
  "concurrency/QuvContinuationAdmissionCancel.cfg|concurrency/QuvContinuationAdmission.tla|Invariant Ownership is violated"
  "concurrency/QuvReceiptAdmissionBypass.cfg|concurrency/QuvAdmissionOrder.tla|Invariant BoundedPredecessors is violated"
  ...
  "consequence/QuvEffectPreparationTerminal.cfg|consequence/QuvEffectPreparation.tla|Invariant TerminalReadOnly is violated"
  "consequence/QuvManifestLocatorOverwrite.cfg|consequence/QuvManifestLocator.tla|Invariant IndexCorrect is violated"
  "consequence/QuvRegistryIdentityDuplicate.cfg|consequence/QuvManifestLocator.tla|Invariant RegistryUnique is violated"
  "consequence/QuvRegistryBootstrapHiddenError.cfg|consequence/QuvRegistryBootstrap.tla|Invariant BootstrapSound is violated"
...
if [[ "${1:-}" == "--quv-receipt-reuse-only" ]]; then
  run_proof "${FORMAL_DIR}/consequence" "QuvReceiptReuseProof.tla"
  run_model "${FORMAL_DIR}/consequence" "QuvReceiptReuse.cfg" "QuvReceiptReuse.tla"
  run_countermodel "${FORMAL_DIR}/consequence" "QuvReceiptReuseRewrite.cfg" "QuvReceiptReuse.tla" "Invariant ReusePreservesData is violated"
  run_countermodel "${FORMAL_DIR}/consequence" "QuvReceiptReuseFallback.cfg" "QuvReceiptReuse.tla" "Invariant ActiveOnlyAuthority is violated"
  exit 0
fi
...
if [[ "${1:-}" == "--quv-continuation-admission-only" ]]; then
  run_proof "${FORMAL_DIR}/concurrency" "QuvContinuationAdmissionProof.tla"
  run_model "${FORMAL_DIR}/concurrency" "QuvContinuationAdmission.cfg" "QuvContinuationAdmission.tla"
  run_countermodel "${FORMAL_DIR}/concurrency" "QuvContinuationAdmissionEarly.cfg" "QuvContinuationAdmission.tla" "Invariant Ownership is violated"
  run_countermodel "${FORMAL_DIR}/concurrency" "QuvContinuationAdmissionCancel.cfg" "QuvContinuationAdmission.tla" "Invariant Ownership is violated"
  exit 0
fi

if [[ "${1:-}" == "--quv-receipt-admission-only" ]]; then
  run_model "${FORMAL_DIR}/concurrency" "QuvReceiptAdmission.cfg" "QuvAdmissionOrder.tla"
  run_countermodel "${FORMAL_DIR}/concurrency" "QuvReceiptAdmissionBypass.cfg" "QuvAdmissionOrder.tla" "Invariant BoundedPredecessors is violated"
  exit 0
fi

if [[ "${1:-}" == "--quv-queued-preparation-only" ]]; then
  run_proof "${FORMAL_DIR}/consequence" "QuvQueuedEffectPreparationProof.tla"
  run_model "${FORMAL_DIR}/consequence" "QuvQueuedEffectPreparation.cfg" "QuvQueuedEffectPreparation.tla"
  run_countermodel "${FORMAL_DIR}/consequence" "QuvQueuedEffectPreparationEarly.cfg" "QuvQueuedEffectPreparation.tla" "Invariant PreparedAfterAdmission is violated"
  run_countermodel "${FORMAL_DIR}/consequence" "QuvQueuedEffectPreparationLocked.cfg" "QuvQueuedEffectPreparation.tla" "Invariant QueueReleasesStore is violated"
  run_countermodel "${FORMAL_DIR}/consequence" "QuvQueuedEffectPreparationStale.cfg" "QuvQueuedEffectPreparation.tla" "Invariant PreparationCheck is violated"
  run_countermodel "${FORMAL_DIR}/consequence" "QuvQueuedEffectPreparationFinal.cfg" "QuvQueuedEffectPreparation.tla" "Invariant CallWasAuthorized is violated"
  exit 0
fi
...
if [[ "${1:-}" == "--quv-effect-preparation-only" ]]; then
  ...
  run_countermodel "${FORMAL_DIR}/consequence" "QuvEffectPreparationTerminal.cfg" "QuvEffectPreparation.tla" "Invariant TerminalReadOnly is violated"
  exit 0
fi

if [[ "${1:-}" == "--quv-manifest-locator-only" ]]; then
  run_proof "${FORMAL_DIR}/consequence" "QuvRegistryBootstrapProof.tla"
  run_model "${FORMAL_DIR}/consequence" "QuvRegistryBootstrap.cfg" "QuvRegistryBootstrap.tla"
  run_countermodel "${FORMAL_DIR}/consequence" "QuvRegistryBootstrapHiddenError.cfg" "QuvRegistryBootstrap.tla" "Invariant BootstrapSound is violated"
  ...
  run_model "${FORMAL_DIR}/consequence" "QuvRegistryIdentity.cfg" "QuvManifestLocator.tla"
  run_countermodel "${FORMAL_DIR}/consequence" "QuvRegistryIdentityDuplicate.cfg" "QuvManifestLocator.tla" "Invariant RegistryUnique is violated"
