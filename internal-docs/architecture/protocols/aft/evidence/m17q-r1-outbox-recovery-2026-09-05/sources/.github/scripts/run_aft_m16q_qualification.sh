...
for required_case in tests::outbox_streaming_recovery_refuses_truncation_and_trailing_bytes outbox_decode::tests::entry_budget_rejects_declared_vector_before_reading_body; do
