...
def validate(text: str) -> dict:
    ...
    return {"sole_correct_placements": 4, "saturation_operations": 4,
...
def self_test():
    lines = [f"[M16Q-QUV] case=sole_correct member_position={i} process_index={i} terminal_replays=1 replay_elapsed_ms=1 elapsed_ms=5000 max_valid_reply_elapsed_ms=3999 qualified_envelope_ms=4000 result=executed" for i in range(4)]
    lines += [
