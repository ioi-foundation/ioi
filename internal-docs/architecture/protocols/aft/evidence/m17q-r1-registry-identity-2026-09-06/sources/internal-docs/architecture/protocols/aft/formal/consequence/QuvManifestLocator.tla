...
EXTENDS FiniteSets
CONSTANTS Records, Effects, Owner, Absent, Ambiguous, DropDuplicate, TrustAfterCrash, EnforceRegistryIdentity
...
Admit == /\ ready
         /\ \E r \in Records :
               /\ (~EnforceRegistryIdentity \/ (\A p \in committed : Owner[p] # Owner[r]))
...
RegistryUnique == \A r, t \in committed : Owner[r] = Owner[t] => r = t
UniqueWhenEnforced == EnforceRegistryIdentity => RegistryUnique
