...
for required_case in identity_substitution_refuses_without_invalidating_prior_admission unindexed_or_unknown_registry_schema_refuses_without_reinitializing; do
