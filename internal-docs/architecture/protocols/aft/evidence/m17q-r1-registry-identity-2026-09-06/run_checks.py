#!/usr/bin/env python3
"""Scoped registry identity checks; not full M16Q qualification."""
...
checks=[('registry',['cargo','test','--locked','-p','ioi-services','--lib','aft_effect_registry']),
...
put('completed.json',{'completed':now(),'source_changes':changed,'passing':passing,'scope':'scoped registry identity validation; prior process evidence predates this production change; aggregate admission/profile/full transition refinement/R2/review outstanding'})
