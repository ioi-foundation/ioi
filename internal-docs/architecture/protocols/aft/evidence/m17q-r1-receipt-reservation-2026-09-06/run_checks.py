#!/usr/bin/env python3
"""Scoped receipt reservation checks; not full M16Q qualification."""
...
files += ['crates/agentgres/src/consequence/resource_reservation.rs','crates/agentgres/src/consequence/receipt_reservation.rs', '.github/scripts/check_aft_endpoint_reservation.py', '.github/scripts/check_aft_receipt_reservation.py']
...
put('completed.json',{'completed':now(),'source_changes':changed,'passing':passing,'scope':'scoped receipt initialized storage; global profile/refinement/full R2/review outstanding'})
