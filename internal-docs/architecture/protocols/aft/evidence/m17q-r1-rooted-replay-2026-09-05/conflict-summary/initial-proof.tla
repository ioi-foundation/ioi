...
\* Algebraic prerequisite for a proposed bounded conflict representation.
\* Not yet a wire/storage change or runtime-refinement theorem.
...
<1>2. CASE n >= 2
  ...
  <2>2. ~Uniform(s, n, wanted)
    BY <2>1, SMT DEF Uniform
  <2>3. ~Uniform(s, 2, wanted)
    BY <2>1, SMT DEF Uniform
  <2> QED BY <2>2, <2>3, SMT DEF SummaryLength
