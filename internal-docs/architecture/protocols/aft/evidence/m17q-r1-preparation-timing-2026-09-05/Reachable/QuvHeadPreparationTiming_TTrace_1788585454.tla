...
trace == 
    ...
    ([refused |-> {},replied |-> {},ready |-> {m1},now |-> 0,started |-> FALSE,startTime |-> 0,finished |-> FALSE,ownGrant |-> {m1, m2}]),
    ([refused |-> {},replied |-> {},ready |-> {m1, m2},now |-> 0,started |-> FALSE,startTime |-> 0,finished |-> FALSE,ownGrant |-> {m1, m2}]),
    ([refused |-> {},replied |-> {},ready |-> {m1, m2},now |-> 1,started |-> FALSE,startTime |-> 0,finished |-> FALSE,ownGrant |-> {m1, m2}]),
    ([refused |-> {},replied |-> {},ready |-> {m1, m2},now |-> 2,started |-> FALSE,startTime |-> 0,finished |-> FALSE,ownGrant |-> {m1, m2}]),
    ([refused |-> {},replied |-> {},ready |-> {m1, m2},now |-> 2,started |-> TRUE,startTime |-> 2,finished |-> FALSE,ownGrant |-> {m1, m2}]),
    ([refused |-> {},replied |-> {m1},ready |-> {m1, m2},now |-> 2,started |-> TRUE,startTime |-> 2,finished |-> FALSE,ownGrant |-> {m1, m2}]),
    ([refused |-> {},replied |-> {m1, m2},ready |-> {m1, m2},now |-> 2,started |-> TRUE,startTime |-> 2,finished |-> FALSE,ownGrant |-> {m1, m2}]),
    ([refused |-> {},replied |-> {m1, m2},ready |-> {m1, m2},now |-> 3,started |-> TRUE,startTime |-> 2,finished |-> FALSE,ownGrant |-> {m1, m2}]),
    ([refused |-> {},replied |-> {m1, m2},ready |-> {m1, m2},now |-> 3,started |-> TRUE,startTime |-> 2,finished |-> TRUE,ownGrant |-> {m1, m2}])
    >>
----
