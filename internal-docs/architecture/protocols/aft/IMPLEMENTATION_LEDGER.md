...
| M12 non-circular visibility viability | **PUBLIC THEOREM REVIEW REQUEST OPEN — UNADJUDICATED** | R2 candidate and tag are published; public commission [#358](https://github.com/ioi-foundation/ioi/issues/358) is open and unassigned. L-MAX remains a local candidate until a qualified independent reviewer returns `UPHELD`, `REPAIR_REQUIRED`, or `REFUTED`; M13-M18 remain locked unless a concrete construction defeats it |
