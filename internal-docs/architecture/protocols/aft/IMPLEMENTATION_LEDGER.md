...
| M10 independent PQ v1 review and release | **WAITING OWNER COMMISSIONING — CRITICAL PATH** | `packets/M10-M12-owner-commissioning-handoff-2026-09-03.md` records the exact immutable ref and engagement/return fields. Owner must publish or privately transfer the candidate, name and engage an independent reviewer against the full commit resolved by the M9 tag, and return complete findings, remediation/retest, a final attributable report, and no unresolved high/critical finding |
