...
| M10 independent PQ v1 review and release | **R4 LOCAL REPAIR PASSED; RETEST PENDING — CRITICAL PATH** | R3 closed AFT-M10-006/007 and left only AFT-M10-003. The finite 120-second signer readiness repair preserves early-exit/timeout diagnostics, and the exact four-validator fixture now passes locally through fallback height 5, full cold restart, and height 7 in 1,098.02 seconds. Freeze and independent exact-tag retest remain required before M1/M8/M10 admission |
