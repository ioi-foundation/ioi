...
- [`asymptote.md`](/home/heathledger/Documents/ioi/repos/ioi/internal-docs/architecture/protocols/aft/specs/asymptote.md): two-tier finality with asynchronous sealing, equal-authority observer veto-collapse, and sealed-only effects under the repository's broader PSC-based `99%` Byzantine-tolerance claim
...
- [`equal_authority_ordering.md`](/home/heathledger/Documents/ioi/repos/ioi/internal-docs/architecture/protocols/aft/specs/equal_authority_ordering.md): architectural framing for AFT's `99%` equal-authority ordering consensus claim and its separation of revelation from dense positive voting
