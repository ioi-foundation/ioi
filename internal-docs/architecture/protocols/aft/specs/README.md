...
- [`common_boundary_theorems.md`](./common_boundary_theorems.md): AFT-CB theorem and lower-bound surface, including T1–T12, the no-laundering/consequence/economic/PQ-channel extensions, and machine-checked `Assumes:` discipline; conditional on each theorem's printed model
