...
\hypersetup{
  ...
  pdftitle={Asymptote Fault Tolerance (AFT): Relay-Free Deterministic All-But-One (n-1 of n) Byzantine Safety in the AFT Model Delta},
  pdfauthor={IOI}
}
...
\title{Asymptote Fault Tolerance (AFT): Relay-Free Deterministic All-But-One (\(n-1\) of \(n\)) Byzantine Safety in the AFT Model Delta}
\author{IOI}
\date{March 17, 2026}
...
visibility delta without a trusted relay,
