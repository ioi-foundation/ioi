...
\hypersetup{
  ...
  pdftitle={Asymptote Fault Tolerance (AFT): Maximal Deterministic Byzantine Safety - All-But-One (n-1 of n), Relay-Free, Fully Attributable - in the AFT Model Delta},
  pdfauthor={IOI}
}
...
\title{Asymptote Fault Tolerance (AFT): Maximal Deterministic Byzantine Safety --- All-But-One (\(n-1\) of \(n\)), Relay-Free, Fully Attributable --- in the AFT Model Delta}
\author{IOI}
\date{March 17, 2026}
