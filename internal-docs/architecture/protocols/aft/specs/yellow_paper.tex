...
\hypersetup{
  ...
  pdftitle={Asymptote Fault Tolerance (AFT): Breaking the Indefinite-Suppression Lower Bound with Relay-Free Deterministic 99\% Byzantine Fault Tolerance},
  pdfauthor={IOI}
}
...
\title{Asymptote Fault Tolerance (AFT): Breaking the Indefinite-Suppression Lower Bound with Relay-Free Deterministic 99\% Byzantine Fault Tolerance}
\author{IOI}
\date{March 17, 2026}
...
In that model delta, \AFT{} is \code{relay-free, coordinator-free,
pure-software deterministic 99\% Byzantine Tolerance}: the classical threshold
...
\code{99\% Byzantine Tolerance}. It breaks the classical threshold in the
...
exactly the paper's relay-free deterministic \code{99\% Byzantine Tolerance}
...
distance to the relay-free deterministic \code{99\% Byzantine Tolerance}
...
retrievability surface,
\item that the whole \AFT{} stack breaks the classical indefinite-suppression
lower bound by identifying the first illegal adversary step and realizing the
...
\begin{theorem}[Relay-Free Deterministic 99\% Byzantine Tolerance in \(M_{\mathrm{AFT}}\)]
...
\code{99\% Byzantine Tolerance} theorem in \(M_{\mathrm{AFT}}\), plus sound witness assignment and witness
