...
(***************************************************************************)
(* AFT-CB P2.7 — the §16 v3 succession kernel: observation-committed       *)
(* adjudication, activation on the objective chain condition, and the      *)
(* T5d-v3 claim over BINDING rivals.                                       *)
(*                                                                         *)
