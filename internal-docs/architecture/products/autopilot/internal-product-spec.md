...
* supervise live adaptive work graphs, devices, or embedded endpoints under the same operator identity
...
The shell should prefer context-driven defaults and per-project preferred lenses over a theatrical global mode switcher. A personal workspace may open in the Personal lens, a repo or workflow project may open in Builder, and a live work graph or device scope may open in Runtime / Fleet.
...
## 13. Adaptive Work Graph Orchestration

Autopilot should eventually support true adaptive work graphs, not just linear flows.
...
> A user or company can run an entire layer of sovereign autonomous action under their own authority, starting with software labor across local and connected systems, with capabilities spanning computer use and APIs, with adaptive work graphs coordinated under policy, and with enough evidence and replayability to trust and continuously improve the system over time.
