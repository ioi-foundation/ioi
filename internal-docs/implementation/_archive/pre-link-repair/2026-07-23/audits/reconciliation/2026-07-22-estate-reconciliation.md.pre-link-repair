...
| `ioi-target-end-state-master-implementation-guide.md` | `AUTHORITY` | Sole internal M0-M14 sequencer, implementation-stage activation/proof gates, and source-disposition ledger. Architecture owners still outrank it for meaning. | Keep in place and never duplicate. The approved stateless-guide slice now places the Status Truth Rule at the front door, replaces dated stage narratives with record/projection pointers, and makes section 13.3 step 9 the projection-regeneration rule. Its exact ignored-file change is preserved by the private [`WORK-RECORD` manifest](./reconciliation/stateless-master-guide.v1.json) and [reviewable patch](./reconciliation/stateless-master-guide.v1.patch). Further amendments require explicit user approval. |
