...
> **Execution routing (2026-07-17): preserved compatibility source;
> sequencing superseded.** This path remains for historical ADR and test
> backlinks. Do not execute its phase order directly. Use the
> [IOI Target-End-State Master Implementation Guide](./ioi-target-end-state-master-implementation-guide.md)
> and current canon.

Status: internal historical implementation and architecture-pressure guide.
