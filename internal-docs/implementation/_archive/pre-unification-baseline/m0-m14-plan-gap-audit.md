...
This dated, ignored internal audit is neither architecture canon, an
implementation-status owner, nor a sequencer. It does not amend or reorder the
M0-M14 program. Its pending slices live only in the private
`internal-docs/implementation/work-items/` estate; the public PR appendix may
summarize the audit but does not publish the work queue.
...
[`source-of-truth-map.md`](../../docs/architecture/_meta/source-of-truth-map.md), the contract-dependency
and claim horizons in [`execution-horizons.md`](../../docs/architecture/_meta/execution-horizons.md), the
sole internal M0-M14 sequencer above, and machine-checked private status in
ignored `ioi.program.work_item.v1` records plus
...
- **Canon specifies:** documentation ownership in
  [`source-of-truth-map.md`](../../docs/architecture/_meta/source-of-truth-map.md), contract-dependency and
  claim horizons in [`execution-horizons.md`](../../docs/architecture/_meta/execution-horizons.md), and
...
- **Code proves:** `scripts/m0-program-control.mjs` and
  ...
  [`m0-exit.v1.txt`](./evidence/m0-exit.v1.txt)
...
- **Canon specifies:**
  [`domain-kernels.md`](../../docs/architecture/foundations/domain-kernels.md),
  [`governed-autonomous-systems.md`](../../docs/architecture/foundations/governed-autonomous-systems.md),
...
- **Canon specifies:**
  [`collaborative-outcome-pattern.md`](../../docs/architecture/domains/ioi-ai/collaborative-outcome-pattern.md),
...
- **Canon specifies:**
  [`domain-ontologies-and-data-recipes.md`](../../docs/architecture/foundations/domain-ontologies-and-data-recipes.md),
...
- **Canon specifies:**
  [`institutional-learning-boundary.md`](../../docs/architecture/foundations/institutional-learning-boundary.md),
...
- **Canon specifies:** [`aiip.md`](../../docs/architecture/foundations/aiip.md), the common-object
...
- **Guide demands:** prove registry/rights/reputation/security/escrow/bond/
  ...
  distinct.
- **Canon specifies:**
  [`ioi-l1-mainnet.md`](../../docs/architecture/foundations/ioi-l1-mainnet.md),
  [`ioi-l1-contract-interfaces.md`](../../docs/architecture/foundations/ioi-l1-contract-interfaces.md),
...
+all such facts route to the owning private work-item record and program-state
+projection.
```
...
2. Existing private work-item records are the status owner even where their
   evidence arrays are empty. This audit did not reinterpret their status from
   prose or task exit codes, and no such record belongs in architecture canon.
