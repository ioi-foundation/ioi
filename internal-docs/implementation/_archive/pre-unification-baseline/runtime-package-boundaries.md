...
> **Execution routing (2026-07-17): conditional reference guardrail.** Rebase
> paths and taxonomy against current canon before using this checklist. Stage
> activation and runtime order are owned by the
...
| Hypervisor Foundry | Application surface over Hypervisor Core for worker/eval/training, benchmark, model, and package work | Separate runtime, Agentgres replacement, wallet authority, or storage authority |
| Hypervisor Providers / Environments | Default Hypervisor views over provider posture, nodes, workspaces, environments, sessions, leases, and restore/archive refs | Separate application, separate runtime, mandatory cloud router, Agentgres replacement, wallet authority, or storage authority |
