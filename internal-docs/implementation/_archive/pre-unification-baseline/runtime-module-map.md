...
> **Execution routing (2026-07-17): stale reference guardrail.** This body
> names deleted JS-daemon and bridge roots. Do not use its paths as current
> implementation truth until it is refreshed against the Rust daemon and
> canonical migration matrix. See the
