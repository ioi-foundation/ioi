...
| Hypervisor App/Web | `apps/hypervisor/` today, future Hypervisor app/web homes as code is renamed | First-class product clients over Hypervisor Core; product shell over Workbench, Foundry, provider/environment views, chat/assistant surfaces, and daemon/runtime projections. |
