...
|---|---|---|
| X-0 ODK canon expansion (DomainApp envelopes · composable-application journey · descriptor-expressibility rule) | ☐ | canon PRs against docs/architecture; lands before X-1. (a) DomainApp envelope family — PR #176 (LANDED); (b) composable-application journey — PR #173 (open); (c) ☐ |
