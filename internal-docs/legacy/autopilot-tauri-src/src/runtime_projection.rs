...
impl ActionKind {
    pub fn from_node_type(node_type: &str) -> Self {
        match node_type {
            ...
            "runtime_usage_meter" => Self::RuntimeUsageMeter,
            "runtime_context_budget" => Self::RuntimeContextBudget,
            "runtime_compaction_policy" => Self::RuntimeCompactionPolicy,
...
mod tests {
    ...
    fn substrate_classifies_workflow_node_kinds() {
        ...
        assert_eq!(
            ActionKind::from_node_type("runtime_usage_meter"),
            ActionKind::RuntimeUsageMeter
        );
        assert_eq!(
            ActionKind::from_node_type("runtime_context_budget"),
            ActionKind::RuntimeContextBudget
        );
        assert_eq!(
            ActionKind::from_node_type("runtime_compaction_policy"),
            ActionKind::RuntimeCompactionPolicy
        );
        assert_eq!(
