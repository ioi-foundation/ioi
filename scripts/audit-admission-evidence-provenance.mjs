...
const PINNED = [
  {"file": "authority_routes.rs", "rule": "D", "key": "operator", "count": 1, "disposition": "open_lead", "justification": "authority-grant subject defaulted to a constant in a handler that resolves nobody; plane previously flagged in aa61d92ef"},
  {"file": "editor_routes.rs", "rule": "D", "key": "operator", "count": 1, "disposition": "open_lead", "justification": "editor access-lease subject falls back to a constant when session_id is absent (weaker claim: subject is a session ref)"},
  {"file": "lifecycle_routes.rs", "rule": "A", "key": "actor", "count": 2, "disposition": "open_lead", "justification": "handle_compact / handle_workspace_trust_acknowledge forward a caller-chosen actor into kernel state updates \u2014 the GOV-ATTR class closed for reviewer_ref in e7deb8ca4, still open here"},
  {"file": "lifecycle_routes.rs", "rule": "A", "key": "actor_ref", "count": 1, "disposition": "open_lead", "justification": "handle_approval_request passes a caller-supplied actor_ref to authorize_approval_request \u2014 the caller-passed-actor-at-the-delegation-edge shape INV-37 was ratified against; adjacent receipt_refs are legitimately client-presented grants, actor_ref is not"},
  {"file": "lifecycle_routes.rs", "rule": "A", "key": "requested_by", "count": 1, "disposition": "open_lead", "justification": "pinned at gate introduction 2026-08-08; owed a handler-level reading"},
  {"file": "lifecycle_routes.rs", "rule": "D", "key": "operator", "count": 5, "disposition": "open_lead", "justification": "compaction-policy / context-budget / compact / workspace-trust mutation handlers default their acting principal to a constant"},
  {"file": "lifecycle_routes.rs", "rule": "D", "key": "unattributed", "count": 1, "disposition": "open_lead", "justification": "connector-invoke receipt attribution defaults to a constant instead of refusing"},
  {"file": "lifecycle_routes.rs", "rule": "D", "key": "user://local-operator", "count": 6, "disposition": "open_lead", "justification": "1 of 6 is the canonical resolver's fail-closed local-dev lane (hypervisor_request_identity, sanctioned); the other 5 default a stored session record's absent owner_ref before ownership comparisons \u2014 read before W1.2 closes the module"},
  {"file": "lifecycle_routes.rs", "rule": "E", "key": "handle_connector_invoke", "count": 1, "disposition": "open_lead", "justification": "connector existence answered (400) before resolve_principal \u2014 the record-existence oracle ordering bc73b5b20 fixed for approvals"},
