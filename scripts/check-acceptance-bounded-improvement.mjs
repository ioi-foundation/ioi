...
const CLAUSES = [
  ...
  { id: "2", clause: "Search cannot redefine the epoch: the order-0 epoch is frozen before search begins and an attempt to change it from inside search is refused", unit: "M10.2", absences: [absent("M10.2", "check:improvement-role-separation", "the planted search-role mutation against the frozen M10.1 EvaluationEpoch")] },
  ...
  { id: "4", clause: "Authority cannot fabricate evidence: a promotion attempted without the exposure ledger's records is refused (today: without a fresh simulation, an approved ApprovalRequest and an open ReleaseControl)", unit: "M10.1 · M10.2", provenBy: "1", absences: [absent("M10.2", "check:improvement-role-separation", "the exposure-ledger half — a promotion attempted without the M10.1 ledger's records")] },
