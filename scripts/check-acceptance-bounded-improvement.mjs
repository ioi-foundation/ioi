...
const CLAUSES = [
  ...
  { id: "6", clause: "Negative and inconclusive results are retained and reproducible, and a candidate archive is not a promotion queue — the retention half here (negative, inconclusive, blocked and invalid results immutable and byte-identical across a restart, no record carrying a promotion member); the archive half inside clause 2's gate (a nomination Authority REJECTED retained in the derived archive beside the applied one, with no rank, order or promote member anywhere)", unit: "M10.2 · M10.4", checks: [EVALUATION_PLANE, EVALUATION_PLANE_DRILL] },
