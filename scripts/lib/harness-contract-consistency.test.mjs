...
test("TS harness fork activation contract records blocked and canary-validated paths", () => {
  ...
  assert.match(graph, /WorkflowRevisionRestoreRequest[\s\S]*revisionBinding: WorkflowRevisionBinding[\s\S]*expectedWorkflowContentHash[\s\S]*dryRun\?: boolean/);
  assert.match(graph, /WorkflowRevisionRestoreResult[\s\S]*dryRun\?: boolean[\s\S]*git_show_file_restore[\s\S]*bundle\?: WorkflowWorkbenchBundle/);
  assert.match(graph, /WorkflowRevisionRestoreResult[\s\S]*receiptBindingRef\?: string/);
  ...
  assert.match(graph, /WorkflowHarnessLiveHandoffProof[\s\S]*livePromotionReadinessProof\?: WorkflowHarnessLivePromotionReadinessProof \| null[\s\S]*livePromotionReadinessReady: boolean[\s\S]*livePromotionReadinessBlockers: string\[\]/);
  assert.match(graph, /WorkflowHarnessRuntimeSelectorDecision[\s\S]*livePromotionReadinessProof\?: WorkflowHarnessLivePromotionReadinessProof \| null[\s\S]*livePromotionReadinessReady: boolean[\s\S]*livePromotionReadinessBlockers: string\[\]/);
  assert.match(graph, /WorkflowHarnessLivePromotionReadinessProof/);
  assert.match(graph, /WorkflowHarnessLivePromotionReadinessProof[\s\S]*requiredClusterIds[\s\S]*clusterReadiness[\s\S]*defaultLiveActivationReady[\s\S]*invalidForkLiveActivationBlocked/);
  assert.match(graph, /WorkflowHarnessDefaultRuntimeDispatchProof/);
  assert.match(graph, /WorkflowHarnessDefaultRuntimeDispatchProof[\s\S]*cognitionExecutionAdapterMode[\s\S]*cognitionExecutionAdapterResults[\s\S]*WorkflowHarnessComponentAdapterResult/);
  assert.match(graph, /WorkflowHarnessDefaultRuntimeDispatchProof[\s\S]*cognitionExecutionGateAdapterMode[\s\S]*cognitionExecutionGateAdapterResults[\s\S]*WorkflowHarnessDivergenceClass/);
  assert.match(graph, /WorkflowHarnessDefaultRuntimeDispatchProof[\s\S]*routingModelAdapterMode[\s\S]*routingModelAdapterResults[\s\S]*routingModelDivergenceClasses[\s\S]*WorkflowHarnessDivergenceClass/);
  assert.match(graph, /WorkflowHarnessDefaultRuntimeDispatchProof[\s\S]*verificationOutputAdapterMode[\s\S]*verificationOutputAdapterResults[\s\S]*verificationOutputDivergenceClasses[\s\S]*WorkflowHarnessDivergenceClass/);
  assert.match(graph, /WorkflowHarnessDefaultRuntimeDispatchProof[\s\S]*authorityToolingAdapterMode[\s\S]*authorityToolingAdapterResults[\s\S]*authorityToolingDivergenceClasses[\s\S]*WorkflowHarnessDivergenceClass/);
  assert.match(graph, /WorkflowHarnessDefaultRuntimeDispatchProof[\s\S]*livePromotionReadinessProof: WorkflowHarnessLivePromotionReadinessProof/);
  ...
  assert.match(workflow, /workflowHarnessLivePromotionReadinessProofBlockers[\s\S]*live_promotion_readiness_proof_missing[\s\S]*live_promotion_readiness_invalid_fork_not_blocked[\s\S]*live_promotion_readiness_cluster_divergence_not_ready/);
  assert.match(workflow, /makeHarnessDefaultRuntimeDispatchProof[\s\S]*read_only_cognition_routing_verification_completion_authority_tooling[\s\S]*cognitionExecutionAdapterMode: "workflow_component_adapter_live"[\s\S]*cognitionExecutionAdapterResults[\s\S]*cognitionExecutionGateAdapterMode: "workflow_component_adapter_gated"[\s\S]*cognitionExecutionGateAdapterResults[\s\S]*routingModelAdapterMode: "workflow_component_adapter_gated"[\s\S]*routingModelAdapterResults[\s\S]*routingModelComponentKinds[\s\S]*verificationOutputAdapterMode: "workflow_component_adapter_gated"[\s\S]*verificationOutputAdapterResults[\s\S]*verificationOutputComponentKinds[\s\S]*authorityToolingAdapterMode: "workflow_component_adapter_gated"[\s\S]*authorityToolingAdapterResults[\s\S]*authorityToolingComponentKinds[\s\S]*cognitionExecutionMode: "workflow_synchronous_envelope"[\s\S]*promptAssemblyMode: "workflow_synchronous_envelope"[\s\S]*modelExecutionMode: "workflow_synchronous_envelope"[\s\S]*modelExecutionProviderInvocationMode: "workflow_provider_canary"[\s\S]*modelProviderCanaryMode: "workflow_provider_canary"[\s\S]*modelProviderGatedVisibleOutputMode: "workflow_provider_gated_visible_output"[\s\S]*selectedVisibleOutputAuthority: "workflow_model_provider_call"[\s\S]*outputWriterDeferred: false[\s\S]*outputWriterStatus: "visible_write_committed"[\s\S]*outputWriterMaterializationMode: "workflow_visible_transcript_write"[\s\S]*outputWriterStagedWriteMode: "isolated_checkpoint_blob"[\s\S]*outputWriterVisibleWriteMode: "workflow_visible_transcript_write"[\s\S]*authorityToolingMode: "workflow_live_dry_run"[\s\S]*legacyOutputAuthorityRetained: false/);
  assert.match(workflow, /DEFAULT_VERIFICATION_OUTPUT_GATE_ADAPTER_COMPONENTS[\s\S]*postcondition_synthesizer[\s\S]*verifier[\s\S]*completion_gate[\s\S]*receipt_writer[\s\S]*quality_ledger[\s\S]*output_writer/);
  assert.match(workflow, /DEFAULT_AUTHORITY_TOOLING_GATE_ADAPTER_COMPONENTS[\s\S]*policy_gate[\s\S]*approval_gate[\s\S]*dry_run_simulator[\s\S]*mcp_provider[\s\S]*mcp_tool_call[\s\S]*tool_call[\s\S]*connector_call[\s\S]*wallet_capability/);
  assert.match(workflow, /makeHarnessDefaultRuntimeDispatchProof[\s\S]*verificationOutputProof:[\s\S]*workflow\.harness\.verification-output-envelope\.v1[\s\S]*adapterMode: "workflow_component_adapter_gated"[\s\S]*componentKinds: verificationOutputComponentKinds[\s\S]*policyDecision: "accept_workflow_verification_output_adapter_envelope"/);
  assert.match(workflow, /makeHarnessDefaultRuntimeDispatchProof[\s\S]*authorityToolingAdapterProof:[\s\S]*workflow\.harness\.authority-tooling-adapter-envelope\.v1[\s\S]*adapterMode: "workflow_component_adapter_gated"[\s\S]*componentKinds: authorityToolingComponentKinds[\s\S]*policyDecision: "accept_workflow_authority_tooling_adapter_envelope"/);
  assert.match(workflow, /makeHarnessLivePromotionReadinessProof[\s\S]*workflow\.harness\.live-promotion-readiness\.v1[\s\S]*invalidForkLiveActivationBlocked[\s\S]*allow_default_harness_live_promotion_readiness/);
  assert.match(workflow, /makeHarnessDefaultRuntimeDispatchProof[\s\S]*livePromotionReadinessProof[\s\S]*clusterId: "cognition"[\s\S]*clusterId: "routing_model"[\s\S]*clusterId: "verification_output"[\s\S]*clusterId: "authority_tooling"/);
  assert.match(workflow, /makeHarnessDefaultRuntimeDispatchProof[\s\S]*authorityToolingGateLiveAttemptIds:[\s\S]*authority_tooling_policy_gate[\s\S]*authority_tooling_destructive_denial[\s\S]*authority_tooling_approval_gate[\s\S]*authorityToolingReadOnlyLiveAttemptIds:[\s\S]*authority_tooling_mcp_provider_read_only[\s\S]*authority_tooling_mcp_tool_call_read_only[\s\S]*authority_tooling_tool_call_read_only[\s\S]*authority_tooling_connector_call_read_only[\s\S]*authority_tooling_wallet_capability_read_only[\s\S]*authorityToolingProviderCatalogLiveAttemptIds:[\s\S]*authority_tooling_mcp_provider_read_only[\s\S]*authorityToolingMcpToolCatalogLiveAttemptIds:[\s\S]*authority_tooling_mcp_tool_call_read_only[\s\S]*authorityToolingNativeToolCatalogLiveAttemptIds:[\s\S]*authority_tooling_tool_call_read_only[\s\S]*authorityToolingConnectorCatalogLiveAttemptIds:[\s\S]*authority_tooling_connector_call_read_only[\s\S]*authorityToolingWalletCapabilityLiveDryRunAttemptIds:[\s\S]*authority_tooling_wallet_capability_read_only[\s\S]*authorityToolingGateLiveReady: true[\s\S]*authorityToolingPolicyGateLiveReady: true[\s\S]*authorityToolingDestructiveDenialLiveReady: true[\s\S]*authorityToolingApprovalGateLiveReady: true[\s\S]*authorityToolingReadOnlyAuthorityCanaryReady: true[\s\S]*authorityToolingProviderCatalogLiveReady: true[\s\S]*authorityToolingMcpToolCatalogLiveReady: true[\s\S]*authorityToolingNativeToolCatalogLiveReady: true[\s\S]*authorityToolingConnectorCatalogLiveReady: true[\s\S]*authorityToolingWalletCapabilityLiveDryRunReady: true[\s\S]*gateLiveReady: true[\s\S]*policyGateLiveReady: true[\s\S]*destructiveDenialLiveReady: true[\s\S]*approvalGateLiveReady: true[\s\S]*readOnlyAuthorityCanaryReady: true[\s\S]*providerCatalogLiveReady: true[\s\S]*mcpToolCatalogLiveReady: true[\s\S]*nativeToolCatalogLiveReady: true[\s\S]*connectorCatalogLiveReady: true[\s\S]*walletCapabilityLiveDryRunReady: true[\s\S]*mutationDeferredComponentKinds: authorityToolingMutationDeferredComponentKinds/);
  ...
  assert.match(validation, /receiptBindingRef[\s\S]*workflow_restore_canary:[\s\S]*evidenceRefs/);
  assert.match(validation, /rollback_restore_canary_not_run[\s\S]*rollback_restore_canary_not_restored[\s\S]*rollback_restore_canary_bundle_missing[\s\S]*rollback_restore_canary_hash_mismatch/);
  assert.match(validation, /gateId: "slots"[\s\S]*gateId: "tests"[\s\S]*gateId: "replay-fixtures"[\s\S]*gateId: "policy-posture"[\s\S]*gateId: "receipt-coverage"[\s\S]*gateId: "canary"[\s\S]*gateId: "rollback-restore"[\s\S]*gateId: "rollback"[\s\S]*gateId: "worker-binding"[\s\S]*gateId: "activation-id"/);
