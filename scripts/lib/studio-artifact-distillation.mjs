...
export function collectStudioArtifactDistillationLedger(options = {}) {
...
export function loadStudioArtifactDistillationLedger(options = {}) {
  const repoRoot = options.repoRoot ?? process.cwd();
  const evidenceRoot =
    options.evidenceRoot ??
    path.join(repoRoot, "docs", "evidence", "studio-artifact-surface");
...
export function writeStudioArtifactDistillationLedger(options = {}) {
  const repoRoot = options.repoRoot ?? process.cwd();
  const evidenceRoot =
    options.evidenceRoot ??
    path.join(repoRoot, "docs", "evidence", "studio-artifact-surface");
...
export function collectStudioArtifactDistillationView(options = {}) {
  const repoRoot = options.repoRoot ?? process.cwd();
  const evidenceRoot =
    options.evidenceRoot ??
    path.join(repoRoot, "docs", "evidence", "studio-artifact-surface");
  const { ledgerPath, ledger } = loadStudioArtifactDistillationLedger({
    repoRoot,
    evidenceRoot,
