...
test("Autopilot Mounts workbench is wired to daemon API without persisting capability tokens", () => {
  ...
  for (const route of [
    ...
    "/v1/model-mount/backends/:id/health",
  ...
  assert.match(source, /Bandwidth policy/);
  assert.match(source, /Bandwidth B\/s/);
  assert.match(source, /Retry attempts/);
  assert.match(source, /Resume partial downloads/);
  assert.match(source, /Confirm destructive cleanup/);
  assert.match(source, /Remove orphan files/);
  assert.match(source, /Arm cancel/);
  assert.match(source, /Arm delete/);
  ...
  assert.match(source, /bandwidthPolicyGuard/);
  ...
  assert.match(source, /importValidationModel/);
  assert.match(source, /mountValidationModel/);
  ...
  assert.match(source, /bandwidth_bps/);
  assert.match(source, /retry_limit/);
  assert.match(source, /resume_download/);
  assert.match(source, /confirm_destructive/);
  assert.match(source, /remove_orphans/);
  assert.match(source, /variant_id/);
  assert.match(source, /catalog_provider_id/);
  ...
  assert.match(source, /deleteArtifact/);
  assert.match(source, /Catalog gate/);
  assert.match(source, /Download gate/);
  assert.match(source, /Catalog adapter/);
  assert.match(source, /Provider filter/);
  assert.match(source, /Catalog provider/);
  assert.match(source, /All catalog providers/);
  ...
  assert.match(source, /materialVaultRefHash/);
  assert.match(source, /vaultMaterialSource/);
  ...
  assert.match(source, /catalogAuthConfigured/);
  assert.match(source, /catalogAuthHeaderNameHash/);
  ...
  assert.match(source, /Custom HTTP catalog/);
  assert.match(source, /catalog\.ollama/);
  assert.match(source, /Ollama catalog bridge/);
  assert.match(source, /IOI_MODEL_CATALOG_MANIFEST_PATH/);
  assert.match(source, /IOI_MODEL_CATALOG_CUSTOM_BASE_URL/);
  assert.match(source, /OLLAMA_HOST/);
  ...
  assert.match(source, /model_invocation_stream_completed/);
  assert.match(source, /model_invocation_stream_canceled/);
  assert.match(source, /streamStatus/);
  assert.match(source, /streamSource/);
  assert.match(source, /streamKind/);
  assert.match(source, /invocationReceiptId/);
  assert.match(source, /chunksForwarded/);
  assert.match(source, /finishReason/);
  assert.match(source, /client_disconnect/);
  assert.match(source, /Replay stream receipt/);
