...
import {
  autopilotProfileRoot,
  openReadonlySqliteDatabase,
  waitForRetainedQueryRuntimeEvidence,
} from "./retained-query-evidence.mjs";
export {
  retainedQueryRuntimeEvidence,
  submitRetainedQuery,
  waitForRetainedQueryRuntimeEvidence,
  waitForRetainedQueryUserRequest,
} from "./retained-query-evidence.mjs";
...
export function collectRollbackRestoreCanaryUiProof(outputRoot) {
  ...
  const restoreCommandPath = "apps/hypervisor/src/services/HypervisorClientRuntime.ts";
  const projectPackagePath = "packages/hypervisor-workbench/src/runtime/harness-workflow/core.ts";
  const projectRustValidationPath =
    "packages/hypervisor-workbench/src/runtime/workflow-validation.ts";
  const projectRuntimePath = "apps/hypervisor/src/services/HypervisorClientRuntime.ts";
  ...
  const projectRuntimeTestsPath =
    "packages/hypervisor-workbench/src/runtime/harness-workflow-activation.test.ts";
...
export function buildGuiEvidenceAssessment({
  ...
  const hasWorkflowTerminalCodingLoopCreatorProof =
...
export async function collectPromotionTransitionLiveGuiInteractionProof(
  ...
  const proofWorkflowPath = resolve(
    repoRoot,
    ".agents/workflows/default-agent-harness-live-gui-promotion-proof.workflow.json",
  );
...
async function runGuiValidation(args, outputRoot) {
  ...
  try {
    ...
    const workflowTerminalCodingLoopCreatorProof =
    ...
    return {
      ...
      artifacts: {
        ...
        workflow_terminal_coding_loop_creator:
          workflowTerminalCodingLoopCreatorProof.proof.passed === true
            ? workflowTerminalCodingLoopCreatorProof.path
            : false,
        ...
        workflow_native_browser_prompt_pipeline:
          workflowNativeBrowserPromptPipelineProof.proof.passed === true
            ? workflowNativeBrowserPromptPipelineProof.path
            : false,
      ...
      uiAssertions: {
        ...
        workflowTerminalCodingLoopCreator:
