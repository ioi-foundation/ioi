...
export function collectRollbackRestoreCanaryUiProof(outputRoot) {
  ...
  const checks = {
    ...
    workflowSettingsHarnessModelUi:
      ...
      /WorkflowSettingsHarnessActivationGatePanel/.test(settingsHarnessActivationPanel) && /workflow-harness-activation-gate-inspector/.test(settingsHarnessActivationGatePanel) &&
  ...
  const proof = {
    ...
    sourceRefs: [
      ...
      settingsHarnessActivationPanelPath, settingsHarnessActivationGatePanelPath,
      settingsHarnessWorkerBindingPanelPath, settingsHarnessActiveRuntimeRollbackPanelPath, settingsHarnessActiveRuntimeBindingPanelPath, settingsHarnessRollbackRestoreProofPanelPath, settingsHarnessPromotionPanelPath,
      ...
      activationGateWorkerInvariantInspector:
        activationGateWorkerInvariantDeepLinkCase
	      ...
	      sourceRefs: [
	        ...
	        "packages/agent-ide/src/features/Workflows/WorkflowRailPanel/settingsHarnessActivationPanel.tsx", "packages/agent-ide/src/features/Workflows/WorkflowRailPanel/settingsHarnessActivationGatePanel.tsx", "packages/agent-ide/src/features/Workflows/WorkflowRailPanel/settingsHarnessWorkerBindingPanel.tsx", "packages/agent-ide/src/features/Workflows/WorkflowRailPanel/settingsHarnessActiveRuntimeRollbackPanel.tsx", "packages/agent-ide/src/features/Workflows/WorkflowRailPanel/settingsHarnessActiveRuntimeBindingPanel.tsx", "packages/agent-ide/src/features/Workflows/WorkflowRailPanel/settingsHarnessRollbackRestoreProofPanel.tsx", "packages/agent-ide/src/features/Workflows/WorkflowRailPanel/settingsHarnessPromotionPanel.tsx",
	        "packages/agent-ide/src/runtime/workflow-settings-harness-model.ts",
	        "packages/agent-ide/src/features/Workflows/WorkflowRailPanel/readinessPanel.tsx",
	        "packages/agent-ide/src/runtime/workflow-readiness-model.ts",
	        "packages/agent-ide/src/features/Workflows/WorkflowRailPanel/unitTestsPanel.tsx",
