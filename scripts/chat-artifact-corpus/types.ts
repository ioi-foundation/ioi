...
export interface ChatRuntimeRenderCapture {
...
export interface ChatRuntimeRenderFinding {
  code: string;
  severity: RenderFindingSeverity;
  summary: string;
}

export interface ChatRuntimeRenderEvaluation {
  supported: boolean;
  firstPaintCaptured: boolean;
  interactionCaptureAttempted: boolean;
  captures: ChatRuntimeRenderCapture[];
  ...
  overallScore: number;
  findings: ChatRuntimeRenderFinding[];
  summary: string;
}
...
export interface GeneratedArtifactEvidence {
  ...
  candidateSummaries: Array<{
    ...
    renderEvaluation?: ChatRuntimeRenderEvaluation | null;
    validation: ChatRuntimeValidationResult;
  }>;
  winningCandidateId: string | null;
  winningCandidateRationale: string | null;
  renderEvaluation?: ChatRuntimeRenderEvaluation | null;
  validation: ChatRuntimeValidationResult | null;
...
export type ChatRuntimeRuntimeEnv = {
  endpoint: string;
...
export interface CaseSummary {
  ...
  validation: ChatRuntimeValidationResult | null;
  rubric: ChatRuntimeValidationResult | null;
  classification: ValidationClassification;
  strongestContradiction: string | null;
  outputOrigin: string | null;
  productionProvenance: RuntimeProvenance | null;
...
export interface LiveChatRuntimeLaneSummary {
...
export interface CorpusSummary {
  ...
  lanes: {
    ...
    liveChatRuntime: LiveChatRuntimeLaneSummary;
  };
  parityChecks: {
    htmlDistinctness: {
      caseIds: string[];
