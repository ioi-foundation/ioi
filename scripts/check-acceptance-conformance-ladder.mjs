...
const CLAUSES = [
  ...
  { id: "7", clause: "The north-star network proof, deterministic half: the three-institution paid-hire/settlement/exit contract, the published offline-verifier package, two-substrate binding and same-owner/shared-control refusal, without claiming live organizational independence", unit: "M12.7 (product_track) · M06.11 · M09.10", checks: [{ ...bounded(rootScript("check:public-verifier-conformance", ["--", "--drills"]), 15), allowsFixture: true }], battery: { ...rootScript("mutate:public-verifier-conformance"), cost: "minutes" }, absences: [absent("M12.7 (product_track)", "check:horizon-3-independent-worker", "the deterministic three-institution matrix"), absent("M09.10", "check:multi-substrate-portability", "two deterministic adapters running one workload/authority/receipt contract with the eight substitution mutations")] },
