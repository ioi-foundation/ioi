  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">Marketplace Publishing</h1>
          <p className="text-gray-400 text-sm">Manage your listings on aiagent.xyz.</p>
        </div>
