      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="hidden lg:flex items-center space-x-2 bg-white/5 border border-white/10 rounded-full px-3 py-1">
            ...
            <span className="text-[10px] font-mono text-gray-400 uppercase tracking-widest">Service Plane: Active | 186 Governed Lanes Online</span>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-6 text-sm font-medium text-gray-400">
          ...
          <Link to="/templates" className="hover:text-white transition-colors">Catalog</Link>
          <Link to="/docs" className="hover:text-white transition-colors">Docs</Link>
          <Link to="/economics" className="hover:text-white transition-colors">Pricing</Link>
          <Link to="/security" className="hover:text-white transition-colors">Trust</Link>
          <Link to="/changelog" className="hover:text-white transition-colors">Updates</Link>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <a href="https://aiagent.xyz" target="_blank" rel="noreferrer" className="hidden sm:flex text-sm font-medium text-gray-400 hover:text-white transition-colors items-center">
            Browse supply on aiagent.xyz <ArrowRight className="w-3 h-3 ml-1" />
          </a>
