  ...
  function renderStudioOperationalSurface(state, { standalone = false } = {}) {
    ...
    return `
      <main
        ...
        data-policy-lease-allow-once-observed="${studioRuntimeProjection.runtimeCockpit?.policyLeaseAllowOnceObserved ? "true" : "false"}"
        data-policy-lease-revoke-observed="${studioRuntimeProjection.runtimeCockpit?.policyLeaseRevokeObserved ? "true" : "false"}"
        data-policy-lease-expiry-observed="${studioRuntimeProjection.runtimeCockpit?.policyLeaseExpiryObserved ? "true" : "false"}"
        data-policy-lease-revoked-action-blocked="${studioRuntimeProjection.runtimeCockpit?.policyLeaseRevokedActionDidNotExecute ? "true" : "false"}"
        data-policy-lease-expired-action-blocked="${studioRuntimeProjection.runtimeCockpit?.policyLeaseExpiredActionDidNotExecute ? "true" : "false"}"
