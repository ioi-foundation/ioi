...
const paths = {
  ...
  runtimeControls:
    "apps/autopilot/openvscode-extension/ioi-workbench/studio/runtime-controls.js",
  runtimeEventSelectors:
    "apps/autopilot/openvscode-extension/ioi-workbench/studio/runtime-event-selectors.js",
  threadEvents:
    "apps/autopilot/openvscode-extension/ioi-workbench/studio/thread-events.js",
  threadLifecycle:
    "apps/autopilot/openvscode-extension/ioi-workbench/studio/thread-lifecycle.js",
  pendingWork:
  ...
  runtimeRailRows:
    "apps/autopilot/openvscode-extension/ioi-workbench/studio/runtime-rail-rows.js",
  nativeChatView:
  ...
  parityPlusEvents:
    "apps/autopilot/openvscode-extension/ioi-workbench/studio/projection-parity-plus-events.js",
  runtimeEventProjection:
    "apps/autopilot/openvscode-extension/ioi-workbench/studio/projection-runtime-events.js",
  workspaceChanges:
    "apps/autopilot/openvscode-extension/ioi-workbench/studio/projection-workspace-changes.js",
  artifactRouting:
