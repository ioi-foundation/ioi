...
interface StudioWelcomeViewProps {
...
export function StudioWelcomeView({
  currentProject,
  projects,
  notificationCount,
  onOpenCanvas,
        ...
        <div className="studio-welcome-primary">
          <div className="studio-welcome-hero">
            ...
            <div className="studio-welcome-hero-copy">
              ...
              <p>
                Autopilot stays operator-first. Studio is the builder-first
          ...
          <div className="studio-welcome-hero-strip" aria-label="Studio posture">
