...
interface ChatNotificationDetailPanelProps {
...
export function ChatNotificationDetailPanel({
  item,
  onClose,
  onOpenAutopilot,
  onOpenLocalEngine,
  ...
  onOpenIntegrations,
  onOpenShield,
}: ChatNotificationDetailPanelProps) {
  return (
...
export const NotificationDetailPanel = ChatNotificationDetailPanel;
