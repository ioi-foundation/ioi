...
import { ChatNotificationDetailPanel } from "./ChatNotificationDetailPanel";
import type { AssistantNotificationRecord, AssistantWorkbenchSession } from "../../../types";

interface ChatNotificationsViewProps {
...
export const NotificationsView = ChatNotificationsView;
