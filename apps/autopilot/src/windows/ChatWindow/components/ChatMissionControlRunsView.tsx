...
interface ChatMissionControlRunsViewProps {
  runtime: TauriRuntime;
}

export function ChatMissionControlRunsView({ runtime }: ChatMissionControlRunsViewProps) {
  return (
...
export const MissionControlRunsView = ChatMissionControlRunsView;
