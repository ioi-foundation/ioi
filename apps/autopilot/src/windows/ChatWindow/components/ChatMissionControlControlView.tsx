...
import { ChatShieldPolicyView } from "./ChatShieldPolicyView";
...
interface ChatMissionControlControlViewProps {
...
export function ChatMissionControlControlView({
  runtime,
  surface,
  policyState,
  profile,
  ...
  onOpenConnections,
}: ChatMissionControlControlViewProps) {
...
export const MissionControlControlView = ChatMissionControlControlView;
