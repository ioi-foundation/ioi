...
import {
  ...
  type StudioExecutionPreview,
} from "./studioExecutionPreview";

export type StudioExecutionMetrics = {
  stage?: string | null;
...
export type StudioExecutionProcess = {
  id: string;
  label: string;
  status: string;
  summary: string;
...
export type StudioExecutionChrome = {
  ...
  livePreview: StudioExecutionPreview;
  codePreview: StudioExecutionPreview;
};
...
export function deriveStudioExecutionChrome({
  executionEnvelope,
  swarmExecution,
  swarmPlan,
  workerReceipts,
  ...
  const livePreview = resolveStudioExecutionStreamPreview({
    executionEnvelope,
    workerReceipts,
    changeReceipts,
  });
  const codePreview = resolveStudioExecutionCodePreview({
    executionEnvelope,
    workerReceipts,
    changeReceipts,
  });
