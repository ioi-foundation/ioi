...
assert.match(
  workflowValidation,
  /(?=[\s\S]*workflowIsHarnessFork)(?=[\s\S]*harness_required_slot_unbound)(?=[\s\S]*harness_activation_not_validated)(?=[\s\S]*harness_self_mutation_not_proposal_only)(?=[\s\S]*createWorkflowHarnessActivationCandidate)(?=[\s\S]*activationIdPreview)(?=[\s\S]*workerBindingPreview)(?=[\s\S]*dryRunOnly: true)/,
...
assert.match(
  harnessWorkflow,
  /(?=[\s\S]*recordWorkflowHarnessActivationDryRun)(?=[\s\S]*recordWorkflowHarnessRollbackTargetSelection)(?=[\s\S]*executeWorkflowHarnessRollbackDrill)(?=[\s\S]*rollback_drill_restored_previous_worker_binding)(?=[\s\S]*applyWorkflowHarnessActivationCandidate)(?=[\s\S]*activation_mint_blocked)(?=[\s\S]*activation_minted)(?=[\s\S]*candidate_not_mintable)(?=[\s\S]*activation_id_missing)(?=[\s\S]*activationState: "validated")(?=[\s\S]*workerHarnessBinding: workerBinding)(?=[\s\S]*rollbackTarget)(?=[\s\S]*componentVersionSet: candidate\.componentVersionSet)/,
...
assert.match(
  workflowRailPanel,
  /(?=[\s\S]*workflow-settings-harness-summary)(?=[\s\S]*Mode)(?=[\s\S]*Live-ready)(?=[\s\S]*Gated clusters)(?=[\s\S]*workflow-harness-activation-wizard)(?=[\s\S]*workflow-harness-activation-wizard-summary)(?=[\s\S]*workflow-harness-activation-candidate)(?=[\s\S]*workflow-harness-activation-candidate-decision)(?=[\s\S]*workflow-harness-activation-candidate-worker-binding)(?=[\s\S]*workflow-harness-worker-binding-rollback-targets)(?=[\s\S]*workflow-harness-worker-binding-rollback-target-\$\{index\})(?=[\s\S]*workflow-harness-worker-binding-apply-candidate)(?=[\s\S]*workflow-harness-worker-binding-run-rollback-drill)(?=[\s\S]*workflow-harness-rollback-drill-proof)(?=[\s\S]*workflow-harness-activation-audit)(?=[\s\S]*workflow-harness-activation-audit-list)(?=[\s\S]*workflow-harness-activation-audit-event-\$\{event\.eventId\})(?=[\s\S]*onSelectHarnessRollbackTarget)(?=[\s\S]*onApplyHarnessActivationCandidate)(?=[\s\S]*onRunHarnessRollbackDrill)(?=[\s\S]*workflow-harness-activation-candidate-gates)(?=[\s\S]*workflow-harness-activation-candidate-gate-\$\{gate\.gateId\})(?=[\s\S]*workflow-harness-activation-candidate-blockers)(?=[\s\S]*workflow-harness-activation-candidate-empty)(?=[\s\S]*workflow-harness-activation-dry-run)(?=[\s\S]*workflow-harness-activation-step-\$\{step\.id\})(?=[\s\S]*id: "slots")(?=[\s\S]*id: "tests")(?=[\s\S]*id: "replay-fixtures")(?=[\s\S]*id: "policy-posture")(?=[\s\S]*id: "receipt-coverage")(?=[\s\S]*id: "canary")(?=[\s\S]*id: "rollback")(?=[\s\S]*id: "activation-id")(?=[\s\S]*id: "worker-binding")(?=[\s\S]*workflow-harness-activation-blocked-proof)(?=[\s\S]*workflow-harness-activation-minted-proof)(?=[\s\S]*workflow-harness-activation-run-readiness)(?=[\s\S]*workflow-harness-activation-review-proposal)(?=[\s\S]*workflow-harness-slots)(?=[\s\S]*workflow-harness-promotion-clusters)(?=[\s\S]*workflow-harness-canary-execution-boundaries)(?=[\s\S]*workflow-harness-canary-execution-boundary)(?=[\s\S]*workflow-harness-default-runtime-dispatch)(?=[\s\S]*workflow-harness-read-only-routing-proof)(?=[\s\S]*workflow-harness-read-only-routing-node-kinds)(?=[\s\S]*workflow-harness-read-only-routing-receipts)(?=[\s\S]*workflow-harness-deep-link-state)(?=[\s\S]*workflow-copy-harness-deep-link)(?=[\s\S]*workflow-harness-group-inspector)(?=[\s\S]*workflow-harness-group-components)(?=[\s\S]*workflow-harness-group-receipt-refs)(?=[\s\S]*workflow-harness-group-receipt-ref-)(?=[\s\S]*workflow-harness-group-replay-fixtures)(?=[\s\S]*workflow-harness-group-replay-ref-)(?=[\s\S]*workflow-harness-group-shadow-comparison)(?=[\s\S]*workflow-run-harness-timeline)(?=[\s\S]*workflow-run-harness-shadow-comparison)(?=[\s\S]*workflow-selected-node-harness-component)(?=[\s\S]*workflow-selected-node-harness-receipts)(?=[\s\S]*workflow-selected-node-replay-binding)(?=[\s\S]*workflow-selected-node-harness-attempt)(?=[\s\S]*workflow-selected-node-read-only-routing-proof)(?=[\s\S]*workflow-selected-node-read-only-routing-receipts)(?=[\s\S]*workflow-selected-node-read-only-routing-no-mutation)(?=[\s\S]*replayEnvelope)/,
