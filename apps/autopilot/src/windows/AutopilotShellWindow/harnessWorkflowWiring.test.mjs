...
assert.match(
  ...
  /(?=[\s\S]*WorkflowHarnessActivationWizardStep)(?=[\s\S]*selectedHarnessActivationGateInspection)(?=[\s\S]*workflow-harness-activation-gate-inspector)(?=[\s\S]*workflow-harness-activation-gate-summary)(?=[\s\S]*workflow-harness-activation-gate-evidence-refs)(?=[\s\S]*workflow-harness-activation-gate-receipt-refs)(?=[\s\S]*workflow-harness-activation-gate-replay-refs)(?=[\s\S]*data-evidence-ref-count)(?=[\s\S]*data-selected-activation-gate-evidence-ref)(?=[\s\S]*data-activation-gate-evidence-ref)(?=[\s\S]*activationGateEvidenceRef)(?=[\s\S]*activationGateReceiptRef)(?=[\s\S]*activationGateReplayFixtureRef)(?=[\s\S]*selectedRailTestId: "workflow-harness-activation-gate-inspector")(?=[\s\S]*gateResults:[\s\S]*evidenceRefs)(?=[\s\S]*activationGateEvidenceInspectable)(?=[\s\S]*routeStatefulActivationGateReferenceDeepLinks)(?=[\s\S]*harness_activation_gate_evidence_inspector)(?=[\s\S]*harness_activation_gate_evidence_inspector_present)(?=[\s\S]*harness_activation_gate_ref_deep_link_restore)(?=[\s\S]*harness_activation_gate_ref_deep_link_restore_present)/,
