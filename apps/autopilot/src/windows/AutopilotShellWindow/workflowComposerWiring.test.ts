...
assert.match(
  ...
  "Replay fixture refs should run replay drills and batch replay gates, classify divergence, persist audit evidence, surface receipt refs, and feed activation readiness.",
);
