...
assert.match(
  harnessWorkflow,
  /(?=[\s\S]*forkDefaultAgentHarnessWorkflow[\s\S]*proposal-\$\{slug\}-activation-gates[\s\S]*forkedFrom[\s\S]*activationState: "blocked"[\s\S]*activationRecord)(?=[\s\S]*applyWorkflowHarnessActivationCandidate)(?=[\s\S]*candidate_not_mintable)(?=[\s\S]*activationState: "validated")(?=[\s\S]*workerHarnessBinding: workerBinding)(?=[\s\S]*componentVersionSet: candidate\.componentVersionSet)/,
  "Forking the Default Agent Harness should create editable lineage metadata, package proposal sidecars, and guarded candidate activation minting",
);
...
assert.match(
  workflowComposerUi,
  /(?=[\s\S]*workflow-open-default-harness)(?=[\s\S]*handleOpenDefaultHarness)(?=[\s\S]*workflow-fork-harness-button)(?=[\s\S]*handleForkDefaultHarness)(?=[\s\S]*handleApplyHarnessActivationCandidate)(?=[\s\S]*handleSelectHarnessRollbackTarget)(?=[\s\S]*workflow-readonly-badge)(?=[\s\S]*workflow-harness-worker-binding)(?=[\s\S]*workflow-harness-authority-gate-badge)/,
  "Workflow GUI should expose a read-only Default Agent Harness view, an editable fork path, worker harness identity, rollback target selection, activation minting, and authority gate live state",
);

assert.match(
  workflowRailPanel,
  /(?=[\s\S]*workflow-settings-harness-summary)(?=[\s\S]*Mode)(?=[\s\S]*Live-ready)(?=[\s\S]*Gated clusters)(?=[\s\S]*Authority gates)(?=[\s\S]*workflow-harness-authority-gate-status)(?=[\s\S]*Authority gate live)(?=[\s\S]*workflow-harness-worker-binding-inspector)(?=[\s\S]*workflow-harness-worker-binding-summary)(?=[\s\S]*workflow-harness-worker-binding-picker)(?=[\s\S]*workflow-harness-worker-binding-option-current)(?=[\s\S]*workflow-harness-worker-binding-option-candidate)(?=[\s\S]*workflow-harness-worker-binding-option-rollback)(?=[\s\S]*workflow-harness-worker-binding-rollback-targets)(?=[\s\S]*workflow-harness-worker-binding-rollback-target-\$\{index\})(?=[\s\S]*workflow-harness-worker-binding-apply-candidate)(?=[\s\S]*workflow-harness-worker-binding-version-set)(?=[\s\S]*harnessBindingVersionSet)(?=[\s\S]*harnessBindingRollbackTarget)(?=[\s\S]*harnessSelectedRollbackTarget)(?=[\s\S]*workflow-harness-activation-wizard)(?=[\s\S]*workflow-harness-activation-candidate)(?=[\s\S]*workflow-harness-activation-candidate-empty)(?=[\s\S]*workflow-harness-activation-candidate-gates)(?=[\s\S]*workflow-harness-activation-dry-run)(?=[\s\S]*workflow-harness-activation-step-\$\{step\.id\})(?=[\s\S]*id: "slots")(?=[\s\S]*id: "tests")(?=[\s\S]*id: "replay-fixtures")(?=[\s\S]*id: "policy-posture")(?=[\s\S]*id: "receipt-coverage")(?=[\s\S]*id: "canary")(?=[\s\S]*id: "rollback")(?=[\s\S]*id: "activation-id")(?=[\s\S]*id: "worker-binding")(?=[\s\S]*workflow-harness-slots)(?=[\s\S]*workflow-harness-promotion-clusters)(?=[\s\S]*workflow-harness-fork-component-diff)(?=[\s\S]*workflow-harness-fork-component-diff-summary)(?=[\s\S]*workflow-harness-default-runtime-dispatch)(?=[\s\S]*workflow-harness-authority-gate-live)(?=[\s\S]*workflow-harness-authority-gate-summary)(?=[\s\S]*workflow-harness-authority-gate-rollup)(?=[\s\S]*workflow-harness-authority-gate-list)(?=[\s\S]*workflow-selected-node-authority-gate-live)(?=[\s\S]*workflow-selected-node-authority-gate-list)(?=[\s\S]*policy_gate)(?=[\s\S]*destructive-denial)(?=[\s\S]*approval_gate)(?=[\s\S]*workflow-harness-read-only-routing-proof)(?=[\s\S]*workflow-harness-read-only-routing-node-kinds)(?=[\s\S]*workflow-harness-read-only-routing-receipts)(?=[\s\S]*workflow-run-harness-timeline)(?=[\s\S]*workflow-run-harness-shadow-comparison)(?=[\s\S]*workflow-selected-node-harness-component)(?=[\s\S]*workflow-selected-node-harness-receipts)(?=[\s\S]*workflow-selected-node-replay-binding)(?=[\s\S]*workflow-selected-node-harness-attempt)(?=[\s\S]*workflow-selected-node-read-only-routing-proof)(?=[\s\S]*workflow-selected-node-read-only-routing-receipts)(?=[\s\S]*workflow-selected-node-read-only-routing-no-mutation)(?=[\s\S]*replayEnvelope)/,
  "Workflow rail should render harness mode, readiness, activation wizard gates, activation candidates, rollback target selection, mint action, slots, promotion clusters, fork component diffs, default dispatch, authority gate live proof, read-only routing proof, component ids, receipt mappings, replay metadata, node attempts, no-mutation proof, and shadow comparison at node level",
);
