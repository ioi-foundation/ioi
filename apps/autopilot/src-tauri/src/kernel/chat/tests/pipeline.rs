...
fn pipeline_steps_for_ready_markdown_artifact_are_complete() {
    ...
    let mut materialization = materialization_contract_for_request(
        ...
        &request,
        "Chat created the artifact.",
        None,
        ChatExecutionStrategy::PlanExecute,
    );
    materialization.artifact_brief = Some(ChatArtifactBrief {
    ...
    materialization.prepared_context_resolution =
        Some(ioi_api::chat::ChatArtifactPreparedContextResolution {
...
fn pipeline_steps_surface_work_graph_execution_merge_and_repair() {
    ...
    materialization.work_graph_execution = Some(ChatArtifactWorkGraphExecutionSummary {
        ...
        active_worker_role: Some(ChatArtifactWorkerRole::Repair),
        total_work_items: 5,
    ...
    materialization.work_graph_worker_receipts = vec![ChatArtifactWorkerReceipt {
        ...
        runtime: crate::models::ChatRuntimeProvenance {
            kind: crate::models::ChatRuntimeProvenanceKind::FixtureRuntime,
...
fn materialization_contract_carries_micro_work_graph_mode_decision_and_budget() {
    ...
    let decision = ioi_types::app::ChatExecutionModeDecision {
        ...
        budget_envelope: ioi_types::app::ChatExecutionBudgetEnvelope {
            max_workers: 3,
            ...
            max_tool_calls: 6,
            max_repairs: 1,
            expansion_policy: ioi_types::app::ChatExecutionBudgetExpansionPolicy::ConfidenceGated,
        },
    };
...
fn pipeline_steps_label_micro_work_graph_and_surface_completion_progress() {
    ...
    materialization.execution_envelope = Some(ioi_api::execution::ExecutionEnvelope {
        ...
        mode_decision: Some(ioi_types::app::ChatExecutionModeDecision {
            ...
            budget_envelope: ioi_types::app::ChatExecutionBudgetEnvelope {
                ...
                max_repairs: 1,
                expansion_policy:
                    ioi_types::app::ChatExecutionBudgetExpansionPolicy::ConfidenceGated,
            },
        }),
        budget_envelope: Some(ioi_types::app::ChatExecutionBudgetEnvelope {
            max_workers: 3,
            max_parallel_depth: 2,
            max_replans: 1,
            max_wall_clock_ms: 300_000,
    ...
    materialization.work_graph_execution = Some(ChatArtifactWorkGraphExecutionSummary {
        ...
        execution_stage: Some(ExecutionStage::Mutate),
        active_worker_role: Some(ChatArtifactWorkerRole::SectionContent),
        total_work_items: 3,
