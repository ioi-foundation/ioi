use super::*;
use ioi_api::runtime_harness::{resolve_runtime_locality_placeholder, StudioIntentContext};
...
pub(super) fn studio_surface_http_client() -> Result<Client, String> {
    Client::builder()
...
fn places_request_for_tool_widget(
    ...
    if let Some(ioi_types::app::studio::StudioNormalizedRequestFrame::Places(frame)) =
