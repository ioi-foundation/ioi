...
pub(super) fn specialized_domain_clarification_question(
    ...
    let kind = studio_specialized_domain_kind(Some(frame))?;
    ...
    Some(match kind {
        StudioSpecializedDomainKind::Weather => {
            "Which city or area should Studio check for the weather?".to_string()
        }
        StudioSpecializedDomainKind::Sports => {
        ...
        StudioSpecializedDomainKind::Places => {
        ...
        StudioSpecializedDomainKind::Recipe => {
        ...
        StudioSpecializedDomainKind::UserInput => {
...
fn specialized_domain_clarification_options(
    ...
    let Some(kind) = studio_specialized_domain_kind(Some(frame)) else {
        return Vec::new();
    };
    let blocking_slots = studio_request_frame_clarification_slots(frame);
    if blocking_slots.is_empty() {
    ...
    match kind {
        StudioSpecializedDomainKind::Weather => {
            ...
            let mut options = vec![crate::models::ClarificationOption {
                ...
                description: "Tell Studio which city or area to use for the forecast.".to_string(),
            ...
            if blocking_slots.iter().any(|slot| slot == "team_or_target") {
                vec![
                    crate::models::ClarificationOption {
                        ...
                        description:
                            "Tell Studio the team, player, or matchup to anchor the sports lookup."
                                .to_string(),
                        recommended: true,
                    },
                    crate::models::ClarificationOption {
                ...
                vec![
                    crate::models::ClarificationOption {
                        ...
                        description: "Tell Studio which league to use before it continues."
                            .to_string(),
                        recommended: true,
                    },
                    crate::models::ClarificationOption {
        ...
        StudioSpecializedDomainKind::Places => {
            if blocking_slots.iter().any(|slot| {
                ...
                let mut options = vec![crate::models::ClarificationOption {
                    ...
                    description:
                        "Tell Studio the neighborhood, city, or landmark to search around."
                            .to_string(),
                    recommended: !locality_available,
                }];
                if locality_available {
                ...
                vec![
                    crate::models::ClarificationOption {
                        ...
                        description: "Tell Studio what kind of place to search for.".to_string(),
                        recommended: true,
                    },
                    crate::models::ClarificationOption {
        ...
        StudioSpecializedDomainKind::Recipe => vec![
            crate::models::ClarificationOption {
                id: "name_the_dish".to_string(),
                label: "Name the dish".to_string(),
                description: "Tell Studio the exact dish or recipe you want.".to_string(),
                recommended: true,
            },
            crate::models::ClarificationOption {
                id: "use_a_cuisine".to_string(),
                label: "Use a cuisine".to_string(),
                description: "Give a cuisine or style so Studio can suggest a fitting dish."
                    .to_string(),
                recommended: false,
            },
            crate::models::ClarificationOption {
                ...
                .any(|slot| slot == "recipient_context")
            {
                vec![
                    crate::models::ClarificationOption {
                        ...
                        description: "Tell Studio who the message is for or how to describe them."
                            .to_string(),
                        recommended: true,
                    },
                    crate::models::ClarificationOption {
        ...
        StudioSpecializedDomainKind::UserInput => vec![
            crate::models::ClarificationOption {
                id: "add_options".to_string(),
                label: "Add options".to_string(),
                description: "Tell Studio what choices should appear in the decision surface."
                    .to_string(),
                recommended: true,
            },
            crate::models::ClarificationOption {
                ...
                description: "Tell Studio how the options should be ranked or compared."
                    .to_string(),
                recommended: false,
            },
            crate::models::ClarificationOption {
                ...
                description:
                    "Ask Studio to draft a first set of candidate options for you to refine."
                        .to_string(),
                recommended: false,
            },
        ],
...
pub(in crate::kernel::studio) fn clarification_request_for_outcome_request(
    outcome_request: &StudioOutcomeRequest,
    ...
    let question = outcome_request
        ...
        .first()
        .cloned()
        .unwrap_or_else(|| "What should Studio create before it continues?".to_string());
    ...
    let question = if has_hint("prioritization_request") && has_hint("user_input_preferred") {
        ...
        format!(
            "{target_label} is not available in this runtime yet. Should Studio wait for you to connect it, or should I work from pasted data instead?"
        )
    } else if has_hint("connector_auth_required") {
        let target_label = routing_hint_prefixed_value(outcome_request, "connector_target_label:")
            .unwrap_or_else(|| "That connector".to_string());
        format!(
            "{target_label} is available here but not connected yet. Should Studio wait for you to connect it, or should I use another source?"
        )
    } else if has_hint("location_required_for_weather_advice") {
        "What city should Studio check the weather for?".to_string()
    ...
    Some(crate::models::ClarificationRequest {
        ...
        question,
        tool_name: "studio::route_clarification".to_string(),
...
fn route_clarification_options(
    ...
    if has_hint("connector_missing") {
        return vec![
            crate::models::ClarificationOption {
                ...
                description:
                    "Open Studio capabilities and connect the missing service before retrying."
                        .to_string(),
                recommended: true,
            },
            crate::models::ClarificationOption {
                ...
                description:
                    "Paste the messages, issues, or records here so Studio can work locally."
                        .to_string(),
                recommended: false,
            },
            crate::models::ClarificationOption {
    ...
    if has_hint("connector_auth_required") {
        return vec![
            crate::models::ClarificationOption {
                ...
                description: "Finish connector authentication, then let Studio retry the request."
                    .to_string(),
                recommended: true,
            },
            crate::models::ClarificationOption {
            ...
            crate::models::ClarificationOption {
                ...
                description: "Ask Studio to explain how to connect the required service first."
                    .to_string(),
                recommended: false,
            },
        ];
    ...
    if has_hint("location_required_for_weather_advice") {
        ...
        let mut options = vec![crate::models::ClarificationOption {
            id: "share_city".to_string(),
            label: "Share a city".to_string(),
            description: "Tell Studio which city to check before it answers.".to_string(),
            recommended: !locality_available,
        }];
        if locality_available {
            options.push(use_current_area_option(
