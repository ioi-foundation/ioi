...
impl ActionKind {
    pub fn from_node_type(node_type: &str) -> Self {
        match node_type {
            ...
            "uncertainty_gate" => Self::UncertaintyGate,
            "probe" => Self::Probe,
            ...
            "semantic_impact" => Self::SemanticImpact,
            "postcondition_synthesis" => Self::PostconditionSynthesis,
            "verifier" => Self::Verifier,
            "drift_detector" => Self::DriftDetector,
            "quality_ledger" => Self::QualityLedger,
            "handoff" => Self::Handoff,
            "gui_harness_validation" => Self::GuiHarnessValidation,
            "output" => Self::Output,
    ...
    pub fn node_type(&self) -> &'static str {
        match self {
            ...
            Self::SemanticImpact => "semantic_impact",
            Self::PostconditionSynthesis => "postcondition_synthesis",
            Self::Verifier => "verifier",
            Self::DriftDetector => "drift_detector",
            Self::QualityLedger => "quality_ledger",
            Self::Handoff => "handoff",
            Self::GuiHarnessValidation => "gui_harness_validation",
            Self::Output => "output",
    ...
    pub fn evidence_kind(&self) -> &'static str {
        match self {
            ...
            Self::Trigger => "trigger",
            Self::TaskState => "task_state",
            Self::UncertaintyGate => "uncertainty",
            Self::Probe => "probe",
