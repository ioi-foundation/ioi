...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            project::list_workflow_projects,
            project::create_workflow_project,
            ...
            project::run_workflow_project,
            project::run_workflow_project_live,
            project::run_workflow_node,
            project::run_workflow_node_live,
            project::dry_run_workflow_function,
            project::list_workflow_scaffolds,
            project::create_workflow_node_from_scaffold,
            project::validate_workflow_node_config,
            project::dry_run_workflow_node,
            project::materialize_workflow_function,
            project::list_workflow_model_bindings,
            project::list_workflow_delivery_targets,
            project::list_workflow_tool_catalog,
            project::list_workflow_connector_catalog,
            ...
            project::compare_workflow_runs,
            project::validate_workflow_bundle,
            project::validate_workflow_execution_readiness,
            project::check_workflow_binding,
            project::generate_workflow_binding_manifest,
            project::load_workflow_binding_manifest,
            project::export_workflow_package,
            project::import_workflow_package,
            project::list_workflow_evidence,
            project::list_workflow_node_fixtures,
            project::save_workflow_node_fixture,
            project::create_workflow_proposal,
            project::create_workflow_repair_proposal,
            project::apply_workflow_proposal,
            project::run_workflow_dogfood_suite,
