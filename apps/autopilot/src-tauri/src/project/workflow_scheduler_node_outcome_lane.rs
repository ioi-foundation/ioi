...
use super::workflow_scheduler_node_failure_outcome_lane::workflow_scheduler_handle_node_failure_outcome;
...
pub(super) fn workflow_scheduler_handle_node_outcome(
    ...
    match execution_result {
        ...
        Err(error) => workflow_scheduler_handle_node_failure_outcome(
            workflow_path,
            node,
            node_id,
            error,
