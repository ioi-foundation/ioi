...
fn workflow_repository_context_output(
    workflow_path: &Path,
    node_id: &str,
    logic: &Value,
    evidence_kind: &str,
...
fn workflow_branch_policy_output(
    node_id: &str,
    logic: &Value,
    input: &Value,
    evidence_kind: &str,
...
fn workflow_github_context_output(
    node_id: &str,
    logic: &Value,
    input: &Value,
    evidence_kind: &str,
...
fn workflow_issue_context_output(
    node_id: &str,
    logic: &Value,
    input: &Value,
    evidence_kind: &str,
...
fn workflow_review_gate_output(
    node_id: &str,
    logic: &Value,
    input: &Value,
    evidence_kind: &str,
...
fn workflow_github_pr_create_output(
    node_id: &str,
    logic: &Value,
    input: &Value,
    evidence_kind: &str,
