...
const SURFACES = [
  ...
  ["Daemon API", "The public runtime surface: project, session, and mission APIs, delegated work queues, adapter targets, and short-lived access tokens."],
  ["AIIP", "The semantic interop protocol for bounded autonomous-work handoffs between local microharness routing and external systems."],
