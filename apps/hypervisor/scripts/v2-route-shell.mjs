...
export const V2_ROUTE_TABLE = [
  ...
  },
  {
    ...
    serve: { kind: "rewrite", to: "/__ioi/systems-projection", heading: "Systems" },
    serving_today: [
      { href: "/__ioi/systems-projection", label: "Systems — policy-filtered projection", note: "M08.9 (2026-09-14): canon's HypervisorSystemsProjection rows over GET /v1/hypervisor/autonomous-systems/projection — verified genesis + live chain, membership and writer planes as typed presence/absence, the seven modes as routes; honest_empty when nothing is admitted" },
  ...
  },
  {
    ...
    serve: { kind: "rewrite", to: "/__ioi/work-projection/sessions", heading: "Work / Sessions" },
    serving_today: [
      { href: "/__ioi/work-projection/sessions", label: "Sessions — typed Work view", note: "M08.9 (2026-09-14): the session rows of the Work projection (subject_kind session, the Session owner's identity verbatim, facets derived from lifecycle_state)" },
      { href: "/__ioi/sessions", label: "Sessions root readout", note: "the T2 readout the retired view's grammar was rehomed from — the live Sessions surface; a migration input of the typed view" },
  ...
  },
  {
    ...
    surface: "Work / Queues",
    kind: "typed Work view (core workspace: Work)",
    rule: "typed views only; work_queue / work_item / work_run are typed absences until the work-lifecycle owner publishes an enumeration",
    waves: "M08.9 (2026-09-14)",
    build_state: "M08.9 (2026-09-14): served from the typed Work projection (GET /v1/hypervisor/work-projection?view=queues); rows are typed subjects with deep links to their owners, counts and recents are computed after the owners' policy, and what no owner enumerates is a typed absence on the page",
    serve: { kind: "rewrite", to: "/__ioi/work-projection/queues", heading: "Work / Queues" },
    serving_today: [
      { href: "/__ioi/work-projection/queues", label: "Queues — typed Work view", note: "M08.9: the queues view of the policy-filtered Work projection" },
    ],
  },
  {
    route: "/work/reviews",
    surface: "Work / Reviews",
    kind: "typed Work view (core workspace: Work)",
    rule: "a review is a policy-filtered FACET pointing at its owner (governance approval requests today), never a minted Review object",
    waves: "M08.9 (2026-09-14)",
    build_state: "M08.9 (2026-09-14): served from the typed Work projection (GET /v1/hypervisor/work-projection?view=reviews); rows are typed subjects with deep links to their owners, counts and recents are computed after the owners' policy, and what no owner enumerates is a typed absence on the page",
    serve: { kind: "rewrite", to: "/__ioi/work-projection/reviews", heading: "Work / Reviews" },
    serving_today: [
      { href: "/__ioi/work-projection/reviews", label: "Reviews — typed Work view", note: "M08.9: the reviews view of the policy-filtered Work projection" },
    ],
  },
  {
    route: "/work/incidents",
    surface: "Work / Incidents",
    kind: "typed Work view (core workspace: Work)",
    rule: "an incident is a policy-filtered FACET pointing at its owner; no incident owner publishes a reader yet, so the view is a typed absence",
    waves: "M08.9 (2026-09-14)",
    build_state: "M08.9 (2026-09-14): served from the typed Work projection (GET /v1/hypervisor/work-projection?view=incidents); rows are typed subjects with deep links to their owners, counts and recents are computed after the owners' policy, and what no owner enumerates is a typed absence on the page",
    serve: { kind: "rewrite", to: "/__ioi/work-projection/incidents", heading: "Work / Incidents" },
    serving_today: [
      { href: "/__ioi/work-projection/incidents", label: "Incidents — typed Work view", note: "M08.9: the incidents view of the policy-filtered Work projection" },
    ],
  },
  {
    route: "/work/history",
    surface: "Work / History",
    kind: "typed Work view (core workspace: Work)",
    rule: "completed, failed and archived work by derived activity facet; nothing is written back to any owner",
    waves: "M08.9 (2026-09-14)",
    build_state: "M08.9 (2026-09-14): served from the typed Work projection (GET /v1/hypervisor/work-projection?view=history); rows are typed subjects with deep links to their owners, counts and recents are computed after the owners' policy, and what no owner enumerates is a typed absence on the page",
    serve: { kind: "rewrite", to: "/__ioi/work-projection/history", heading: "Work / History" },
    serving_today: [
      { href: "/__ioi/work-projection/history", label: "History — typed Work view", note: "M08.9: the history view of the policy-filtered Work projection" },
    ],
  },
  {
    route: "/settings",
