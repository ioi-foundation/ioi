...
const PINNED = {
   ...
   */
  unadjudicable: {
    "foreign-qualified": 4341 /* 2026-09-18 (R-192, S5-1, follow-up): −6, the same arm's StatusCode uses. Before that, 2026-09-18 (R-192, S5-1): −497 — the deleted GoalRun modules' uses of names this walk does not contain (StatusCode, Value, header and the like). Before that, 2026-09-18 (R-190, S4d-2): +8, the membership handler's StatusCode/Value uses; before that, 2026-09-18 (R-189, S4d-1): −25, the retired System-bound lane's share; before that, 2026-09-18 (R-187, S4c-2 dead-code closure): −1, `std::time::UNIX_EPOCH` in the deleted room-keyed wrapper; before that, 2026-09-17 (R-187, S4c-2): −84 — the two room modules' share; before that, 2026-09-16: R-178 S4a / R-179 — six room-hosted modules deleted (attempt_finding, verifier_challenge, resource_capability_offer, work_frontier_claim, room_participation, m048_collaboration) */,
