// The surface registry — the explicit table of certified runtime/tool surfaces (functional-runtime
// wave). Each entry is the CODE-side identity of one certified port: slug (joins the parity
// matrix + pixel certification, the EVIDENCE side), current serving route, product placement,
// display title + app tile icon, and the paths of its verifier + certification artifact.
//
// IMPORTANT: a row here is runtime and UX evidence, never peer-application membership. Product
// membership comes from typed registrations in product-surface-registry.mjs. `route` remains the
// route that actually serves today; `canonical_target_route` names the post-taxonomy destination
// without pretending that route has shipped.
//
...
export const SURFACE_CLASSES = ["tool_surface", "workspace_view"];
export const ROUTE_POSTURES = ["canonical", "compatibility_alias"];

export const SURFACES = [
  { slug: "pipeline", owner: "Data", title: "Pipeline Builder", served_title: "Pipeline Builder", surface_class: "tool_surface", placement_owner_ref: "application:data", placement: "Data / Recipes", route: "/__ioi/pipeline", canonical_target_route: "/data/recipes", route_posture: "compatibility_alias", icon: PIPELINE_APP_ICON_URI, verifier: "scripts/verify-hypervisor-app-parity-pipeline.mjs", certification: "pixel-certifications/pipeline.json", capabilities: ["browse", "select", "inspect", "create", "transition", "execute", "proof"], operational_state: "workflow_complete", embedded_shell_state: "native_single_rail", interaction_parity_state: "atlas_verified" },
  { slug: "sources", owner: "Data", title: "Data Connections", served_title: "Data Connection", surface_class: "tool_surface", placement_owner_ref: "application:data", placement: "Data / Sources", route: "/__ioi/data/sources", canonical_target_route: "/data/sources", route_posture: "compatibility_alias", icon: SRC_APP_TILE_URI, verifier: "scripts/verify-hypervisor-app-parity-sources.mjs", certification: "pixel-certifications/sources.json", capabilities: ["browse", "select", "create"], operational_state: "act", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  { slug: "schema", owner: "Ontology", title: "Ontology Manager", served_title: "Ontology Manager", surface_class: "tool_surface", placement_owner_ref: "application:ontology", placement: "Ontology / Schema", route: "/__ioi/ontology/manager", canonical_target_route: "/ontology/schema", route_posture: "compatibility_alias", icon: ONTOLOGY_APP_ICON_URI, verifier: "scripts/verify-hypervisor-app-parity-ontology-manager.mjs", certification: "pixel-certifications/schema.json", capabilities: ["browse", "filter", "select", "inspect", "create", "update", "proof"], operational_state: "act", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  { slug: "explorer", owner: "Ontology", title: "Object Explorer", served_title: "Object Explorer", surface_class: "tool_surface", placement_owner_ref: "application:ontology", placement: "Ontology / Explore", route: "/__ioi/ontology/explorer", canonical_target_route: "/ontology/explore", route_posture: "compatibility_alias", icon: EXPLORER_APP_ICON_URI, verifier: "scripts/verify-hypervisor-app-parity-object-explorer.mjs", certification: "pixel-certifications/explorer.json", capabilities: ["browse", "filter", "select", "inspect", "proof"], operational_state: "inspect", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  { slug: "approvals", owner: "Governance", title: "Approvals", served_title: "Approvals", surface_class: "tool_surface", placement_owner_ref: "application:governance", placement: "Governance / Approvals", route: "/__ioi/governance/approvals", canonical_target_route: "/governance/approvals", route_posture: "compatibility_alias", icon: APPROVALS_APP_ICON_URI, verifier: "scripts/verify-hypervisor-app-parity-approvals.mjs", certification: "pixel-certifications/approvals.json", capabilities: ["browse", "filter", "select", "inspect", "transition"], operational_state: "act", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  { slug: "incidents", owner: "Work", title: "Incidents", served_title: "Issues", surface_class: "workspace_view", placement_owner_ref: "workspace:work", placement: "Work / Incidents", route: "/__ioi/missions/incidents", canonical_target_route: "/work/incidents", route_posture: "compatibility_alias", icon: ISSUES_APP_ICON_URI, verifier: "scripts/verify-hypervisor-app-parity-incidents.mjs", certification: "pixel-certifications/incidents.json", capabilities: ["browse", "filter", "proof"], operational_state: "browse", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  { slug: "models", owner: "Foundry", title: "Model Catalog", served_title: "Model Catalog", surface_class: "tool_surface", placement_owner_ref: "application:foundry", placement: "Foundry / Models", route: "/__ioi/foundry/models", canonical_target_route: "/foundry/models", route_posture: "compatibility_alias", icon: MODELS_APP_ICON_URI, verifier: "scripts/verify-hypervisor-app-parity-foundry-models.mjs", certification: "pixel-certifications/models.json", capabilities: ["browse"], operational_state: "browse", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  { slug: "listings", owner: "Packages", title: "Marketplace", served_title: "Marketplace", surface_class: "tool_surface", placement_owner_ref: "application:packages", placement: "Packages / Marketplace", route: "/__ioi/marketplace/listings", canonical_target_route: "/packages/marketplace", route_posture: "compatibility_alias", icon: MARKETPLACE_APP_ICON_URI, verifier: "scripts/verify-hypervisor-app-parity-listings.mjs", certification: "pixel-certifications/listings.json", capabilities: ["browse"], operational_state: "browse", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  { slug: "designer", owner: "Studio", title: "System Designer", served_title: "Solution Designer", surface_class: "tool_surface", placement_owner_ref: "application:studio", placement: "Studio / System Design", route: "/__ioi/studio/designer", canonical_target_route: "/studio/system-design", route_posture: "compatibility_alias", icon: DSG_APP_TILE_URI, verifier: "scripts/verify-hypervisor-app-parity-studio-designer.mjs", certification: "pixel-certifications/designer.json", capabilities: ["browse"], operational_state: "browse", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  { slug: "machinery", owner: "Automations", title: "Process Graphs", served_title: "Machinery", surface_class: "tool_surface", placement_owner_ref: "application:automations", placement: "Automations / Process Graphs", route: "/__ioi/studio/machinery", canonical_target_route: "/automations/process-graphs", route_posture: "compatibility_alias", icon: MCH_APP_TILE_URI, verifier: "scripts/verify-hypervisor-app-parity-studio-machinery.mjs", certification: "pixel-certifications/machinery.json", capabilities: ["browse"], operational_state: "browse", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  { slug: "monitors", owner: "Automations", title: "Monitors", served_title: "Automate", surface_class: "tool_surface", placement_owner_ref: "application:automations", placement: "Automations / Monitors", route: "/__ioi/automations/monitors", canonical_target_route: "/automations/monitors", route_posture: "compatibility_alias", icon: MON_APP_TILE_URI, verifier: "scripts/verify-hypervisor-app-parity-monitors.mjs", certification: "pixel-certifications/monitors.json", capabilities: ["browse"], operational_state: "browse", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  { slug: "changes", owner: "Improvement", title: "Change Inbox", served_title: "Upgrade Assistant", surface_class: "tool_surface", placement_owner_ref: "application:improvement", placement: "Improvement / Changes", route: "/__ioi/improvement/changes", canonical_target_route: "/improvement/changes", route_posture: "compatibility_alias", icon: CHG_APP_TILE_URI, verifier: "scripts/verify-hypervisor-app-parity-changes.mjs", certification: "pixel-certifications/changes.json", capabilities: ["browse"], operational_state: "browse", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  { slug: "evalsuites", owner: "Evaluations", title: "Evaluation Suites", served_title: "AIP Evals", surface_class: "tool_surface", placement_owner_ref: "application:evaluations", placement: "Evaluations / Suites", route: "/__ioi/evaluations/evalsuites", canonical_target_route: "/evaluations/suites", route_posture: "compatibility_alias", icon: EVL_APP_TILE_URI, verifier: "scripts/verify-hypervisor-app-parity-evalsuites.mjs", certification: "pixel-certifications/evalsuites.json", capabilities: ["browse"], operational_state: "browse", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
].map((entry) => ({ ...entry, peer_application: false }));

// Fail-fast registry invariants: a typo'd capability, state, or product placement is a boot error,
// not a silent lie. These checks still do not grant product membership.
for (const s of SURFACES) {
  if (!SURFACE_CLASSES.includes(s.surface_class)) throw new Error(`surface-registry: '${s.slug}' has an invalid surface_class`);
  if (!s.placement_owner_ref || !s.placement || !s.served_title || !s.canonical_target_route) throw new Error(`surface-registry: '${s.slug}' has an incomplete product placement`);
  if (!ROUTE_POSTURES.includes(s.route_posture)) throw new Error(`surface-registry: '${s.slug}' has an invalid route_posture`);
  if (s.peer_application !== false) throw new Error(`surface-registry: '${s.slug}' must remain contextual evidence, not a peer application`);
...
if (process.env.IOI_APP_RUNTIME_TEST_ROUTE === "1") {
  SURFACES.push({ slug: "__test_action", runtime_test_only: true, owner: "Test", title: "Action Runtime Test", icon: "data:,x", route: "/__ioi/__test/action-surface", verifier: "n/a", certification: "n/a", capabilities: ["browse"], operational_state: "browse", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" });
