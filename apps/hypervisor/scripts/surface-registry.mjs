...
export const SURFACES = [
  ...
  { slug: "ecology", owner: "Missions", title: "Artifact Ecology", icon: ecologyModule.ECOLOGY_APP_ICON_URI, route: "/__ioi/missions/ecology", verifier: "../../scripts/check-collective-artifact-ecology-surface.mjs", certification: "n/a", catalog_evidence: { schema: "ioi.hypervisor.catalog-contract-evidence.v1", artifact: "application-operational-depth.json", evidence_key: "ecology", module: "surfaces/ecology/index.mjs", verifier: "../../scripts/check-collective-artifact-ecology-surface.mjs" }, capabilities: ["browse", "filter", "select", "inspect", "proof"], operational_state: "read_only_by_contract", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
  ...
  { slug: "machinery", owner: "Automations", title: "Machinery", icon: MCH_APP_TILE_URI, route: "/__ioi/studio/machinery", verifier: "scripts/verify-hypervisor-app-parity-studio-machinery.mjs", certification: "pixel-certifications/machinery.json", capabilities: ["browse"], operational_state: "browse", embedded_shell_state: "native_single_rail", interaction_parity_state: "none" },
