...
for (const [needle, code] of [
  ...
  ["parse_cheapest_qualified_bid", "exact_ceiling_selector_absent"],
  ...
  ["parse_pinned_qualified_bid", "exact_provider_ceiling_gate_absent"],
...
for (const name of [
  ...
  "cheapest_qualified_bid_enforces_exact_denom_and_ceiling",
  "endpoint_discovery_does_not_inflate_zero_ready_replicas",
  "pinned_qualified_bid_enforces_provider_denom_and_ceiling_together",
]) {
