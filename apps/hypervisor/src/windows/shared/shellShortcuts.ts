  ...
  return [
    {
      ...
      summary: "Show or hide Hypervisor from anywhere.",
    },
    {
      ...
      summary: "Open the Hypervisor command palette from the active shell.",
    },
    {
      id: "chat-new-session",
    ...
    },
    {
      ...
      defaultBinding: "Esc",
      scope: "Hypervisor shell",
      source: "Session input controls",
      summary: "Stop the active task or close the current inspection surface.",
    },
    {
      id: "chat-command-palette",
      command: "Open Hypervisor command palette",
      binding: chatCommandPaletteShortcutLabel(platformInfo),
      defaultBinding: chatCommandPaletteShortcutLabel(platformInfo),
      scope: "Hypervisor shell",
      source: "Hypervisor command header",
