...
export const HypervisorRailLogoIcon = () => (
  ...
  >
    <defs>
      <linearGradient id="hypervisor-ioi-gem-vert" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0" stopColor="#75abf0" />
        <stop offset="0.5" stopColor="#5a8cec" />
        <stop offset="1" stopColor="#3650c0" />
      </linearGradient>
      <linearGradient id="hypervisor-ioi-gem-pale" x1="0" y1="0" x2="1" y2="0">
        <stop offset="0" stopColor="#f7f8f7" />
        <stop offset="1" stopColor="#b0c6f4" />
      </linearGradient>
      <linearGradient id="hypervisor-ioi-gem-deep" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0" stopColor="#3b5eda" />
        <stop offset="1" stopColor="#2740a8" />
      </linearGradient>
      <linearGradient id="hypervisor-ioi-gem-light" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0" stopColor="#d3d3df" />
        <stop offset="1" stopColor="#f7f8f7" />
      </linearGradient>
    </defs>
    <polygon points="295.299,434.631 295.299,654.116 485.379,544.373" fill="url(#hypervisor-ioi-gem-vert)" />
    <polygon points="500,308.005 302.61,421.968 500,535.931 697.39,421.968" fill="url(#hypervisor-ioi-gem-pale)" />
    <polygon points="876.043,695.903 719.322,425.085 719.322,662.557 854.487,740.594" fill="url(#hypervisor-ioi-gem-deep)" />
    <polygon points="514.621,544.373 704.701,654.115 704.701,434.631" fill="#9dc2f5" />
    <polygon points="164.878,780.741 470.757,780.741 287.988,675.22 151.883,753.8" fill="#6b8fd9" />
    <polygon points="533.962,104.779 507.31,104.779 507.31,295.342 712.945,414.066" fill="#5c82dc" />
    <polygon points="123.957,695.903 145.513,740.594 280.678,662.557 280.678,425.086" fill="url(#hypervisor-ioi-gem-light)" />
    <polygon points="835.122,780.741 848.117,753.8 712.012,675.219 529.242,780.741" fill="#4877dc" />
    <polygon points="466.038,104.779 287.055,414.066 492.689,295.343 492.689,104.779" fill="url(#hypervisor-ioi-gem-pale)" />
    <polygon points="500,780.741 500,552.815 302.61,666.778 500,780.741" fill="#5d83df" />
    <polygon points="500,552.815 500,780.741 697.39,666.778" fill="#8ab7e8" />
  </svg>
);
