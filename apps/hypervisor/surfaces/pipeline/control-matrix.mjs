...
export const CONTROL_MATRIX = [
  ...
  { id: "hdr.tabs-mode", region: "header", label: "Graph / Proposals / History tabs", reference: "switches the workspace between graph, proposal review, and version history", outcome: "unsupported", reason: "no PIPELINE proposal/branch/version plane exists — the surface is permanently the Graph workspace; run history lives on the Provenance surface (linked from node details)" },
  ...
  { id: "hdr.propose", region: "header", label: "Propose", reference: "opens proposal flow", outcome: "unsupported", reason: "no PIPELINE proposal plane — the ontology proposal plane landed in next-legs XIII and is a different subject" },
