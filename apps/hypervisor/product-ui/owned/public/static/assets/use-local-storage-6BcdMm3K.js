...
var n = e(t(), 1),
  r = (e, t) => {
    ...
    return (
      ...
      {
        storedValue: i,
        setValue: (0, n.useCallback)(
          (n) => {
            try {
              (n === void 0 ? (window.localStorage.removeItem(e), a(t)) : (window.localStorage.setItem(e, n), a(n)),
                (o.current = !0),
                window.dispatchEvent(new StorageEvent(`storage`, { key: e, newValue: n })));
            } catch (t) {
