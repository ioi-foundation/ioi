...
function i(e) {
  return Array.isArray(e) ? a(e) : e instanceof RegExp ? e : typeof e == `object` ? o(e) : e;
}
function a(e) {
  let t = [];
...
function c(e) {
  ...
  return t === 0 ? e : ~t === e.length - 1 ? c(e.substring(0, e.length - 1)) : e.substr(~t + 1);
}
...
var h = class {
  ...
  g = class {
    ...
    match(e) {
      ...
      let t = e.scopeName,
        n = this._cachedMatchRoot.get(t).find((t) => v(e.parent, t.parentScopes));
...
function ne(e) {
  ...
  for (let e = 0, i = t.length; e < i; e++) {
    ...
    let s = null;
    typeof i.settings.foreground == `string` && p(i.settings.foreground) && (s = i.settings.foreground);
    let c = null;
    typeof i.settings.background == `string` && p(i.settings.background) && (c = i.settings.background);
...
function ie(e, t) {
  e.sort((e, t) => {
    ...
    return n !== 0 || ((n = f(e.parentScopes, t.parentScopes)), n !== 0) ? n : e.index - t.index;
  });
  let n = 0,
    r = `#000000`,
    i = `#ffffff`;
  ...
  ce = class e {
    ...
    insert(t, n, r, i, a, o) {
      ...
      (this._children.hasOwnProperty(c)
        ? (u = this._children[c])
        : ((u = new e(this._mainRule.clone(), se.cloneArr(this._rulesWithParentScopes))), (this._children[c] = u)),
...
function be(e, t, n, r) {
  ...
  e instanceof ge
    ...
    : xe(e.ruleName, { baseGrammar: a, selfGrammar: i, repository: i.repository }, r);
...
function Se(e, t) {
  (e.selfGrammar.patterns &&
    ...
    Ce(e.selfGrammar.patterns, { ...e, repository: e.selfGrammar.repository }, t),
    e.selfGrammar.injections &&
      Ce(Object.values(e.selfGrammar.injections), { ...e, repository: e.selfGrammar.repository }, t));
}
function Ce(e, t, n) {
  for (let r of e) {
    ...
    switch (a.kind) {
      ...
      case 4:
        ...
        } else a.kind === 4 ? n.add(new _e(a.scopeName, a.ruleName)) : n.add(new ge(a.scopeName));
        break;
    }
  }
}
...
function ke(e) {
  ...
  let t = e.indexOf(`#`);
  return t === -1 ? new De(e) : t === 0 ? new Ee(e.substring(1)) : new Oe(e.substring(0, t), e.substring(t + 1));
}
var Ae = /\\(\d+)/,
  je = /\\(\d+)/g,
  Me = -1,
...
var Ie = class {
    ...
    get debugName() {
      let e = this.$location ? `${c(this.$location.filename)}:${this.$location.line}` : `unknown`;
    ...
    _getCachedCompiledPatterns(e) {
      return (
        this._cachedCompiledPatterns ||
          ((this._cachedCompiledPatterns = new We()), this.collectPatterns(e, this._cachedCompiledPatterns)),
        this._cachedCompiledPatterns
      );
    }
  },
  ...
  Ve = class extends Ie {
    ...
    dispose() {
      ((this._cachedCompiledPatterns &&= (this._cachedCompiledPatterns.dispose(), null)),
        (this._cachedCompiledWhilePatterns &&= (this._cachedCompiledWhilePatterns.dispose(), null)));
    }
    get debugBeginRegExp() {
      return `${this._begin.source}`;
    }
    ...
    static getCompiledRuleId(t, n, r) {
      return (
        t.id ||
          n.registerRule((i) => {
            if (((t.id = i), t.match))
              return new Re(t.$vscodeTextmateLocation, t.id, t.name, t.match, e._compileCaptures(t.captures, n, r));
            if (t.begin === void 0) {
              t.repository && (r = s({}, r, t.repository));
              let i = t.patterns;
              return (
                i === void 0 && t.include && (i = [{ include: t.include }]),
                new ze(t.$vscodeTextmateLocation, t.id, t.name, t.contentName, e._compilePatterns(i, n, r))
              );
            }
            return t.while
              ? new Ve(
  ...
  Ue = class e {
    ...
    resolveBackReferences(e, t) {
      ...
      return ((je.lastIndex = 0), this.source.replace(je, (e, t) => m(n[parseInt(t, 10)] || ``)));
    }
    _buildAnchorCache() {
      if (typeof this.source != `string`) throw Error(`This method should only be called if the source is a string`);
      let e = [],
...
`);
  ...
  qe = class e {
    ...
    constructor(e, t) {
      ((this._defaultAttributes = new Ke(e, 8)), (this._embeddedLanguagesMatcher = new Je(Object.entries(t || {}))));
    }
    ...
    _getBasicScopeAttributes = new h((e) => new Ke(this._scopeToLanguage(e), this._toStandardTokenType(e)));
    _scopeToLanguage(e) {
...
function Ze(e, t, n, r, i, a, o, s) {
  ...
  function f() {
    ...
    if (d === Me) {
      ...
      if (((i = i.push(d, r, u, s[0].end === c, null, h, h)), o instanceof Be)) {
        let r = o;
        (at(e, t, n, i, a, r.beginCaptures, s), a.produce(i, s[0].end), (u = s[0].end));
        let d = r.getContentName(t.content, s),
          m = h.pushAttributed(d, e);
        if (
          ((i = i.withContentNameScopesList(m)),
          r.endHasBackReferences && (i = i.withEndRule(r.getEndWithResolvedBackReferences(t.content, s))),
          !f && p.hasSameRuleAs(i))
        ) {
        ...
        if (
          ((i = i.withContentNameScopesList(m)),
          r.whileHasBackReferences && (i = i.withEndRule(r.getWhileWithResolvedBackReferences(t.content, s))),
          !f && p.hasSameRuleAs(i))
        ) {
          ((i = i.pop()), a.produce(i, c), (l = !0));
          return;
        }
      } else if ((at(e, t, n, i, a, o.captures, s), a.produce(i, s[0].end), (i = i.pop()), !f)) {
...
function Qe(e, t, n, r, i, a) {
  ...
  for (let c = s.pop(); c; c = s.pop()) {
    let { ruleScanner: s, findOptions: l } = rt(c.rule, e, c.stack.endRule, n, r === o),
...
function et(e, t, n, r, i, a) {
  let { ruleScanner: o, findOptions: s } = nt(i.getRule(e), e, i.endRule, n, r === a),
...
function tt(e, t, n, r, i, a, o) {
  ...
  for (let a = 0, f = e.length; a < f; a++) {
    ...
    let { ruleScanner: p, findOptions: m } = nt(t.getRule(f.ruleId), t, null, r, i === o),
...
function lt(e, t) {
  ...
  let n = 0;
  return e.every((e) => {
    for (let r = n; r < t.length; r++) if (ut(t[r], e)) return ((n = r + 1), !0);
    return !1;
  });
}
function ut(e, t) {
...
var dt = class {
  ...
  getExternalGrammar(e, t) {
    ...
    if (this._grammarRepository) {
      ...
      if (n) return ((this._includedGrammars[e] = ft(n, t && t.$base)), this._includedGrammars[e]);
    }
  }
  ...
  _tokenize(e, t, n, r) {
    this._rootId === -1 &&
      ((this._rootId = He.getCompiledRuleId(this._grammar.repository.$self, this, this._grammar.repository)),
      this.getInjections());
    let i;
    if (!t || t === mt.NULL) {
      i = !0;
      let e = this._basicScopeAttributesProvider.getDefaultAttributes(),
        ...
        r = le.set(0, e.languageId, e.tokenType, null, n.fontStyle, n.foregroundId, n.backgroundId),
        a = this.getRule(this._rootId).getName(null, null),
        o;
      ((o = a ? pt.createRootAndLookUpScopeName(a, r, this) : pt.createRoot(`unknown`, r)),
...
`;
    ...
    return (he(a), { lineLength: o, lineTokens: s, ruleStack: c.stack, stoppedEarly: c.stoppedEarly });
  }
};
function ft(e, t) {
  return (
...
var pt = class e {
    ...
    static fromExtension(t, n) {
      let r = t,
        i = t?.scopePath ?? null;
      for (let t of n) ((i = _.push(i, t.scopeNames)), (r = new e(r, i, t.encodedTokenAttributes)));
      return r;
    }
  ...
  ht = class {
    ...
    constructor(e, t) {
      ((this.balancedBracketScopes = e.flatMap((e) =>
        e === `*` ? ((this.allowAny = !0), []) : fe(e, lt).map((e) => e.matcher),
      )),
        (this.unbalancedBracketScopes = t.flatMap((e) => fe(e, lt).map((e) => e.matcher))));
    }
    get matchesAlways() {
  ...
  gt = class {
    ...
    produceFromScopes(e, t) {
      ...
      if (this._emitBinaryTokens) {
        ...
        if (
          ...
          for (let e of this._tokenTypeOverrides) e.matcher(t) && (n = le.set(n, 0, ue(e.type), null, -1, 0, 0));
    ...
    getResult(e, t) {
      return (
        this._tokens.length > 0 && this._tokens[this._tokens.length - 1].startIndex === t - 1 && this._tokens.pop(),
        this._tokens.length === 0 &&
          ((this._lastTokenEndIndex = -1), this.produce(e, t), (this._tokens[this._tokens.length - 1].startIndex = 0)),
        this._tokens
      );
    }
    getBinaryResult(e, t) {
  ...
  vt = class {
    ...
    constructor(e) {
      ((this._options = e),
        (this._syncRegistry = new _t(g.createFromRawTheme(e.theme, e.colorMap), e.onigLib)),
    ...
    loadGrammarWithConfiguration(e, t, n) {
      return this._loadGrammar(
        ...
        n.embeddedLanguages,
        n.tokenTypes,
        new ht(n.balancedBracketSelectors || [], n.unbalancedBracketSelectors || []),
      );
    }
    loadGrammar(e) {
...
((xt.prototype.normal = {}), (xt.prototype.property = {}), (xt.prototype.space = void 0));
function St(e, t) {
  let n = {},
    r = {};
...
const Xt = /["&'<>`]/g,
  ...
  en = new WeakMap();
function tn(e, t) {
  if (((e = e.replace(t.subset ? nn(t.subset) : Xt, r)), t.subset || t.escapeOnly)) return e;
...
function gn(e, t, n, r) {
  ...
  if (fn.call(pn, i)) {
    let e = pn[i],
      a = `&` + e;
    return n && ln.includes(e) && !dn.includes(e) && (!r || (t && t !== 61 && hn.test(String.fromCharCode(t))))
      ? a
      : a + `;`;
  }
  return ``;
...
function _n(e, t, n) {
  let r = on(e, t, n.omitOptionalSemicolons),
    i;
  if (
    ((n.useNamedReferences || n.useShortestReferences) && (i = gn(e, t, n.omitOptionalSemicolons, n.attribute)),
...
function Sn(e, t, n, r) {
  return r.settings.bogusComments
    ? `<?` + vn(e.value, Object.assign({}, r.settings.characterReferences, { subset: bn })) + `>`
    : `<!--` + e.value.replace(yn, i) + `-->`;
  function i(e) {
    return vn(e, Object.assign({}, r.settings.characterReferences, { subset: xn }));
  }
}
function Cn(e, t, n, r) {
...
function In(e, t, n) {
  let r = D(n, t, !0);
  return !r || (r.type !== `comment` && !(r.type === `text` && On(r.value.charAt(0))));
}
function Ln(e, t, n) {
  let r = D(n, t);
...
function tr(e, t, n) {
  let r = An(n, t),
    i = D(e, -1, !0);
  return n && r && r.type === `element` && r.tagName === `colgroup` && Fn(r, n.children.indexOf(r), n)
    ? !1
...
function ir(e, t, n, r) {
  let i = r.schema,
    ...
    o = i.space === `svg` ? r.settings.closeEmptyElements : r.settings.voids.includes(e.tagName.toLowerCase()),
    s = [],
    c;
...
function or(e, t, n) {
  ...
  if (
    (r.overloadedBoolean && (n === r.attribute || n === ``)
      ? (n = !0)
      : (r.boolean || r.overloadedBoolean) && (typeof n != `string` || n === r.attribute || n === ``) && (n = !!n),
    n == null || n === !1 || (typeof n == `number` && Number.isNaN(n)))
  )
    return ``;
  let c = vn(r.attribute, Object.assign({}, e.settings.characterReferences, { subset: rr.name[i][a] }));
  return n === !0 ||
    ((n = Array.isArray(n)
      ? (r.commaSeparated ? Tn : En)(n, { padLeft: !e.settings.tightCommaSeparatedLists })
      : String(n)),
    e.settings.collapseEmptyAttributes && !n)
    ? c
    : (e.settings.preferUnquoted &&
        (s = vn(n, Object.assign({}, e.settings.characterReferences, { attribute: !0, subset: rr.unquoted[i][a] }))),
      s !== n &&
        (e.settings.quoteSmart && wn(n, o) > wn(n, e.alternative) && (o = e.alternative),
        (s =
          o +
          vn(
            n,
...
function cr(e, t, n, r) {
  return n && n.type === `element` && (n.tagName === `script` || n.tagName === `style`)
    ? e.value
    : vn(e.value, Object.assign({}, r.settings.characterReferences, { subset: sr }));
}
function lr(e, t, n, r) {
...
const dr = Yt(`type`, {
  invalid: fr,
  unknown: pr,
  handlers: { comment: Sn, doctype: Cn, element: ir, raw: lr, root: ur, text: cr },
});
function fr(e) {
...
function Mr(e, t) {
  let n = 0,
    r = [];
  for (let i of t) (i > n && r.push({ ...e, content: e.content.slice(n, i), offset: e.offset + n }), (n = i));
      ...
      for (let o of c) {
        ...
        if (r === 0 && i && jr.includes(o))
          if (i === Ar && s.length > 1) {
            ...
            if (e === -1 || i === -1)
              throw new n('When using `defaultColor: "light-dark()"`, you must provide both `light` and `dark` themes');
            ((l[o] = `light-dark(${s[e][o] || `inherit`}, ${s[i][o] || `inherit`})`),
...
function Fr(e) {
  ...
  if ((e.color && (t.color = e.color), e.bgColor && (t[`background-color`] = e.bgColor), e.fontStyle)) {
    (e.fontStyle & y.Italic && (t[`font-style`] = `italic`), e.fontStyle & y.Bold && (t[`font-weight`] = `bold`));
    let n = [];
      ...
      let r = function (e) {
          if (typeof e == `number`) {
            if (e < 0 || e > t.source.length)
              throw new n(`Invalid decoration offset: ${e}. Code length: ${t.source.length}`);
            return { ...i.indexToPos(e), offset: e };
          } else {
            let t = i.lines[e.line];
            if (t === void 0)
              throw new n(`Invalid decoration position ${JSON.stringify(e)}. Lines length: ${i.lines.length}`);
            let r = e.character;
            if ((r < 0 && (r = t.length + r), r < 0 || r > t.length))
              throw new n(`Invalid decoration position ${JSON.stringify(e)}. Line ${e.line} length: ${t.length}`);
            return { ...e, character: r, offset: i.posToIndex(e.line, r) };
          }
        },
        i = kr(t.source),
        a = (t.options.decorations || []).map((e) => ({ ...e, start: r(e.start), end: r(e.end) }));
      (Wr(a), e.set(t.meta, { decorations: a, converter: i, source: t.source }));
    }
    return e.get(t.meta);
  }
  return {
    ...
    code(e) {
      ...
      let r = t(this),
        i = Array.from(e.children).filter((e) => e.type === `element` && e.tagName === `span`);
      ...
      function a(e, t, r, a) {
        let o = i[e],
          ...
          l = -1,
          u = -1;
        if ((t === 0 && (l = 0), r === 0 && (u = 0), r === 1 / 0 && (u = o.children.length), l === -1 || u === -1))
          for (let e = 0; e < o.children.length; e++)
            ((c += Gr(o.children[e])),
              l === -1 && c.length === t && (l = e + 1),
              u === -1 && c.length === r && (u = e + 1));
        if (l === -1) throw new n(`Failed to find start index for decoration ${JSON.stringify(a.start)}`);
        if (u === -1) throw new n(`Failed to find end index for decoration ${JSON.stringify(a.end)}`);
      ...
      let c = [],
        l = r.decorations.sort((e, t) => t.start.offset - e.start.offset || e.end.offset - t.end.offset);
      for (let e of l) {
        let { start: t, end: n } = e;
...
function Wr(e) {
  for (let t = 0; t < e.length; t++) {
    ...
    if (r.start.offset > r.end.offset)
      throw new n(`Invalid decoration range: ${JSON.stringify(r.start)} - ${JSON.stringify(r.end)}`);
    for (let i = t + 1; i < e.length; i++) {
      ...
      if (a || o || s || c) {
        if ((a && o) || (s && c) || (s && r.start.offset === r.end.offset) || (o && t.start.offset === t.end.offset))
          continue;
        throw new n(`Decorations ${JSON.stringify(r.start)} and ${JSON.stringify(t.start)} intersect.`);
      }
    }
  }
}
function Gr(e) {
  return e.type === `text` ? e.value : e.type === `element` ? e.children.map(Gr).join(``) : ``;
}
const Kr = [Ur()];
function qr(e) {
...
var k = [
  ...
  Yr = { 1: `bold`, 2: `dim`, 3: `italic`, 4: `underline`, 7: `reverse`, 8: `hidden`, 9: `strikethrough` };
function Xr(e, t) {
  let n = e.indexOf(`\x1B`, t);
  if (n !== -1 && e[n + 1] === `[`) {
    let t = e.indexOf(`m`, n);
    if (t !== -1) return { sequence: e.substring(n + 2, t).split(`;`), startPosition: n, position: t + 1 };
  }
...
function Qr(e) {
  ...
  for (; e.length > 0; ) {
    ...
    if (!Number.isNaN(r))
      ...
      } else if (r <= 37) t.push({ type: `setForegroundColor`, value: { type: `named`, name: k[r - 30] } });
      else if (r === 38) {
        let n = Zr(e);
        n && t.push({ type: `setForegroundColor`, value: n });
      } else if (r === 39) t.push({ type: `resetForegroundColor` });
      else if (r <= 47) t.push({ type: `setBackgroundColor`, value: { type: `named`, name: k[r - 40] } });
      else if (r === 48) {
        let n = Zr(e);
        ...
        r === 49
          ...
          : r === 53
            ...
            : r === 55
              ...
              : r >= 90 && r <= 97
                ? t.push({ type: `setForegroundColor`, value: { type: `named`, name: k[r - 90 + 8] } })
                : r >= 100 &&
                  r <= 107 &&
                  t.push({ type: `setBackgroundColor`, value: { type: `named`, name: k[r - 100 + 8] } });
  }
  return t;
}
function $r() {
  ...
  return {
    parse(r) {
      ...
      do {
        ...
        if ((s.length > 0 && i.push({ value: s, foreground: e, background: t, decorations: new Set(n) }), o.sequence)) {
          let r = Qr(o.sequence);
          for (let i of r)
            i.type === `resetAll`
...
function ti(e = ei) {
  ...
  function i() {
    ...
    for (let t = 0; t < 6; t++) for (let i = 0; i < 6; i++) for (let a = 0; a < 6; a++) r.push(n([e[t], e[i], e[a]]));
    let i = 8;
  ...
  return i.map((t) =>
    o.parse(t[0]).map((n) => {
      ...
      (n.decorations.has(`reverse`)
        ? ((i = n.background ? a.value(n.background) : e.bg), (o = n.foreground ? a.value(n.foreground) : e.fg))
        : ((i = n.foreground ? a.value(n.foreground) : e.fg), (o = n.background ? a.value(n.background) : void 0)),
        (i = O(i, r)),
        (o = O(o, r)),
...
function ai(e, t, r = {}) {
  ...
  if (Cr(a) || Tr(i)) return Or(t).map((e) => [{ content: e[0], offset: e[1] }]);
  let { theme: o, colorMap: s } = e.setTheme(i);
  if (a === `ansi`) return ri(o, t, r);
  let c = e.getLanguage(r.lang || `text`);
  if (r.grammarState) {
    if (r.grammarState.lang !== c.name)
      throw new n(`Grammar state language "${r.grammarState.lang}" does not match highlight language "${c.name}"`);
    if (!r.grammarState.themes.includes(o.name))
      throw new n(`Grammar state themes "${r.grammarState.themes}" do not contain highlight theme "${o.name}"`);
  }
  return si(t, c, o, s, r);
}
function oi(...e) {
  ...
  let a = br(n, i),
    ...
    l = i.grammarState
      ...
      : i.grammarContextCode == null
        ? yt
        : ci(i.grammarContextCode, t, n, r, { ...i, grammarState: void 0, grammarContextCode: void 0 }).stateStack,
    u = [],
    d = [];
      ...
      if (i.includeExplanation) {
        ...
        for (; t + r < o; ) {
          ...
          ((r += n.length),
            d.explanation.push({
              content: n,
              scopes: i.includeExplanation === `scopeName` ? li(t.scopes) : ui(e, t.scopes),
            }),
            (g += 1));
        }
      }
...
function mi(e, t, n) {
  let r = Object.entries(n.themes)
    ...
    i = r.map((r) => {
      ...
      return { tokens: i, state: zr(i), theme: typeof r.theme == `string` ? r.theme : r.theme.name };
    }),
    ...
    s = i[0].state
      ? new Br(Object.fromEntries(i.map((e) => [e.theme, e.state?.getInternalStack(e.theme)])), i[0].state.lang)
      : void 0;
  return (s && Rr(o, s), o);
}
function hi(...e) {
...
function gi(e, t, r) {
  ...
  if (`themes` in r) {
    ...
    if (((l = zr(m)), u && Ar !== u && !p.find((e) => e.color === u)))
      throw new n(`\`themes\` option must contain the defaultColor key \`${u}\``);
  ...
  return { tokens: o, fg: a, bg: i, themeName: s, rootStyle: c, grammarState: l };
}
...
function vi(
  ...
  t,
  n,
  r = { meta: {}, options: n, codeToHast: (t, n) => vi(e, t, n), codeToTokens: (t, n) => gi(e, t, n) },
) {
  let i = t;
  for (let e of qr(n)) i = e.preprocess?.call(r, i, n) || i;
  let { tokens: a, fg: o, bg: s, themeName: c, rootStyle: l, grammarState: u } = gi(e, i, n),
  ...
  return yi(a, { ...n, fg: o, bg: s, themeName: c, rootStyle: n.rootStyle === !1 ? !1 : (n.rootStyle ?? l) }, p, u);
}
function yi(e, t, n, r = zr(e)) {
  ...
  (t.rootStyle !== !1 &&
    (t.rootStyle == null ? (l.style = `background-color:${t.bg};color:${t.fg}`) : (l.style = t.rootStyle)),
    c !== !1 && c != null && (l.tabindex = c.toString()));
  for (let [e, n] of Object.entries(t.meta || {})) e.startsWith(`_`) || (l[e] = n);
  let u = { type: `element`, tagName: `pre`, properties: l, children: [], data: t.data },
...
`,
    ...
    for (let n of o.children)
      n.type === `element` && n.tagName === `br`
        ? (e.push(t), (t = { type: `element`, tagName: `span`, properties: { class: `line` }, children: [] }))
...
function bi(e) {
  return e.map((e) => {
    ...
    return (
      e.forEach((i, a) => {
        let o = !(i.fontStyle && (i.fontStyle & y.Underline || i.fontStyle & y.Strikethrough));
  ...
  return e.map((e) => {
    ...
    for (let n of e) {
      ...
      let e = t[t.length - 1],
        ...
        a = e.fontStyle && (e.fontStyle & y.Underline || e.fontStyle & y.Strikethrough),
        o = n.fontStyle && (n.fontStyle & y.Underline || n.fontStyle & y.Strikethrough);
...
const Ci = _r;
function wi(e, t, n) {
  let r = { meta: {}, options: n, codeToHast: (t, n) => vi(e, t, n), codeToTokens: (t, n) => gi(e, t, n) },
    i = Ci(vi(e, t, n, r));
...
function Oi(e) {
  ...
  return (Object.defineProperty(t, Di, { enumerable: !1, writable: !1, value: !0 }), t);
}
async function ki(e) {
  return Array.from(
    new Set(
      (
        await Promise.all(
          e.filter((e) => !wr(e)).map(async (e) => await Sr(e).then((e) => (Array.isArray(e) ? e : [e]))),
        )
      ).flat(),
    ),
  );
...
async function Ai(e) {
  return (await Promise.all(e.map(async (e) => (Er(e) ? null : Oi(await Sr(e)))))).filter((e) => !!e);
}
function ji(e, t = 3) {
...
function Ni(e, t) {
  ...
  if (t[e]) {
    let n = new Set([e]);
    for (; t[e]; ) {
      if (((e = t[e]), n.has(e))) throw new Mi(`Circular alias \`${Array.from(n).join(` -> `)} -> ${e}\``);
      n.add(e);
    }
  }
  return e;
...
var Pi = class extends vt {
    ...
    loadLanguages(e) {
      ...
      if (n.length) {
        let e = t
          .filter(([e, t]) =>
            t ? (t.embeddedLanguages || t.embeddedLangs)?.some((e) => n.map(([e]) => e).includes(e)) : !1,
          )
  ...
  Fi = class {
    ...
    _onigLib;
    constructor(e, t) {
      ((this._onigLib = { createOnigScanner: (t) => e.createScanner(t), createOnigString: (t) => e.createString(t) }),
...
function Li(e) {
  ...
  let t = !1;
  if (!e.engine) throw new Mi("`engine` option is required for synchronous mode");
  ...
  function s(e) {
    ...
    if (!t) throw new Mi(`Language \`${e}\` not found, you may need to load it first`);
    return t;
  }
  function c(e) {
    ...
    g();
    let t = i.getTheme(e);
    if (!t) throw new Mi(`Theme \`${e}\` not found, you may need to load it first`);
    return t;
  }
  function l(e) {
    g();
...
async function Ri(e) {
  ...
  let [t, n, r] = await Promise.all([Ai(e.themes || []), ki(e.langs || []), e.engine]);
...
function Yi(e, t = {}) {
  ...
  let u = l || c.length;
  return { tokens: o.map((e) => (e.type === `EscapedNumber` ? Ta(e, u) : e)).flat(), flags: r };
}
function Xi(e, t, n, r) {
  let [i, a] = n;
  if (n === `[` || n === `[^`) {
  ...
  if (i === `(`) {
    ...
    if ((e.pushModX(e.getCurrentModX()), e.numOpenGroups++, (n === `(` && !e.captureGroup) || n === `(?:`))
      return { token: ua(`group`, n) };
    if (n === `(?>`) return { token: ua(`atomic`, n) };
    if (n === `(?=` || n === `(?!` || n === `(?<=` || n === `(?<!`)
      return { token: ua(n[2] === `<` ? `lookbehind` : `lookahead`, n, { negate: n.endsWith(`!`) }) };
    if (
      (n === `(` && e.captureGroup) ||
      (n.startsWith(`(?<`) && n.endsWith(`>`)) ||
      (n.startsWith(`(?'`) && n.endsWith(`'`))
    )
      return { token: ua(`capturing`, n, { ...(n !== `(` && { name: n.slice(3, -1) }) }) };
    if (n.startsWith(`(?~`)) {
...
function $i(e, { inCharClass: t }) {
  ...
  if (e.startsWith(A`\o{`)) throw Error(`Incomplete, invalid, or unsupported octal code point "${e}"`);
  if (/^\\[pP]\{/.test(e)) {
...
const ma = new Set([`COUNT`, `CMP`, `ERROR`, `FAIL`, `MAX`, `MISMATCH`, `SKIP`, `TOTAL_COUNT`]),
  ha = new Map([
    [`a`, 7],
    [`b`, 8],
    [`e`, 27],
...
function _a(e, t) {
  ...
  if (e.endsWith(`:`)) return (t.pushModX(i), t.numOpenGroups++, ua(`group`, e, { ...((a || o) && { flags: s }) }));
  ...
  switch (l) {
    ...
    case `cmp`:
      ...
      if (typeof s == `number` || !/^(?:[<>!=]=|[<>])$/.test(s))
        throw Error(`Named callout argument two must be '==', '!=', '>', '<', '>=', or '<=' "${s}"`);
...
function ba(e) {
  ...
  return M({ d: `digit`, h: `hex`, s: `space`, w: `word` }[t], e, { negate: e[1] !== t });
}
function xa(e) {
  let { p: t, neg: n, value: r } = /^\\(?<p>[pP])\{(?<neg>\^?)(?<value>[^}]+)/.exec(e).groups;
  return M(`property`, e, { value: r, negate: (t === `P` && !n) || (t === `p` && !!n) });
}
function Sa(e) {
  let t = {};
  return (
...
function Ta(e, t) {
  let { raw: n, inCharClass: r } = e,
    i = n.slice(1);
  if (!r && ((i !== `0` && i.length === 1) || (i[0] !== `0` && +i <= t))) return [na(n)];
  let a = [],
    o = i.match(/^[0-7]+|\d/g);
  for (let e = 0; e < o.length; e++) {
    let t = o[e],
      r;
    if (e === 0 && t !== `8` && t !== `9`) {
      if (((r = parseInt(t, 8)), r > 127)) throw Error(A`Octal encoded byte above 177 unsupported "${n}"`);
    } else r = Bi(t);
    a.push(j(r, (e === 0 ? `\\` : ``) + t));
  }
  return a;
...
function Aa(e, t = {}) {
  let n = {
    ...
    r = Yi(e, { flags: n.flags, rules: { captureGroup: n.rules.captureGroup, singleline: n.rules.singleline } }),
    i = (e, t) => {
  ...
  for (let { ref: e } of d)
    if (typeof e == `number`) {
      ...
      if (u.get(e).length > 1) throw Error(A`Subroutine uses a duplicate group name "\g<${e}>"`);
      u.get(e)[0].isSubroutined = !0;
    } else throw Error(A`Subroutine uses a group name that's not defined "\g<${e}>"`);
  return o;
}
function ja({ kind: e }) {
  return Ba(
...
function Na(e, t, n) {
  ...
  if (
    ...
    if (o.type === `Character` && e.type === `Character`) return (a.body.pop(), Ga(o, e));
...
function Ia(e, t, n) {
  let { tokens: r, capturingGroups: i, namedGroupsByName: a, skipLookbehindValidation: o, walk: s } = t,
    c = to(e),
    l = c.type === `AbsenceFunction`,
    u = ao(c),
    d = u && c.negate;
  if ((c.type === `CapturingGroup` && (i.push(c), c.name && Vi(a, c.name, []).push(c)), l && n.isInAbsenceFunction))
...
function Ra({ raw: e }, t) {
  ...
  if (a) {
    let e = +a.groups.num,
      r = n.length;
    if (((t.hasNumberedRef = !0), (i = { "": e, "+": r + e, "-": r + 1 - e }[a.groups.sign]), i < 1))
...
function Ha(e, t) {
  ...
  if (n.name !== void 0 && !oo(n.name)) throw Error(`Group name "${n.name}" invalid in Oniguruma`);
  return {
    type: `CapturingGroup`,
    number: e,
    ...(n.name && { name: n.name }),
...
function Wa(e) {
  ...
  return { type: `CharacterClass`, kind: t.kind, negate: t.negate, body: ro(e?.body) };
}
function Ga(e, t) {
...
function Ka(e, t) {
  ...
  return (
    (e === `digit` || e === `hex` || e === `newline` || e === `space` || e === `word`) && (r.negate = n),
...
function P(e) {
  ...
  return { type: `Group`, ...(t && { atomic: t }), ...(n && { flags: n }), body: no(e?.body) };
}
function F(e) {
...
function eo(e, t) {
  ...
  if (!r) {
    ...
    else if (n.unicodePropertyMap && !n.skipPropertyNameValidation) throw Error(A`Invalid Unicode property "\p{${e}}"`);
  }
...
function lo(e, t) {
  return Ui(e, `${t?.type === `Character` && t.value === 93 ? `Empty` : `Unclosed`} character class`);
}
function uo(e) {
  ...
  function i(a, o = null, s = null, c = null) {
    let l = 0,
      ...
      d = {
        ...
        replaceWith(e, t = {}) {
          let n = !!t.traverse;
          (c ? (c[Math.max(0, mo(s) + l)] = e) : (Ui(o, `Can't replace root node`)[s] = e),
            n && i(e, o, s, c),
            (u = !0));
        },
        replaceWithMultiple(e, t = {}) {
          let n = !!t.traverse;
          if ((po(c).splice(Math.max(0, mo(s) + l), 1, ...e), (l += e.length - 1), n)) {
            let t = 0;
            for (let n = 0; n < e.length; n++) t += i(e[n], o, mo(s) + n + t, c);
          }
          u = !0;
        },
        skip() {
...
const Co = new RegExp(String.raw`(?<noncapturingStart>${ho})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`, `gsu`);
function wo(e, t) {
...
function Mo(e, t) {
  ...
  if (!new RegExp(Oo, `su`).test(e)) return { pattern: e, captureTransfers: i, hiddenCaptures: n };
  if (r === `plugin` && xo(e, L`\(\?\(DEFINE\)`, I.DEFAULT)) throw Error(`DEFINE groups cannot be used with recursion`);
  let a = [],
  ...
  for (R.lastIndex = 0; (f = R.exec(e)); ) {
    ...
    if (t === `[`) u++;
      ...
      ((i = Lo(i, _, te, a.length - ee, ee, d)),
        ...
        (l = !0));
    } else if (p) (d++, s.set(String(d), R.lastIndex), s.set(p, R.lastIndex), c.push({ num: d, name: p }));
    else if (t[0] === `(`) {
      let e = t === `(`;
...
((V.bugFlagVLiteralHyphenIsRange = V.unicodeSets
  ...
  : !1),
  (V.bugNestedClassIgnoresNegation = V.unicodeSets && RegExp(`[[^a]]`, `v`).test(`a`)));
...
function Wo(e = {}) {
  ...
  if (e.target !== void 0 && !Uo[e.target]) throw Error(`Unexpected target "${e.target}"`);
  let t = {
    accuracy: `default`,
    avoidSubclass: !1,
    flags: ``,
...
function ns(e, t) {
  let n = { accuracy: `default`, asciiWordBoundaries: !1, avoidSubclass: !1, bestEffortTarget: `ES2025`, ...t };
  os(e);
  let r = {
    accuracy: n.accuracy,
...
var rs = {
    AbsenceFunction({ node: e, parent: t, replaceWith: n }) {
      ...
      if (i === `repeater`) {
        ...
        let i = P();
        (i.body[0].body.push(Za(`greedy`, 0, 1 / 0, e)), n(K(i, t), { traverse: !0 }));
    ...
    Assertion({ node: e, parent: t, key: n, container: r, root: i, remove: a, replaceWith: o }, s) {
      ...
      if (c === `line_end`) o(K(F({ body: [N({ body: [Ba(`string_end`)] }), N({ body: [Ua(10)] })] }), t));
    ...
    CapturingGroup({ node: e }, { jsGroupNameMap: t, subroutineRefMap: n }) {
      let { name: r } = e;
      (r && !xs(r) && ((r = fs(r, t)), (e.name = r)), n.set(e.number, e), r && n.set(r, e));
    },
...
\v\f\u2028\u2029])`,
    ...
    Directive({
      ...
      if (s === `flags`)
        ...
        let e = n.body[0],
          r = n.body.length === 1 && Da(e, { type: `Group` }) && e.body[0].body.length === 1 ? e.body[0] : n;
    ...
    Flags({ node: e, parent: t }) {
      ...
      ([`digitIsAscii`, `extended`, `posixIsAscii`, `spaceIsAscii`, `wordIsAscii`, `textSegmentMode`].forEach(
        (t) => delete e[t],
      ),
  ...
  is = {
    ...
    CapturingGroup: {
      enter(
        ...
        if (
          (o.get(e.number).push({ node: e, origin: l }), e.name && o.get(e.name).push({ node: e, origin: l }), e.name)
        ) {
    ...
    Group: {
      enter({ node: e }, t) {
        ((t.prevFlags = t.currentFlags), e.flags && (t.currentFlags = Ro(t.currentFlags, e.flags)));
      },
      exit(e, t) {
    ...
    Subroutine({ node: e, parent: t, replaceWith: n }, r) {
      ...
      if (!s) {
        ...
        ss(t, r.currentFlags) || ((l = P({ flags: ms(t) })), l.body[0].body.push(c));
      }
      n(K(l, t), { traverse: !s });
    },
  },
  as = {
    Backreference({ node: e, parent: t, replaceWith: n }, r) {
      ...
      i.length
        ? i.length > 1
          ? n(K(P({ atomic: !0, body: i.reverse().map((e) => N({ body: [Va(e.number)] })) }), t))
          : (e.ref = i[0].number)
        : n(K(F({ negate: !0 }), t));
    },
...
function ms({ dotAll: e, ignoreCase: t }) {
  ...
  return (
    ...
    (!e || !t) && ((n.disable = {}), !e && (n.disable.dotAll = !0), !t && (n.disable.ignoreCase = !0)),
    n
  );
}
function hs(e) {
...
function gs(e) {
  let t = e.find((e) => e.kind === `search_start` || bs(e, { negate: !1 }) || !vs(e));
  if (!t) return null;
...
function Cs(e, t) {
  ...
  function d(e) {
    return ((u.lastNode = l), (l = e), Vo(Ts[e.type], `Unexpected node type "${e.type}"`)(e, u, d));
  }
  let f = { pattern: e.body.map(d).join(`|`), flags: d(e.flags), options: { ...e.options } };
  return (
    r || (delete f.options.force.v, (f.options.disable.v = !0), (f.options.unicodeSetsPlugin = null)),
...
var ws = {
  ...
  Ts = {
    ...
    Character({ value: e }, t) {
      let n = z(e),
        r = Ns(e, { escDigit: t.lastNode.type === `Backreference`, inCharClass: t.inCharClass, useFlagV: t.useFlagV });
      if (r !== n) return r;
    ...
    CharacterClass(e, t, n) {
      ...
      V.bugFlagVLiteralHyphenIsRange && t.useFlagV && o.some(zs) && (o = [Ua(45), ...o.filter((e) => !zs(e))]);
      ...
      if (
        ...
        !i &&
        c &&
        (((!t.useFlagV || !t.verbose) && a.kind === `union` && !(V.bugFlagVLiteralHyphenIsRange && t.useFlagV)) ||
          (!t.verbose && a.kind === `intersection` && o.length === 1 && c.type !== `CharacterClassRange`))
      )
        return o.map(n).join(``);
    ...
    CharacterClassRange(e, t) {
      ...
      return (
        t.useAppliedIgnoreCase &&
          ...
          Ps(Ms(e)).forEach((e) => {
            s.add(Array.isArray(e) ? `${Ns(e[0], i)}-${Ns(e[1], i)}` : Ns(e, i));
          }),
        `${a}-${o}${[...s].join(``)}`
      );
    },
    CharacterSet({ kind: e, negate: t, value: n, key: r }, i) {
      if (e === `dot`)
        return i.currentFlags.dotAll ? (i.appliedGlobalFlags.dotAll || i.useFlagMods ? `.` : `[^]`) : B`[^\n]`;
      if (e === `digit`) return t ? B`\D` : B`\d`;
      if (e === `property`) {
        if (i.useAppliedIgnoreCase && i.currentFlags.ignoreCase && ts.has(n))
          throw Error(`Unicode property "${n}" can't be case-insensitive when other chars have specific case`);
...
function Ps(e) {
  ...
  for (let e = 0; e < t.length; e++)
    t[e + 1] === t[e] + 1 ? (r ??= t[e]) : r === null ? n.push(t[e]) : (n.push([r, t[e]]), (r = null));
  return n;
}
function Fs(e, t, n) {
  if (e) return `>`;
...
var Bs = class e extends RegExp {
  ...
  constructor(t, n, r) {
    ...
    if (t instanceof RegExp) {
      ...
      (super(i, n),
        (this.#n = i.source),
        i instanceof e && ((this.#e = i.#e), (this.#r = i.#r), (this.#i = i.#i), (this.rawOptions = i.rawOptions)));
    } else {
  ...
  #a(e) {
    ...
    for (let e = 1; e < n.length; e++) {
      ...
      if (
        (a ? i.push(null) : (i.push(t.length), t.push(n[e]), this.hasIndices && t.indices.push(r[e])),
        o && n[e] !== void 0)
      ) {
        let a = i[o];
...
function Ws(e, t) {
  let n = Gs(e, t);
  return n.options ? new Bs(n.pattern, n.flags, n.options) : new RegExp(n.pattern, n.flags);
}
function Gs(e, t) {
  let n = Wo(t),
    r = ns(
    ...
    i = Cs(r, n),
    a = Mo(i.pattern, { captureTransfers: i._captureTransfers, hiddenCaptures: i._hiddenCaptures, mode: `external` }),
    o = wo(Do(a.pattern).pattern, { captureTransfers: a.captureTransfers, hiddenCaptures: a.hiddenCaptures }),
    s = {
      pattern: o.pattern,
    ...
    function a(e, t, n = 0) {
      return {
        ...
        captureIndices: t.indices.map((e) =>
          e == null ? { start: Ks, end: Ks, length: 0 } : { start: e[0] + n, end: e[1] + n, length: e[1] - e[0] },
        ),
      };
    }
...
async function ec(e) {
  ...
  function s(e) {
    ...
    for (let r = 1; r <= 4; r *= 2) {
      let i = t * (1 + 0.2 / r);
      if (((i = Math.min(i, e + 100663296)), o(Math.min(n, $s(Math.max(e, i), 65536))))) return !0;
    }
    return !1;
  }
  ...
  function l(e, t, n = 1024) {
    ...
    for (; t < i; ) {
      ...
      if (
        ((n =
          (n & 240) == 224 ? ((n & 15) << 12) | (r << 6) | i : ((n & 7) << 18) | (r << 12) | (i << 6) | (e[t++] & 63)),
        n < 65536)
      )
        a += String.fromCharCode(n);
      else {
  ...
  let d = { emscripten_get_now: Qs, emscripten_memcpy_big: a, emscripten_resize_heap: s, fd_write: () => 0 };
  async function f() {
...
var tc = Object.defineProperty,
  nc = (e, t, n) => (t in e ? tc(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n)),
...
var sc = class {
  constructor(e) {
    if ((q(this, `_onigBinding`), q(this, `_ptr`), !J)) throw new Xs(`Must invoke loadWasm first.`);
    let t = [],
      n = [];
    ...
    (J.ofree(i), J.ofree(r), a === 0 && rc(J), (this._onigBinding = J), (this._ptr = a));
  }
  dispose() {
      ...
      return (
        ...
        cc(n)
          ...
          : lc(n)
            ...
            : (uc(n) && (n = n.data),
              dc(n)
                ? (n = typeof WebAssembly.instantiateStreaming == `function` ? await gc(n)(t) : await _c(n)(t))
                : fc(n) || n instanceof WebAssembly.Module
                  ? (n = await hc(n)(t))
                  : `default` in n && n.default instanceof WebAssembly.Module && (n = await hc(n.default)(t))),
...
var Y = class {
    ...
    let p = -1 / 0,
      ...
      h = () => {
        for (let r = Math.max(p, -s); r <= Math.min(m, s); r += 2) {
          ...
          if (
            ((s = !h || (u && c.oldPos < l.oldPos) ? this.addToPath(l, !0, !1, 0, n) : this.addToPath(c, !1, !0, 1, n)),
  ...
  addToPath(e, t, n, r, i) {
    ...
    return a && !i.oneChangePerToken && a.added === t && a.removed === n
      ...
      : { oldPos: e.oldPos + r, lastComponent: { count: 1, added: t, removed: n, previousComponent: a } };
  }
  extractCommon(e, t, n, r, i) {
    ...
    return (
      l &&
        !i.oneChangePerToken &&
        (e.lastComponent = { count: l, previousComponent: e.lastComponent, added: !1, removed: !1 }),
      (e.oldPos = s),
      c
    );
  }
...
const yc = new (class extends Y {})();
function bc(e, t, n) {
  return yc.diff(e, t, n);
}
function xc(e, t) {
  let n;
...
const Ac = `a-zA-Z0-9_\\u{AD}\\u{C0}-\\u{D6}\\u{D8}-\\u{F6}\\u{F8}-\\u{2C6}\\u{2C8}-\\u{2D7}\\u{2DE}-\\u{2FF}\\u{1E00}-\\u{1EFF}`,
  jc = RegExp(`[${Ac}]+|\\s+|[^${Ac}]`, `ug`);
new (class extends Y {
  equals(e, t, n) {
  ...
  postProcess(e, t) {
    ...
    return (
      e.forEach((e) => {
        e.added ? (r = e) : e.removed ? (i = e) : ((r || i) && Mc(n, i, r, e), (n = e), (r = null), (i = null));
      }),
      (r || i) && Mc(n, i, r, null),
      e
    );
...
function Mc(e, t, n, r) {
  if (t && n) {
    ...
    if (e) {
      let r = xc(i, o);
      ((e.value = wc(e.value, o, r)), (t.value = Tc(t.value, r)), (n.value = Tc(n.value, r)));
    }
    if (r) {
      let e = Sc(a, s);
      ((r.value = Cc(r.value, s, e)), (t.value = Ec(t.value, e)), (n.value = Ec(n.value, e)));
    }
  } else if (n) {
    if (e) {
      let e = X(n.value);
    ...
    let n = X(r.value),
      ...
      a = kc(t.value),
      o = xc(n, i);
    t.value = Tc(t.value, o);
    let s = Sc(Tc(n, o), a);
    ((t.value = Ec(t.value, s)),
      (r.value = Cc(r.value, n, s)),
      (e.value = wc(e.value, n, n.slice(0, n.length - s.length))));
  } else if (r) {
    let e = X(r.value),
      n = Dc(kc(t.value), e);
    t.value = Ec(t.value, n);
  } else if (e) {
    let n = Dc(kc(e.value), X(t.value));
    t.value = Tc(t.value, n);
  }
}
const Nc = new (class extends Y {
  tokenize(e) {
    let t = RegExp(`(\\r?\\n)|[${Ac}]+|[^\\S\\n\\r]+|[^${Ac}]`, `ug`);
    return e.match(t) || [];
  }
...
new (class extends Y {
  constructor() {
    (super(...arguments), (this.tokenize = Fc));
  }
  equals(e, t, n) {
    return (
      n.ignoreWhitespace
...
(new (class extends Y {
  ...
  new (class extends Y {
    ...
    castInput(e, t) {
      ...
      return typeof e == `string` ? e : JSON.stringify(Lc(e, null, null, r), null, `  `);
    }
    equals(e, t, n) {
...
function Lc(e, t, n, r, i) {
  ...
  if (Object.prototype.toString.call(e) === `[object Array]`) {
    for (t.push(e), o = Array(e.length), n.push(o), a = 0; a < e.length; a += 1) o[a] = Lc(e[a], t, n, r, String(a));
  ...
  if ((e && e.toJSON && (e = e.toJSON()), typeof e == `object` && e)) {
    ...
    for (i.sort(), a = 0; a < i.length; a += 1) ((s = i[a]), (o[s] = Lc(e[s], t, n, r, s)));
    (t.pop(), n.pop());
  } else o = e;
  return o;
}
...
function Rc(e = {}) {
  ...
  function o(e) {
    let o = t + zc(typeof e == `string` ? e : a(e)) + n;
...
const Bc = /(?<=\n)/,
  Vc = { dark: `pierre-dark`, light: `pierre-light` };
...
function Wc(e, t) {
  ...
  for (let n of e) {
    if (Uc.has(n.name)) continue;
    let e = Hc.get(n.name);
    (e ?? ((e = n), Hc.set(n.name, e)), Uc.add(e.name), t.loadLanguageSync(e.data));
  }
}
const Gc = new Map(),
  Kc = new Set();
function qc(e, t) {
  ...
  for (let n of e) {
    let e;
    if (typeof n == `string`) {
      if (((e = Gc.get(n)), e == null))
        throw Error(`loadResolvedThemes: ${n} is not resolved, you must resolve it before calling loadResolvedThemes`);
    } else ((e = n), (n = n.name), Gc.has(n) || Gc.set(n, e));
    Kc.has(n) || (Kc.add(n), t.loadThemeSync(e));
  }
}
const Z = new Map();
let Jc = 0;
...
function Xc(e) {
  ...
  if (Yc[e] != null) return Yc[e];
  let t = e.match(/\.([^/\\]+\.[^/\\]+)$/);
  if (t != null) {
    if (Z.has(t[1])) return Z.get(t[1]) ?? `text`;
    if (Yc[t[1]] != null) return Yc[t[1]] ?? `text`;
  }
  let n = e.match(/\.([^.]+)$/)?.[1] ?? ``;
  return Z.has(n) ? (Z.get(n) ?? `text`) : (Yc[n] ?? `text`);
}
function Zc(e, t) {
  if (e <= Jc) return !1;
  Z.clear();
...
function el({ tagName: e, children: t = [], properties: n = {} }) {
...
const rl = Symbol(`no-token`),
  il = Symbol(`multiple-tokens`);
function al(e) {
  let t = ol(e);
  if (t != null) return t;
  let n = rl,
    ...
    o = () => {
      ...
      for (let e of i) sl(e);
      (r.push(el({ tagName: `span`, properties: { "data-char": a }, children: i })), (i = []), (a = void 0));
    },
    s = (e) => {
      if (e !== rl) {
        if (e === il) {
...
function ll(e = !1, t = !1) {
    ...
    r = [
      {
        ...
        pre(t) {
          ...
          if (r != null) {
            let t = 1;
            for (let a of r.children) a.type === `element` && (e && al(a), i.push(nl(a, t, n)), t++);
            r.children = i;
          }
          return t;
        },
  ...
  return (t && r.push(dl, ul), { state: n, transformers: r, toClass: ul });
}
const ul = Rc({ classPrefix: `hl-` }),
  dl = {
...
function fl({ theme: e = Vc, highlighter: t, prefix: n }) {
  let r = ``;
  if (typeof e == `string`) {
    let i = t.getTheme(e);
    ((r += `color:${i.fg};`),
    ...
    ((r += `${Q(`global`)}dark:${n.fg};`),
      (r += `${Q(`global`)}dark-bg:${n.bg};`),
      (r += pl(n, `dark`)),
      (n = t.getTheme(e.light)),
      (r += `${Q(`global`)}light:${n.fg};`),
      (r += `${Q(`global`)}light-bg:${n.bg};`),
      (r += pl(n, `light`)));
  }
  return r;
}
...
function hl({ isPartial: e, rangeSize: t, expandedHunks: n, hunkIndex: r, collapsedContextThreshold: i }) {
  let a = Math.max(t, 0);
  if (a === 0 || e) return { fromStart: 0, fromEnd: 0, rangeSize: a, collapsedLines: a, renderAll: !1 };
  if (n === !0 || a <= i) return { fromStart: a, fromEnd: 0, rangeSize: a, collapsedLines: 0, renderAll: !0 };
  let o = n?.get(r),
    s = Math.min(Math.max(o?.fromStart ?? 0, 0), a),
    c = Math.min(Math.max(o?.fromEnd ?? 0, 0), a),
    l = s + c,
    u = l >= a;
  return { fromStart: u ? a : s, fromEnd: u ? 0 : c, rangeSize: a, collapsedLines: Math.max(a - l, 0), renderAll: u };
}
function gl({
  diff: e,
  diffStyle: t,
  ...
  let s = _l({ diff: e, diffStyle: t, startingLine: n, expandedHunks: i, collapsedContextThreshold: a }),
    c = {
  ...
  hunkIterator: for (let n = s.hunkIndex; n < e.hunks.length; n++) {
    ...
    let o = hl({
      ...
      s = (() => {
        ...
        if (t !== n)
          throw Error(`iterateOverDiff: trailing context mismatch (additions=${t}, deletions=${n}) for ${e.name}`);
        let o = Math.min(t, n);
        return hl({
          isPartial: e.isPartial,
          rangeSize: o,
    ...
    if (c.shouldSkip(l, l)) (c.incrementCounts(l, l), d());
    else {
      let e = r.unifiedLineStart - o.rangeSize,
        ...
        [f, p] = yl(c, o.fromStart, t);
      f > 0 && c.incrementCounts(f, f);
      let m = f;
      for (; m < o.fromStart; ) {
        if (m >= p) {
          c.incrementCounts(o.fromStart - m, o.fromStart - m);
          break;
        }
        if (c.isInWindow(0, 0)) {
          if (
      ...
      let [h, g] = yl(c, o.fromEnd, t);
      for (h > 0 && c.incrementCounts(h, h), m = h; m < o.fromEnd; ) {
        if (m >= g) {
          c.incrementCounts(o.fromEnd - m, o.fromEnd - m);
          break;
        }
        if (c.isInWindow(0, 0)) {
          if (
    ...
    for (let e of r.hunkContent) {
      ...
      let i = e === v;
      if (e.type === `context`) {
        if (c.shouldSkip(e.lines, e.lines)) (c.incrementCounts(e.lines, e.lines), d());
        else {
          let [a, o] = yl(c, e.lines, t);
          a > 0 && c.incrementCounts(a, a);
          let s = a;
          for (; s < e.lines; ) {
            if (s >= o) {
              c.incrementCounts(e.lines - s, e.lines - s);
              break;
            }
            if (c.isInWindow(0, 0)) {
              let t = i && s === e.lines - 1,
              ...
              if (
                c.emit({
                  ...
                  hunk: r,
                  collapsedBefore: d(),
                  collapsedAfter: u(a, o),
                  type: `context`,
                  deletionLine: {
                    lineNumber: g + s,
                    lineIndex: m + s,
                    noEOFCR: t && r.noEOFCRDeletions,
                    unifiedLineIndex: a,
                    splitLineIndex: o,
                  },
                  additionLine: {
        ...
        ((f += e.lines), (p += e.lines), (m += e.lines), (h += e.lines), (g += e.lines), (_ += e.lines));
      } else {
        ...
        if (!c.shouldSkip(o, a)) {
          ...
          for (let [l, v] of s)
            for (let s = l; s < v; s++) {
              let l = u(f + s, t === `unified` ? p + (s < e.deletions ? s : s - e.deletions) : p + s);
              if (
                c.emit(
                  Cl({
                    hunkIndex: n,
    ...
    if (s != null) {
      let { collapsedLines: n, fromStart: r, fromEnd: i } = s,
        a = r + i,
        [o, l] = yl(c, a, t);
      o > 0 && c.incrementCounts(o, o);
      let u = o;
      for (; u < a; ) {
        if (c.shouldBreak()) break hunkIterator;
        if (u >= l) {
          c.incrementCounts(a - u, a - u);
          break;
        }
        if (c.isInWindow(0, 0)) {
          let t = u === a - 1;
          if (
            c.emit({
              ...
              hunk: void 0,
              collapsedBefore: 0,
              collapsedAfter: t ? n : 0,
              type: `context-expanded`,
              deletionLine: {
                lineNumber: g + u,
                lineIndex: m + u,
                noEOFCR: !1,
                unifiedLineIndex: f + u,
                splitLineIndex: p + u,
              },
              additionLine: {
                unifiedLineIndex: f + u,
...
function _l({ diff: e, diffStyle: t, startingLine: n, expandedHunks: r, collapsedContextThreshold: i }) {
  if (n <= 0 || t === `both`) return { hunkIndex: 0, splitCount: 0, unifiedCount: 0 };
  let a = vl({ diff: e, expandedHunks: r, collapsedContextThreshold: i }),
    o = 0,
    s = e.hunks.length - 1,
    c = e.hunks.length;
  for (; o <= s; ) {
  ...
  if (c >= e.hunks.length) {
    ...
    return { hunkIndex: e.hunks.length, splitCount: t.splitCount, unifiedCount: t.unifiedCount };
  }
  let l = a[c];
  if (l == null) throw Error(`iterateOverDiff: invalid selected hunk prefix index`);
  return { hunkIndex: c, splitCount: l.splitCount, unifiedCount: l.unifiedCount };
}
function vl({ diff: e, expandedHunks: t, collapsedContextThreshold: n }) {
  let r = 0,
    i = 0,
    a = e.hunks.length - 1,
  ...
  for (let s = 0; s < e.hunks.length; s++) {
    ...
    if (((r += u + c.splitLineCount), (i += u + c.unifiedLineCount), s === a && xl(e))) {
      let a = bl(e, c),
        o = hl({
          isPartial: e.isPartial,
          rangeSize: a,
...
function bl(e, t) {
  ...
  if (n !== r) throw Error(`iterateOverDiff: trailing context mismatch (additions=${n}, deletions=${r}) for ${e.name}`);
  return Math.min(n, r);
}
function xl(e) {
  let t = e.hunks.at(-1);
...
function Sl(e, t, n) {
  ...
  if (
    (r &&
      (l(s(e.unifiedCount, t.deletions), `deletions`), l(s(e.unifiedCount + t.deletions, t.additions), `additions`)),
    i && (l(s(e.splitCount, t.deletions), `deletions`), l(s(e.splitCount, t.additions), `additions`)),
    o.length === 0)
  )
    return o;
  o.sort((e, t) => e[0] - t[0]);
...
function Cl({
  ...
  let g = a < f.deletions ? o + a : void 0,
    _ = i === `unified` ? (a >= f.deletions ? o + a : void 0) : a < f.additions ? o + f.deletions + a : void 0,
    v = i === `unified` ? s + (a < f.deletions ? a : a - f.deletions) : s + a,
    ee = a < f.deletions ? l + a : void 0,
    te = a < f.deletions ? d + a : void 0,
    ne = i === `unified` ? (a >= f.deletions ? c + (a - f.deletions) : void 0) : a < f.additions ? c + a : void 0,
    re = i === `unified` ? (a >= f.deletions ? u + (a - f.deletions) : void 0) : a < f.additions ? u + a : void 0,
    y = i === `unified` ? p && a === f.deletions - 1 && t.noEOFCRDeletions : p && a === h - 1 && t.noEOFCRDeletions,
    ie = i === `unified` ? p && a === m - 1 && t.noEOFCRAdditions : p && a === h - 1 && t.noEOFCRAdditions,
    ae =
      ee != null && te != null && g != null
        ? { lineNumber: te, lineIndex: ee, noEOFCR: y, unifiedLineIndex: g, splitLineIndex: v }
        : void 0,
    oe =
      ne != null && re != null && _ != null
        ? { unifiedLineIndex: _, splitLineIndex: v, lineIndex: ne, lineNumber: re, noEOFCR: ie }
        : void 0;
  if (ae == null && oe != null)
    return {
      type: `change`,
...
function wl({ line: e, spanStart: t, spanLength: n }) {
  return {
...
function Tl({ item: e, arr: t, enableJoin: n, isNeutral: r = !1, isLastItem: i = !1 }) {
  let a = t[t.length - 1];
  if (a == null || i || !n) {
    t.push([+!r, e.value]);
    return;
...
const El = { forcePlainText: !1 };
function Dl(
  e,
  t,
  n,
  { forcePlainText: r, startingLine: i, totalLines: a, expandedHunks: o, collapsedContextThreshold: s = 1 } = El,
) {
  r ? ((i ??= 0), (a ??= 1 / 0)) : ((i = 0), (a = 1 / 0));
  let c = i > 0 || a < 1 / 0,
    l = typeof n.theme == `string` ? t.getTheme(n.theme).type : void 0,
    u = fl({ theme: n.theme, highlighter: t }),
  ...
  for (let i of g.values()) {
    ...
    let a = { name: e.prevName ?? e.name, contents: i.deletionContent.value },
      ...
      { deletionLines: s, additionLines: c } = Al({
        deletionFile: a,
    ...
    if (i.deletionSegments.length > 0)
      for (let e of i.deletionSegments)
        for (let t = 0; t < e.count; t++) f.deletionLines[e.targetIndex + t] = s[e.originalOffset + t];
    else f.deletionLines.push(...s);
    if (i.additionSegments.length > 0)
      for (let e of i.additionSegments)
        for (let t = 0; t < e.count; t++) f.additionLines[e.targetIndex + t] = c[e.originalOffset + t];
...
function Ol({
  ...
  if (e == null || t == null || o === `none` || ((e = Qc(e)), (t = Qc(t)), e.length > s || t.length > s)) return;
  let c = o === `char` ? bc(e, t) : Pc(e, t),
    l = [],
    u = [],
    d = o === `word-alt`,
    f = c.at(-1);
  for (let e of c) {
    let t = e === f;
    !e.added && !e.removed
      ? (Tl({ item: e, arr: l, enableJoin: d, isNeutral: !0, isLastItem: t }),
        Tl({ item: e, arr: u, enableJoin: d, isNeutral: !0, isLastItem: t }))
      : e.removed
        ? Tl({ item: e, arr: l, enableJoin: d, isLastItem: t })
        : Tl({ item: e, arr: u, enableJoin: d, isLastItem: t });
  }
  let p = 0;
  for (let e of l) (e[0] === 1 && i.push(wl({ line: n, spanStart: p, spanLength: e[1].length })), (p += e[1].length));
  p = 0;
  for (let e of u) (e[0] === 1 && a.push(wl({ line: r, spanStart: p, spanLength: e[1].length })), (p += e[1].length));
}
function kl() {
  return {
    deletionContent: {
...
function Al({
  ...
  languageOverride: s,
  options: { theme: c = Vc, ...l },
}) {
  let u = s ?? Xc(e.name),
    d = s ?? Xc(t.name),
    { state: f, transformers: p } = ll(l.useTokenTransformer),
    m =
      typeof c == `string`
        ? {
            ...l,
  ...
  return {
    deletionLines:
      e.contents === ``
        ? []
        : ((m.lang = u), (f.lineInfo = n), (m.decorations = a), ml(i.codeToHast(Qc(e.contents), m))),
    additionLines:
      t.contents === ``
        ? []
        : ((m.lang = d), (m.decorations = o), (f.lineInfo = r), ml(i.codeToHast(Qc(t.contents), m))),
  };
}
function jl({ lines: e, startingLine: t = 0, totalLines: n = 1 / 0, callback: r }) {
...
const Nl = { forcePlainText: !1 };
function Pl(
  e,
  t,
  { theme: n = Vc, tokenizeMaxLineLength: r, useTokenTransformer: i },
  { forcePlainText: a, startingLine: o, totalLines: s, lines: c } = Nl,
) {
  a ? ((o ??= 0), (s ??= 1 / 0)) : ((o = 0), (s = 1 / 0));
  let l = o > 0 || s < 1 / 0,
    { state: u, transformers: d } = ll(i),
    f = a ? `text` : (e.lang ?? Xc(e.name)),
    p = typeof n == `string` ? t.getTheme(n).type : void 0,
    m = fl({ theme: n, highlighter: t });
  ...
  let h =
    ...
    g = ml(t.codeToHast(l ? Fl(c ?? Ml(e.contents), o, s) : Qc(e.contents), h)),
    _ = l ? Array(o) : g;
...
async function Rl(e) {
  try {
    ...
    (console.error(`Worker error:`, t), ql(e.id, t));
  } finally {
    Ll.exec(``);
  }
}
async function zl({
  ...
  let s = Ul(n);
  (`then` in s && (s = await s),
    Wl({ customExtensionsVersion: a, customExtensionMap: o }),
    qc(r, s),
    i != null && Wc(i, s),
    ($ = t),
    postMessage({ type: `success`, id: e, requestType: `initialize`, sentAt: Date.now() }));
}
async function Bl({ id: e, renderOptions: t, resolvedThemes: n }) {
  let r = Ul();
  (`then` in r && (r = await r),
    qc(n, r),
    ($ = t),
    postMessage({ type: `success`, id: e, requestType: `set-render-options`, sentAt: Date.now() }));
}
async function Vl({ id: e, file: t, resolvedLanguages: n, customExtensionsVersion: r, customExtensionMap: i }) {
  let a = Ul();
  (`then` in a && (a = await a), Wl({ customExtensionsVersion: r, customExtensionMap: i }), n != null && Wc(n, a));
  let o = {
    theme: $.theme,
...
async function Hl({ id: e, diff: t, resolvedLanguages: n, customExtensionsVersion: r, customExtensionMap: i }) {
  let a = Ul();
  (`then` in a && (a = await a),
    Wl({ customExtensionsVersion: r, customExtensionMap: i }),
    n != null && Wc(n, a),
    Kl(e, Dl(t, a, $), $));
}
function Ul(e = `shiki-js`) {
  return (
    (Il ??= zi({ themes: [], langs: [], engine: e === `shiki-wasm` ? vc(import(`./wasm-CboGkVi_.js`)) : Ys() })),
    Il
  );
}
function Wl({ customExtensionsVersion: e, customExtensionMap: t }) {
  if (!(e == null && t == null)) {
    if (e == null || t == null)
      throw Error(`Worker request must include both customExtensionsVersion and customExtensionMap`);
    Zc(e, t);
  }
}
function Gl(e, t, n) {
  postMessage({ type: `success`, requestType: `file`, id: e, result: t, options: n, sentAt: Date.now() });
}
function Kl(e, t, n) {
  postMessage({ type: `success`, requestType: `diff`, id: e, result: t, options: n, sentAt: Date.now() });
}
function ql(e, t) {
  let n = {
    type: `error`,
