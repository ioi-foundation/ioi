import { bn as e } from "./SegmentProvider-CXCNBY9U.js";
import {
  B as t,
  Bs as n,
  Eu as r,
...
import { Ls as x } from "./use-boot-in-app-chat-t-J_VjKS.js";
import {
  C as S,
  E as C,
  M as w,
...
var L = {
    "start-from-scratch": {
      ...
      description: `Create a custom automation workflow from scratch.`,
      icon: b,
      iconColor: `text-content-brand`,
      iconBgColor: `bg-surface-brand-subtle`,
      enabled: !0,
      trigger: _(O, {
        trigger: { case: `manual`, value: _(N) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, { step: { case: `agent`, value: { prompt: `With prompts you can send messages to IOI Agent` } } }),
        _(k, { step: { case: `task`, value: { command: `echo 'with commands you can run shell commands'` } } }),
      ],
    },
    "automated-dev-environment-setup": {
      id: `automated-dev-environment-setup`,
      title: `Automated dev environment setup`,
      description: `Standardizes your development environment and opens a PR with the required updates.`,
      enabled: !0,
      icon: d,
      iconColor: `text-content-success`,
      iconBgColor: `bg-surface-success-subtle`,
      trigger: _(O, {
        trigger: { case: `manual`, value: _(N) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Create a high-quality, fully working “development environment as code” configuration for the current environment.
...
https://ioi.com/docs/llms.txt
	...
	•	Anything installable within a Dockerfile
        ...
        _(k, {
          step: {
            case: `pullRequest`,
            value: _(F, {
              title: `IOI: automated dev environment setup`,
              description: `The PR has been automatically created by IOI Agent to set up a consistent development environment for this repository. Please review the changes and merge if everything looks good.`,
              branch: `ioi/automated-dev-environment-setup`,
              draft: !0,
            }),
          },
        }),
    ...
    "cve-mitigation-and-version-updates": {
      id: `cve-mitigation-and-version-updates`,
      title: `CVE mitigation & dependency updates`,
      description: `Fixes vulnerable or outdated dependencies, validates changes, and opens a PR.`,
      enabled: !0,
      icon: l,
      iconColor: `text-content-brand-accent-01`,
      iconBgColor: `bg-surface-brand-accent-01-subtle`,
      trigger: _(O, {
        trigger: { case: `manual`, value: _(N) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `First, scan this repository's dependency files (package.json, go.mod, requirements.txt, Gemfile, pom.xml, etc.) for outdated dependencies. Run the appropriate audit/outdated command for the package manager (npm audit, npm outdated, go list -m -u all, pip-audit, etc.). List dependencies that are more than one major or two minor versions behind, or have known vulnerabilities. If a specific {CVE_ID} was provided, also research that CVE: what is the vulnerability, which library/package, what versions are affected, what versions have the fix, and which specific functions or code patterns trigger it. Output: one sentence status only.`,
            },
          },
        }),
        _(k, {
        ...
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `If the vulnerable library was found: search source code to find if our code calls the vulnerable functions. Show the call chain. If the library was not found or not reachable, skip this work. Do not modify any files yet. Output: one sentence status only.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `If the vulnerability is reachable: update the dependency to the fixed version, adjust code if APIs changed, and run tests. Otherwise skip this work. Do not create a PR yet. Output: one sentence status only.`,
            },
          },
        }),
        _(k, {
          step: {
            ...
            value: _(F, {
              ...
              description: `Automated CVE remediation by IOI Agent.`,
              branch: `ioi/cve-remediation`,
              draft: !0,
            }),
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Generate a security analysis report using all information from previous steps. Format:
...
Put the outcome first. Be concise.`,
    ...
    "add-and-maintain-readmes-and-backstage-yaml": {
      id: `add-and-maintain-readmes-and-backstage-yaml`,
      title: `Backstage catalog standardization`,
      description: `Updates catalog-info.yaml to match your Backstage standards and opens a PR.`,
      enabled: !0,
      icon: r,
      iconColor: `text-content-warning`,
      iconBgColor: `bg-surface-warning-subtle`,
      trigger: _(O, {
        trigger: { case: `manual`, value: _(N) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Fetch and analyze the Backstage catalog standardization RFC from this Gist: https://gist.github.com/loujaybee/7f8ed30f4dd2dee94a5db019b47cce62
...
Output a structured summary of the RFC requirements that will guide the subsequent steps.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Examine this repository to understand its characteristics:
...
Provide a comprehensive analysis that will inform the catalog-info.yaml generation.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Based on the RFC requirements and repository analysis, generate or update the catalog-info.yaml file:
...
If catalog-info.yaml already exists, preserve any manually-added fields and only update missing or outdated automated fields.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Install the Backstage entity validator and validate the generated catalog-info.yaml file:
...
Report the validation results.`,
        ...
        _(k, {
          step: {
            case: `pullRequest`,
            value: _(F, {
              title: `chore: add Backstage catalog metadata per RFC-2024-023`,
              description: `This PR implements the Backstage catalog standardization requirements defined in RFC-2024-023.
...
Please review the automated fields and complete the manual items before merging.`,
              branch: `ioi/backstage-catalog-standardization`,
              draft: !0,
            }),
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Add a comment to the pull request highlighting what requires human attention:
...
Once you've completed these items, this component will be fully compliant with RFC-2024-023.`,
    ...
    "code-review": {
      id: `code-review`,
      title: `Code review`,
      description: `Reviews PRs for quality, security, and test coverage, then leaves actionable feedback.`,
      enabled: !0,
      icon: t,
      iconColor: `text-content-brand`,
      iconBgColor: `bg-surface-brand-subtle`,
      trigger: _(O, {
        trigger: { case: `pullRequest`, value: _(w, { events: [M.OPENED, M.READY_FOR_REVIEW] }) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `CODE REVIEW AGENT FOR IOI
...
REMEMBER: Quality over quantity. Understand before critiquing. Focus on what changed. Be helpful and fair. Check consistency with existing patterns, not arbitrary style. Treat generated code fairly. Always conclude with summary. Work with available context - never fail due to missing pieces.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `If you found no significant concerns in your review, add a "ioi-approved" label to the pull request. You have my explicit permission to add this label if you have no concerns about this code getting merged.`,
            },
          },
        }),
      ],
    ...
    "generate-agents-md": {
      ...
      description: `Creates or updates AGENTS.md with project-specific guidance for coding agents.`,
      enabled: !0,
      recommended: !0,
      icon: y,
      iconColor: `text-content-primary`,
      iconBgColor: `bg-surface-base`,
      trigger: _(O, {
        trigger: { case: `manual`, value: _(N) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Create or update AGENTS.md (https://agents.md) - a README that helps AI agents work on this repo.
...
- Omit sections with no information`,
        ...
        _(k, {
          step: {
            case: `pullRequest`,
            value: _(F, {
              title: `chore: add AGENTS.md`,
              description: `Adds/Improves AGENTS.md to set up this repo for success with IOI Agent.
...
See https://ioi.com/docs/ioi/agents-md and https://agents.md for background.`,
              branch: `ioi/agents-md`,
              draft: !0,
            }),
          },
        }),
    ...
    "sentry-error-triage-and-fix": {
      id: `sentry-error-triage-and-fix`,
      title: `Sentry error triage & fix`,
      description: `Fixes the highest-impact unresolved Sentry error and opens a PR.`,
      enabled: !0,
      requiredIntegrations: [`Sentry`],
      icon: h,
      iconColor: `text-content-destructive`,
      iconBgColor: `bg-surface-destructive-subtle`,
      trigger: _(O, {
        trigger: { case: `manual`, value: _(N) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Sentry integration to list unresolved issues from the past 24 hours for this project. Sort by event count (most frequent first). Select the top unresolved issue that hasn't been assigned. Output: issue title, error message, stack trace, event count, and affected users count.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Using the Sentry stack trace from the previous step, locate the exact file and line in this repository where the error originates. Read the surrounding code and understand the root cause. Identify whether this is a null reference, type error, unhandled exception, race condition, or other category. Explain the root cause in one paragraph.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Fix the root cause identified in the previous step. Apply the minimal change needed. Add or update tests to cover the error scenario. Run the test suite to verify the fix doesn't break anything. If tests fail, iterate until they pass.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `task`,
            value: { command: `npm test || go test ./... || yarn test || echo 'Tests completed'` },
          },
        }),
        _(k, {
          step: {
            case: `pullRequest`,
            value: _(F, {
              title: `fix: resolve top Sentry error`,
              description: `Automated fix for the most frequent unresolved Sentry error. See PR body for root cause analysis.`,
              branch: `ioi/sentry-fix`,
              draft: !0,
            }),
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Sentry integration to add a comment on the original Sentry issue linking to the PR that was just created. Mark the issue as 'assigned' if possible.`,
            },
          },
        }),
      ],
    ...
    "10x-engineer": {
      id: `10x-engineer`,
      title: `10x engineer`,
      description: `Picks your highest-priority Linear issue, implements it, runs tests, and opens a draft PR.`,
      enabled: !0,
      recommended: !0,
      ...
      iconBgColor: `bg-surface-brand-subtle`,
      trigger: _(O, {
        trigger: { case: `time`, value: _(T, { cronExpression: `0 9 * * 1-5` }) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Linear integration to fetch issues assigned to the authenticated user in the current sprint/cycle. Sort by: (1) priority (urgent first), then (2) due date (soonest first). Exclude issues that are already 'In Progress', 'In Review', or 'Done'. Exclude epics and issues with more than 3 sub-tasks. Return the top 5 candidates with: identifier, title, description, priority, due date, labels, and acceptance criteria.`,
            },
          },
        }),
        _(k, {
...
Output: the selected issue identifier and a one-paragraph implementation plan.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Linear integration to update the selected issue's status to 'In Progress'. Add a comment: 'IOI is working on this issue automatically.'

Now implement the changes. Follow existing code patterns and conventions in this repository. Write tests for all new functionality. Handle edge cases mentioned in the acceptance criteria. Keep changes minimal and focused — do not refactor unrelated code.`,
            },
          },
        }),
        _(k, {
        ...
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `If tests failed, analyze the failures and fix them. Re-run the test suite. Iterate up to 3 times. If tests still fail after 3 attempts, revert your changes, use the Linear integration to set the issue back to its previous status, add a comment explaining what went wrong, and stop.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `pullRequest`,
            value: _(F, {
              title: `feat: implement Linear issue`,
              description: `Automated implementation by IOI Agent. See the linked Linear issue for requirements.`,
              branch: `ioi/linear-issue`,
              draft: !0,
            }),
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Linear integration to update the issue status to 'In Review' and add a comment with a link to the created PR. Include a brief summary of what was implemented and any decisions made during implementation.`,
            },
          },
        }),
      ],
    },
    "pr-changelog-to-notion": {
      id: `pr-changelog-to-notion`,
      title: `PR changelog`,
      description: `Updates Notion and CHANGELOG.md when a PR is merged.`,
      enabled: !0,
      requiredIntegrations: [`Notion`],
      icon: o,
      iconColor: `text-content-primary`,
      iconBgColor: `border border-border-subtle bg-surface-secondary`,
      trigger: _(O, {
        trigger: { case: `pullRequest`, value: _(w, { events: [M.MERGED] }) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Read the merged pull request: title, description, labels, changed files, and commit messages. Categorize the change as one of: feature, fix, refactor, docs, chore, or breaking change. Extract a one-line summary and a detailed description (2-3 sentences max).`,
            },
          },
        }),
        _(k, {
        ...
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Check if a CHANGELOG.md (or CHANGES.md, HISTORY.md) file exists in the repository root. If it does, prepend the new changelog entry at the top of the file under the current date heading, following the existing format and conventions in the file. If the file uses Keep a Changelog format, place the entry under the appropriate section (Added, Fixed, Changed, etc.). Do not create a CHANGELOG.md if one doesn't already exist — the Notion entry is sufficient in that case.`,
            },
          },
        }),
      ],
    ...
    "weekly-sentry-report": {
      id: `weekly-sentry-report`,
      title: `Weekly Sentry error report`,
      description: `Publishes a weekly summary of new errors, regressions, and top offenders.`,
      enabled: !0,
      requiredIntegrations: [`Sentry`, `Notion`],
      icon: p,
      iconColor: `text-content-warning`,
      iconBgColor: `bg-surface-warning-subtle`,
      trigger: _(O, {
        trigger: { case: `time`, value: _(T, { cronExpression: `0 9 * * 5` }) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Sentry integration to gather data for the past 7 days: (1) new unresolved issues sorted by event count, (2) issues that regressed (were resolved but reappeared), (3) the top 5 most frequent errors by event count. For each issue, capture: title, error type, event count, affected users, first seen, and last seen.`,
            },
          },
        }),
        _(k, {
        ...
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Notion integration to create a new page titled 'Error Report — Week of {DATE}' in the team's engineering space (search for 'Engineering' or 'Error Reports' section). Add the formatted report content. Include a link back to the Sentry project dashboard.`,
            },
          },
        }),
      ],
    },
    "linear-sprint-standup": {
      id: `linear-sprint-standup`,
      title: `Daily standup generator`,
      description: `Combines Linear and Git activity into a daily standup update.`,
      enabled: !0,
      recommended: !0,
      requiredIntegrations: [`Linear`],
      icon: a,
      ...
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Linear integration to fetch the current active sprint/cycle for the authenticated user. Get: (1) issues completed in the last 24 hours (status changed to 'Done'), (2) issues currently 'In Progress', (3) issues marked as 'Blocked' or with blocking labels. For each issue, get: identifier, title, priority, and any blockers mentioned in comments.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Summarize yesterday's git activity in this repository. Run 'git log --since="24 hours ago" --oneline --no-merges' to get recent commits. Group them by area of the codebase (e.g., frontend, backend, tests, docs, infra). Note any PRs that were merged. Keep the summary concise — one line per commit group, not per commit.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Combine the Linear sprint data and git activity into a formatted standup update:
...
Keep it concise — one line per item. Use the Linear integration to post this as a comment on the current sprint/cycle, or output it for the user to share.`,
            },
          },
        }),
      ],
    },
    "notion-tech-spec-from-issue": {
      id: `notion-tech-spec-from-issue`,
      title: `Tech spec from Linear issue`,
      description: `Turns a Linear issue into an implementation-ready spec with technical design and execution details.`,
      enabled: !0,
      recommended: !0,
      ...
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Linear integration to fetch issue {ISSUE_ID}. Extract all context: title, description, acceptance criteria, comments, linked issues, and sub-issues. Identify the scope of work and any constraints mentioned.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Analyze this repository's codebase to understand the relevant architecture: directory structure, existing patterns, data models, API conventions, and test patterns. Map the Linear issue requirements to specific areas of the codebase that will need changes.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Write a technical specification covering:
...
**Risks:** What could go wrong, migration concerns, backward compatibility.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Notion integration to create a new page titled 'Tech Spec: {ISSUE_TITLE}' in the engineering docs space. Add the technical specification content with proper headings and formatting. Add a link to the Linear issue at the top. Use the Linear integration to add a comment on the issue linking to the Notion spec.`,
            },
          },
        }),
      ],
    },
    "sentry-to-linear-issues": {
      id: `sentry-to-linear-issues`,
      title: `Sentry to Linear issues`,
      description: `Turns new Sentry errors into prioritized Linear issues with relevant context.`,
      enabled: !0,
      requiredIntegrations: [`Sentry`, `Linear`],
      icon: f,
      iconColor: `text-content-destructive`,
      iconBgColor: `bg-surface-destructive-subtle`,
      trigger: _(O, {
      ...
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Sentry integration to list new unresolved issues from the past 24 hours with more than 10 events. For each issue, extract: title, error message, stack trace (first 3 frames), event count, affected users count, and first/last seen timestamps. Skip issues with fewer than 10 events.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `For each Sentry issue found, use the Linear integration to search for existing issues with matching titles or error messages. If a Linear issue already exists, skip it. For issues without a matching Linear ticket, create a new issue with:
...
Output a summary of what was created and what was skipped.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `For each newly created Linear issue, use the Sentry integration to add a comment on the corresponding Sentry issue with the Linear issue link and identifier.`,
            },
          },
        }),
      ],
    ...
    "migrate-deprecated-api": {
      ...
      description: `Replaces deprecated APIs, validates the migration, and opens a PR.`,
      enabled: !0,
      icon: u,
      iconColor: `text-content-warning`,
      iconBgColor: `bg-surface-warning-subtle`,
      ...
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `The user wants to migrate from {OLD_API} to {NEW_API}. Search the entire repository for all usages of the deprecated API: imports, function calls, type references, and configuration. List every file and line number where the old API is used. Count total occurrences. If no usages found, report that and stop.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `For each usage found, determine the correct migration path. Read the new API's documentation or source to understand the equivalent replacement. Handle edge cases: changed function signatures, renamed parameters, different return types, removed features that need workarounds. Plan the migration file by file.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Apply the migration across all files. Update imports, replace function calls, adjust types, and update any configuration files. Ensure each file compiles/parses correctly after changes. Run the linter if available.`,
            },
          },
        }),
        _(k, {
        ...
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `If any tests failed, analyze the failures and fix them. The failures are likely due to the API migration — adjust test expectations, update mocks, or fix migration errors. Re-run tests until they pass.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `pullRequest`,
            value: _(F, {
              title: `refactor: migrate deprecated API usage`,
              description: `Automated migration of all deprecated API usage by IOI Agent.`,
              branch: `ioi/migrate-api`,
              draft: !0,
            }),
          },
        }),
    ...
    "scan-recent-commits": {
      ...
      description: `Finds likely bugs in recent commits and opens a draft PR with proposed fixes.`,
      enabled: !0,
      recommended: !0,
      icon: g,
      iconColor: `text-content-warning`,
      ...
      steps: [
        ...
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `For each bug found in the previous step, apply the minimal fix. Change only what's necessary to resolve the issue — do not refactor surrounding code. Add or update tests to cover the bug scenario where practical. Run the linter if available.`,
            },
          },
        }),
        _(k, {
        ...
        _(k, {
          step: {
            case: `pullRequest`,
            value: _(F, {
              title: `fix: bugs found in recent commits`,
              description: `Automated scan of recent commits found potential bugs. Each fix is minimal and targeted. See the diff for details on what was found and fixed.`,
              branch: `ioi/commit-scan-fixes`,
              draft: !0,
            }),
          },
        }),
    ...
    "draft-weekly-release-notes": {
      ...
      description: `Turns merged PRs into categorized release notes with concise summaries.`,
      enabled: !0,
      recommended: !0,
      icon: v,
      iconColor: `text-content-brand`,
      iconBgColor: `bg-surface-brand-subtle`,
      trigger: _(O, {
        trigger: { case: `time`, value: _(T, { cronExpression: `0 16 * * 5` }) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `List all PRs merged in the past 7 days. For each PR, extract: title, author, labels, and a one-line summary of the change from the PR description or commit messages. Include the PR number and link where available.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Organize the merged PRs into release notes with these sections:
...
Each entry should be one line: a short description followed by the PR link in parentheses. Write in a tone suitable for sharing with the broader team or external stakeholders — clear, factual, no jargon. Output the release notes as markdown.`,
            },
          },
        }),
      ],
    ...
    "ci-failure-summary": {
      ...
      description: `Highlights recurring CI failures and flaky tests, ranked by impact.`,
      enabled: !0,
      icon: i,
      iconColor: `text-content-destructive`,
      iconBgColor: `bg-surface-destructive-subtle`,
      ...
      steps: [
        ...
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Produce a CI health summary:
...
Keep the summary concise and actionable.`,
    ...
    "linear-bug-to-fix": {
      id: `linear-bug-to-fix`,
      title: `Linear bug to fix PR`,
      description: `Converts a Linear bug report into a tested fix and draft PR.`,
      enabled: !0,
      requiredIntegrations: [`Linear`],
      icon: f,
      iconColor: `text-content-warning`,
      ...
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Use the Linear integration to fetch the bug issue assigned to you (or the most recent high-priority bug in the current cycle). Extract: title, description, reproduction steps, acceptance criteria, and any linked code references or stack traces.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Based on the bug details, locate the relevant code in this repository. Identify the root cause, implement a fix, and add or update tests that cover the failure case. Open a pull request with:
...
Mark the Linear issue as "In Review" after opening the PR.`,
            },
          },
        }),
      ],
    ...
    "notion-weekly-digest": {
      ...
      description: `Publishes a weekly digest of team activity, merged PRs, and open work.`,
      enabled: !0,
      requiredIntegrations: [`Notion`],
      icon: s,
      iconColor: `text-content-brand`,
      ...
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Gather this week's activity for the repository: all PRs merged since last Monday, currently open PRs with their review status, new issues opened, and issues closed. For each PR, extract: title, author, and a one-line summary.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `Create a Notion page titled "Weekly Digest — [date range]" with these sections:
...
Keep the tone factual and scannable. Publish the page to the team's weekly digest database in Notion.`,
            },
          },
        }),
      ],
    ...
    "incident-first-response": {
      ...
      description: `Investigates new incidents, gathers context, proposes a diagnosis, and recommends next steps.`,
      enabled: !0,
      requiredIntegrations: [`incident.io`],
      icon: n,
      iconColor: `text-content-warning`,
      iconBgColor: `bg-surface-warning-subtle`,
      trigger: _(O, {
        trigger: { case: `incident`, value: _(E, { events: [C.CREATED], integrationId: `` }) },
        context: _(D, { context: { case: `projects`, value: _(S, { projectIds: [] }) } }),
      }),
      steps: [
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `You are performing first-response triage on a production incident.
...
Output: A brief summary of the incident context — what is affected, when it started, and what signals are available.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `STEP 2 — CHECK RECENT CHANGES
...
Output: List of correlated changes with timestamps, tools that were unavailable, or "no recent changes found."`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `STEP 3 — INVESTIGATE OBSERVABILITY
...
Output: Findings from each available data source, organized by source. List any sources that were unavailable.`,
            },
          },
        }),
        _(k, {
...
If confidence is Low, state what additional information would help and ask the incident lead for guidance.`,
            },
          },
        }),
        _(k, {
          step: {
            case: `agent`,
            value: {
              prompt: `STEP 5 — PROPOSE MITIGATION
...
REMINDER: Do NOT execute any mitigation without explicit human approval.`,
            },
          },
        }),
      ],
  ...
  R = {
    "launch-use-cases": {
      ...
      templates: {
        "scan-recent-commits": L[`scan-recent-commits`],
        "draft-weekly-release-notes": L[`draft-weekly-release-notes`],
        "generate-agents-md": L[`generate-agents-md`],
        "automated-dev-environment-setup": L[`automated-dev-environment-setup`],
        "cve-mitigation-and-version-updates": L[`cve-mitigation-and-version-updates`],
        "add-and-maintain-readmes-and-backstage-yaml": L[`add-and-maintain-readmes-and-backstage-yaml`],
        "code-review": L[`code-review`],
        "migrate-deprecated-api": L[`migrate-deprecated-api`],
        "ci-failure-summary": L[`ci-failure-summary`],
      },
    },
    integrations: {
      id: `requires-integrations`,
      label: `With integrations`,
      description: `Requires connecting external tools like Figma, Linear, Sentry, or Notion`,
      templates: {
        "incident-first-response": L[`incident-first-response`],
        "10x-engineer": L[`10x-engineer`],
        "linear-sprint-standup": L[`linear-sprint-standup`],
        "notion-tech-spec-from-issue": L[`notion-tech-spec-from-issue`],
        "sentry-error-triage-and-fix": L[`sentry-error-triage-and-fix`],
        "sentry-to-linear-issues": L[`sentry-to-linear-issues`],
        "weekly-sentry-report": L[`weekly-sentry-report`],
        "pr-changelog-to-notion": L[`pr-changelog-to-notion`],
        "linear-bug-to-fix": L[`linear-bug-to-fix`],
        "notion-weekly-digest": L[`notion-weekly-digest`],
      },
    },
    "from-scratch": { id: `from-scratch`, label: `Or`, templates: { "start-from-scratch": L[`start-from-scratch`] } },
  },
  z = (e) => L[e],
  B = (t, n) => {
    let r = t.has(e.Webhooks),
      i = n?.incidentTriggersEnabled ?? !1;
    return Object.values(R)
      .map((e) => {
        let t = Object.fromEntries(
          Object.entries(e.templates).filter(
            ([, e]) =>
              !((!r && e.trigger.trigger.case === `pullRequest`) || (!i && e.trigger.trigger.case === `incident`)),
          ),
        );
        return { ...e, templates: t };
      })
      .filter((e) => Object.keys(e.templates).length > 0);
  },
  V = (e) => {
    let t = L[`start-from-scratch`];
    return {
      ...t,
      title: `${e.metadata?.name ?? `Automation`} (copy)`,
      description: e.metadata?.description ?? ``,
      steps: e.spec?.action?.steps ? e.spec.action.steps.map((e) => structuredClone(e)) : [...t.steps],
      trigger: e.spec?.triggers?.[0] ? structuredClone(e.spec.triggers[0]) : t.trigger,
    };
  },
  H = (e, t) =>
    _(P, {
      metadata: { name: e.title, description: e.description, executor: { id: t, principal: x.USER } },
      spec: {
        triggers: [e.trigger],
        action: _(A, { limits: _(j, { maxParallel: I.maxParallel, maxTotal: I.maxTotal }), steps: [...e.steps] }),
      },
    });
export { H as i, z as n, B as r, V as t };
