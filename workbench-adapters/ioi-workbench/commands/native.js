  ...
  return function registerNativeCommands({
    ...
    context.subscriptions.push(
      ...
      ...commandRegistrars.registerNavigationCommands({
        ...
        getLastHypervisorModeBeforeCode,
        getStudioPanel,
        enterHome: () => enterHypervisorMode("home", output),
        enterStudio: () => enterHypervisorMode("studio", output),
        enterCode: () => enterHypervisorMode("code", output),
        enterMode: (modeId) => enterHypervisorMode(modeId, output),
        openOverviewPanel,
        openStudioPanel,
        openGenericModePanel,
        closePrimarySidebarAfterActivityLaunch,
      ...
      ...commandRegistrars.registerWorkflowCommands({
        ...
        workspaceSummary,
        pickString,
        enterWorkflows: () => enterHypervisorMode("workflows", output),
        openWorkflowComposerPanel,
        closePrimarySidebarAfterActivityLaunch,
        buildRuntimeRefs,
      }),
      ...commandRegistrars.registerModelCommands({
        ...
        pickPayloadString,
        daemonEndpoint,
        enterModels: () => enterHypervisorMode("models", output),
        enterWorkflows: () => enterHypervisorMode("workflows", output),
        openModelsPanel,
        openWorkflowComposerPanel,
        closePrimarySidebarAfterActivityLaunch,
      ...
      ...commandRegistrars.registerRuntimeSurfaceCommands({
        ...
        getActiveTraceTarget,
        setActiveTraceTarget,
        enterRuns: () => enterHypervisorMode("runs", output),
        enterPolicy: () => enterHypervisorMode("policy", output),
        enterConnectors: () => enterHypervisorMode("connectors", output),
        openGenericModePanel,
        closePrimarySidebarAfterActivityLaunch,
      }),
    );
