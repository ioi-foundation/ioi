...
const paths = {
  ...
  workbenchSurfaces:
    "workbench-adapters/ioi-workbench/workbench-surfaces.js",
  workbenchContextSnapshot:
    "workbench-adapters/ioi-workbench/workbench/context-snapshot.js",
  codeModePanel:
    "workbench-adapters/ioi-workbench/workbench/code-mode-panel.js",
  overviewPanel:
    "workbench-adapters/ioi-workbench/workbench/overview-panel.js",
  panelLifecycle:
    "workbench-adapters/ioi-workbench/workbench/panel-lifecycle.js",
  persistentModePanels:
    "workbench-adapters/ioi-workbench/workbench/persistent-mode-panels.js",
  workflowComposerPanel:
    "workbench-adapters/ioi-workbench/workbench/workflow-composer-panel.js",
  panel: "workbench-adapters/ioi-workbench/studio/studio-panel-html.js",
  styles: "workbench-adapters/ioi-workbench/studio/studio-panel-styles.js",
  modelSurface: "workbench-adapters/ioi-workbench/studio/model-surface.js",
  operationalSurface:
  ...
  promptPolicy:
    "workbench-adapters/ioi-workbench/studio/prompt-policy.js",
  answerStream:
    "workbench-adapters/ioi-workbench/studio/agent-answer-stream.js",
  finalHandoffStream:
    "workbench-adapters/ioi-workbench/studio/agent-final-handoff-stream.js",
  turnEvents:
    "workbench-adapters/ioi-workbench/studio/agent-turn-events.js",
  turnResultText:
    "workbench-adapters/ioi-workbench/studio/agent-turn-result-text.js",
  turnRecovery:
    "workbench-adapters/ioi-workbench/studio/agent-turn-recovery.js",
  runtimeEvents:
    "workbench-adapters/ioi-workbench/studio/runtime-event-utils.js",
  runtimeControls:
    "workbench-adapters/ioi-workbench/studio/runtime-controls.js",
  runtimeEventSelectors:
    "workbench-adapters/ioi-workbench/studio/runtime-event-selectors.js",
  threadEvents:
    "workbench-adapters/ioi-workbench/studio/thread-events.js",
  threadLifecycle:
    "workbench-adapters/ioi-workbench/studio/thread-lifecycle.js",
  pendingWork:
    "workbench-adapters/ioi-workbench/studio/pending-work.js",
  turnPolicy:
    "workbench-adapters/ioi-workbench/studio/turn-policy.js",
  policyLeaseLifecycle:
    "workbench-adapters/ioi-workbench/studio/policy-lease-lifecycle.js",
  workRecordProjection:
    "workbench-adapters/ioi-workbench/studio/work-record-projection.js",
  workRunRows:
    "workbench-adapters/ioi-workbench/studio/work-run-rows.js",
  responseMetrics:
    "workbench-adapters/ioi-workbench/studio/response-metrics.js",
  receiptRefs:
    "workbench-adapters/ioi-workbench/studio/receipt-refs.js",
  toolResponseProjection:
    "workbench-adapters/ioi-workbench/studio/tool-response-projection.js",
  sourceChipRenderer:
    "workbench-adapters/ioi-workbench/studio/source-chip-renderer.js",
  sourceRefs:
    "workbench-adapters/ioi-workbench/studio/source-refs.js",
  codeExecution:
    "workbench-adapters/ioi-workbench/studio/code-execution.js",
  chatOutputRenderers:
    "workbench-adapters/ioi-workbench/studio/chat-output-renderers.js",
  parityPlusPanels:
    "workbench-adapters/ioi-workbench/studio/parity-plus-panels.js",
  stage7DelegationLifecycle:
    "workbench-adapters/ioi-workbench/studio/stage7-delegation-lifecycle.js",
  pendingView:
    "workbench-adapters/ioi-workbench/studio/pending-view.js",
  durabilityPanels:
    "workbench-adapters/ioi-workbench/studio/durability-panels.js",
  runtimeCockpitLifecycle:
    "workbench-adapters/ioi-workbench/studio/runtime-cockpit-lifecycle.js",
  runtimeCockpitRows:
    "workbench-adapters/ioi-workbench/studio/runtime-cockpit-rows.js",
  runtimeRailRows:
    "workbench-adapters/ioi-workbench/studio/runtime-rail-rows.js",
  nativeChatView:
    "workbench-adapters/ioi-workbench/studio/native-chat-view.js",
  toolPalette:
    "workbench-adapters/ioi-workbench/studio/tool-palette.js",
  modelSelection:
    "workbench-adapters/ioi-workbench/studio/model-selection.js",
  overviewView:
    "workbench-adapters/ioi-workbench/studio/overview-view.js",
  traceView:
    "workbench-adapters/ioi-workbench/studio/trace-view.js",
  viewHelpers:
    "workbench-adapters/ioi-workbench/studio/view-helpers.js",
  chatCommands:
    "workbench-adapters/ioi-workbench/commands/chat.js",
  modelDaemonActions:
    "workbench-adapters/ioi-workbench/commands/model-daemon-actions.js",
  modelCommands:
    "workbench-adapters/ioi-workbench/commands/models.js",
  navigationCommands:
    "workbench-adapters/ioi-workbench/commands/navigation.js",
  runtimeSurfaceCommands:
    "workbench-adapters/ioi-workbench/commands/runtime-surfaces.js",
  productErrors:
    "workbench-adapters/ioi-workbench/studio/product-error-message.js",
  projectionState:
    "workbench-adapters/ioi-workbench/studio/projection-state.js",
  projectionReplay:
    "workbench-adapters/ioi-workbench/studio/projection-replay.js",
  publicTextSanitizer:
    "workbench-adapters/ioi-workbench/studio/public-text-sanitizer.js",
  managedSessions:
    "workbench-adapters/ioi-workbench/studio/projection-managed-sessions.js",
  parityPlusEvents:
    "workbench-adapters/ioi-workbench/studio/projection-parity-plus-events.js",
  runtimeEventProjection:
    "workbench-adapters/ioi-workbench/studio/projection-runtime-events.js",
  workspaceChanges:
    "workbench-adapters/ioi-workbench/studio/projection-workspace-changes.js",
  artifactRouting:
    "workbench-adapters/ioi-workbench/studio/artifact-research-routing.js",
  artifactIntent:
    "workbench-adapters/ioi-workbench/studio/artifact-intent.js",
  artifactPreview:
    "workbench-adapters/ioi-workbench/studio/artifact-preview.js",
  hunkLifecycle:
    "workbench-adapters/ioi-workbench/studio/hunk-lifecycle.js",
  managedSessionView:
    "workbench-adapters/ioi-workbench/studio/managed-session-view.js",
  studioModeControls:
    "workbench-adapters/ioi-workbench/commands/studio-mode-controls.js",
  studioQuickInput:
    "workbench-adapters/ioi-workbench/commands/studio-quick-input.js",
  studioTestHooks:
    "workbench-adapters/ioi-workbench/commands/studio-test-hooks.js",
  workflowCommands:
...
async function readStudioComposite() {
  const parts = await Promise.all(
    [
      ...
      paths.turnRecovery,
      paths.runtimeEvents,
      paths.runtimeControls,
      paths.runtimeEventSelectors,
      paths.threadEvents,
      paths.threadLifecycle,
      paths.pendingWork,
      paths.turnPolicy,
      ...
      paths.parityPlusEvents,
      paths.runtimeEventProjection,
      paths.workspaceChanges,
...
test("Agent Studio streams model text, tool work, final handoff, and artifact delivery through extracted modules", async () => {
  ...
  assertHas(source, [
    ...
    /const hasMaxStepsOverride = maxStepsOverride !== null/,
	    ...
	    /studio_intent_frame_projection_required/,
	    /Rust intent projection unavailable/,
	    /execution_mode: normalizeStudioExecutionMode/,
  ...
  assertLacks(source, [
	    ...
	    /executionMode: normalizeStudioExecutionMode/,
	    /function resolveStudioPromptIntentFrame(?:(?!\n}\n\nasync function recoverStudioConversationArtifactAfterTimeout)[\s\S])*options\.(?:executionMode|routeId|modelId|approvalMode|workspacePath)\b/,
	    /studioIntentFrameProjectsArtifact\(intentFrame\) \|\|/,
	    /studioIntentFrameProjectsRuntimeCockpit\(intentFrame\) \|\|/,
	  ]);
	});
