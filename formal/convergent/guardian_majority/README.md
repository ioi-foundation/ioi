...
`GuardianMajority` mode of Convergent Fault Tolerance.

The canonical prose spec lives at
[`docs/consensus/convergent/specs/guardian_majority.md`](/home/heathledger/Documents/ioi/repos/ioi/docs/consensus/convergent/specs/guardian_majority.md).
