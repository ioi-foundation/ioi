> **Execution routing (2026-07-17): preserved product-direction input.**
> Current worker endpoint, marketplace, identity, lifecycle, and protocol
> owners live in `docs/architecture/`. Active implementation sequencing is in
