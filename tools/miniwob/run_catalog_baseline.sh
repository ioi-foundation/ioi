...
export COMPUTER_USE_SUITE_FAIL_ON_FAILURE="${COMPUTER_USE_SUITE_FAIL_ON_FAILURE:-0}"
export COMPUTER_USE_SUITE_VERBOSE_ARTIFACTS="${COMPUTER_USE_SUITE_VERBOSE_ARTIFACTS:-1}"
